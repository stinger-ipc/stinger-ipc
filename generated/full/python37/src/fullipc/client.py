...
class FullClient:
    ...
    def __init__(self, connection: IBrokerConnection, instance_info: DiscoveredInstance):
        ...
        self._all_methods_response_topic = "client/{client_id}/Full/method/+/response".format(**self._topic_template_kwargs)  # type: ignore[str-format]
        ...
        self._property_response_topic = "client/{client_id}/Full/property/+/update/response".format(**self._topic_template_kwargs)  # type: ignore[str-format]
    ...
    def favorite_number(self, value: Union[int, FavoriteNumberProperty]):
        ...
        if isinstance(value, FavoriteNumberProperty):
            property_obj = value
        else:
        ...
        with self._property_favorite_number_mutex:
            req_msg = MessageCreator.property_update_request_message(
                ...
                "client/{client_id}/Full/property/favorite_number/update/response".format(**self._topic_template_kwargs),  # type: ignore[str-format]
                str(uuid4()),
            )
    ...
    def favorite_foods(self, value: FavoriteFoodsProperty):
        ...
        with self._property_favorite_foods_mutex:
            req_msg = MessageCreator.property_update_request_message(
                ...
                "client/{client_id}/Full/property/favorite_foods/update/response".format(**self._topic_template_kwargs),  # type: ignore[str-format]
                str(uuid4()),
            )
            self._conn.publish(req_msg)
    ...
    def family_name(self, value: Union[str, FamilyNameProperty]):
        ...
        with self._property_family_name_mutex:
            req_msg = MessageCreator.property_update_request_message(
                ...
                "client/{client_id}/Full/property/family_name/update/response".format(**self._topic_template_kwargs),  # type: ignore[str-format]
                str(uuid4()),
            )
            self._conn.publish(req_msg)
    ...
    def last_breakfast_time(self, value: Union[datetime, LastBreakfastTimeProperty]):
        ...
        # Use the model object if passed, otherwise take the raw value and create a new model object.
        if isinstance(value, LastBreakfastTimeProperty):
            property_obj = value
        else:
        ...
        with self._property_last_breakfast_time_mutex:
            req_msg = MessageCreator.property_update_request_message(
                ...
                "client/{client_id}/Full/property/last_breakfast_time/update/response".format(**self._topic_template_kwargs),  # type: ignore[str-format]
                str(uuid4()),
            )
            self._conn.publish(req_msg)
    ...
    def last_birthdays(self, value: LastBirthdaysProperty):
        ...
        with self._property_last_birthdays_mutex:
            req_msg = MessageCreator.property_update_request_message(
                ...
                "client/{client_id}/Full/property/last_birthdays/update/response".format(**self._topic_template_kwargs),  # type: ignore[str-format]
                str(uuid4()),
            )
            self._conn.publish(req_msg)
    ...
    def add_numbers(self, first: int, second: int, third: Optional[int]) -> futures.Future:
        """Calling this method with individual arguments initiates a `addNumbers` IPC method call."""
        payload = AddNumbersMethodRequest(
            first=first,
            second=second,
            third=third,
        )
        return self.call_add_numbers(payload)

    def call_add_numbers(self, payload: AddNumbersMethodRequest) -> futures.Future:
        """Calling this method with a model payload initiates a `addNumbers` IPC method call."""
        ...
        response_topic = "client/{client_id}/Full/method/addNumbers/response".format(**self._topic_template_kwargs)  # type: ignore[str-format]
        req_msg = MessageCreator.request_message("{prefix}/Full/{service_id}/method/addNumbers/request".format(**self._topic_template_kwargs), payload, response_topic, correlation_id)  # type: ignore[str-format]
        self._conn.publish(req_msg)
        return fut
    ...
    def do_something(self, task_to_do: str) -> futures.Future:
        """Calling this method with individual arguments initiates a `doSomething` IPC method call."""
        payload = DoSomethingMethodRequest(
            task_to_do=task_to_do,
        )
        return self.call_do_something(payload)

    def call_do_something(self, payload: DoSomethingMethodRequest) -> futures.Future:
        """Calling this method with a model payload initiates a `doSomething` IPC method call."""
        fut = futures.Future()  # type: futures.Future
        correlation_id = str(uuid4())
        ...
        response_topic = "client/{client_id}/Full/method/doSomething/response".format(**self._topic_template_kwargs)  # type: ignore[str-format]
        req_msg = MessageCreator.request_message("{prefix}/Full/{service_id}/method/doSomething/request".format(**self._topic_template_kwargs), payload, response_topic, correlation_id)  # type: ignore[str-format]
        self._conn.publish(req_msg)
        return fut
    ...
    def what_time_is_it(
        ...
        """Calling this method with individual arguments initiates a `what_time_is_it` IPC method call."""
        payload = WhatTimeIsItMethodRequest()
        return self.call_what_time_is_it(payload)

    def call_what_time_is_it(self, payload: WhatTimeIsItMethodRequest) -> futures.Future:
        """Calling this method with a model payload initiates a `what_time_is_it` IPC method call."""
        fut = futures.Future()  # type: futures.Future
        correlation_id = str(uuid4())
        ...
        response_topic = "client/{client_id}/Full/method/what_time_is_it/response".format(**self._topic_template_kwargs)  # type: ignore[str-format]
        req_msg = MessageCreator.request_message("{prefix}/Full/{service_id}/method/what_time_is_it/request".format(**self._topic_template_kwargs), payload, response_topic, correlation_id)  # type: ignore[str-format]
        self._conn.publish(req_msg)
        return fut
    ...
    def hold_temperature(self, temperature_celsius: float) -> futures.Future:
        """Calling this method with individual arguments initiates a `hold_temperature` IPC method call."""
        payload = HoldTemperatureMethodRequest(
            temperature_celsius=temperature_celsius,
        )
        return self.call_hold_temperature(payload)

    def call_hold_temperature(self, payload: HoldTemperatureMethodRequest) -> futures.Future:
        """Calling this method with a model payload initiates a `hold_temperature` IPC method call."""
        fut = futures.Future()  # type: futures.Future
        correlation_id = str(uuid4())
        ...
        response_topic = "client/{client_id}/Full/method/hold_temperature/response".format(**self._topic_template_kwargs)  # type: ignore[str-format]
        req_msg = MessageCreator.request_message("{prefix}/Full/{service_id}/method/hold_temperature/request".format(**self._topic_template_kwargs), payload, response_topic, correlation_id)  # type: ignore[str-format]
        self._conn.publish(req_msg)
        return fut
...
class FullClientDiscoverer:
    ...
    def __init__(self, connection: IBrokerConnection, builder: Optional[FullClientBuilder] = None, build_binding: Optional[Any] = None):
        ...
        service_discovery_topic = "{prefix}/Full/{service_id}/interface".format(**topic_params)  # type: ignore[str-format]
        self._conn.subscribe(service_discovery_topic, self._process_service_discovery_message)
        all_property_discovery_topic = "{prefix}/Full/{service_id}/property/+/value".format(**topic_params)  # type: ignore[str-format]
    ...
    def set_discovered_interface_info_callback(self, callback: Callable[[FullInterfaceInfo], None]):
    ...
    def _process_service_discovery_message(self, message: Message):
        ...
        if len(message.payload) > 0:
            try:
                service_info = FullInterfaceInfo.model_validate_json(message.payload)
    ...
    def _process_property_value_message(self, message: Message):
        ...
        with self._mutex:
            ...
            if property_name == "favorite_number":
                try:
            ...
            elif property_name == "favorite_foods":
                try:
            ...
            elif property_name == "family_name":
                try:
            ...
            elif property_name == "last_breakfast_time":
                try:
            ...
            elif property_name == "last_birthdays":
                try:
