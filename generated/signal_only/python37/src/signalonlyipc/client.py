...
class SignalOnlyClientDiscoverer:
    ...
    def __init__(self, connection: IBrokerConnection, builder: Optional[SignalOnlyClientBuilder] = None, build_binding: Optional[Any] = None):
        ...
        service_discovery_topic = "{prefix}/SignalOnly/{service_id}/interface".format(**topic_params)  # type: ignore[str-format]
    ...
    def set_discovered_interface_info_callback(self, callback: Callable[[SignalOnlyInterfaceInfo], None]):
