...
SingleDateTimePayload SingleDateTimePayload::FromRapidJsonObject(const rapidjson::Value& jsonObj)
{
    ...
    { // Scoping
        ...
        if (itr != jsonObj.MemberEnd() && itr->value.IsString()) {
            ...
            singleDateTimePayload.value = stinger::utils::parseIsoTimestamp(tempValueIsoString);
...
ThreeDateTimesPayload ThreeDateTimesPayload::FromRapidJsonObject(const rapidjson::Value& jsonObj)
{
    ...
    { // Scoping
        ...
        if (itr != jsonObj.MemberEnd() && itr->value.IsString()) {
            ...
            threeDateTimesPayload.first = stinger::utils::parseIsoTimestamp(tempFirstIsoString);
    ...
    { // Scoping
        ...
        if (itr != jsonObj.MemberEnd() && itr->value.IsString()) {
            ...
            threeDateTimesPayload.second = stinger::utils::parseIsoTimestamp(tempSecondIsoString);
...
SingleDurationPayload SingleDurationPayload::FromRapidJsonObject(const rapidjson::Value& jsonObj)
{
    ...
    { // Scoping
        ...
        if (itr != jsonObj.MemberEnd() && itr->value.IsString()) {
            auto tempValueIsoString = itr->value.GetString();
            singleDurationPayload.value = stinger::utils::parseIsoDuration(tempValueIsoString);
...
ThreeDurationsPayload ThreeDurationsPayload::FromRapidJsonObject(const rapidjson::Value& jsonObj)
{
    ...
    { // Scoping
        ...
        if (itr != jsonObj.MemberEnd() && itr->value.IsString()) {
            auto tempFirstIsoString = itr->value.GetString();
            threeDurationsPayload.first = stinger::utils::parseIsoDuration(tempFirstIsoString);
    ...
    { // Scoping
        ...
        if (itr != jsonObj.MemberEnd() && itr->value.IsString()) {
            auto tempSecondIsoString = itr->value.GetString();
            threeDurationsPayload.second = stinger::utils::parseIsoDuration(tempSecondIsoString);
...
SingleBinaryPayload SingleBinaryPayload::FromRapidJsonObject(const rapidjson::Value& jsonObj)
{
    ...
    { // Scoping
        ...
        if (itr != jsonObj.MemberEnd() && itr->value.IsString()) {
            ...
            singleBinaryPayload.value = stinger::utils::base64Decode(tempValueB64String);
...
ThreeBinariesPayload ThreeBinariesPayload::FromRapidJsonObject(const rapidjson::Value& jsonObj)
{
    ...
    { // Scoping
        ...
        if (itr != jsonObj.MemberEnd() && itr->value.IsString()) {
            ...
            threeBinariesPayload.first = stinger::utils::base64Decode(tempFirstB64String);
    ...
    { // Scoping
        ...
        if (itr != jsonObj.MemberEnd() && itr->value.IsString()) {
            ...
            threeBinariesPayload.second = stinger::utils::base64Decode(tempSecondB64String);
