        ...
        with self._mutex:
            ...
            if property_name == "favoriteNumber":
                try:
                    ...
                    return
                try:
                    self._discovered_properties[instance_id]["favorite_number"] = prop_obj.number
                    self._discovered_properties[instance_id]["favorite_number_version"] = prop_version
                except Exception as e:
                    self._logger.warning("Failed to process property 'favorite_number' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    self._logger.warning("Failed to process property 'favorite_foods' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    self._logger.warning("Failed to process property 'lunch_menu' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    return
                try:
                    self._discovered_properties[instance_id]["family_name"] = prop_obj.family_name
                    self._discovered_properties[instance_id]["family_name_version"] = prop_version
                except Exception as e:
                    self._logger.warning("Failed to process property 'family_name' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    return
                try:
                    self._discovered_properties[instance_id]["last_breakfast_time"] = prop_obj.timestamp
                    self._discovered_properties[instance_id]["last_breakfast_time_version"] = prop_version
                except Exception as e:
                    self._logger.warning("Failed to process property 'last_breakfast_time' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    self._logger.warning("Failed to process property 'last_birthdays' value message:\n%s\n%s", message.payload, e)
