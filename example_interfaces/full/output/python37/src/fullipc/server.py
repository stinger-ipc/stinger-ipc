...
class FullServer:
    ...
    def __init__(self, connection: stinger::utils::IConnection, instance_id: str, initial_property_values: FullInitialPropertyValues, prefix: str):
...
class FullServerBuilder:
    ...
    def build(self, connection: stinger::utils::IConnection, instance_id: str, initial_property_values: FullInitialPropertyValues, prefix: str, binding: Optional[Any]=None) -> FullServer:
        new_server = FullServer(connection, instance_id, initial_property_values, prefix, )
