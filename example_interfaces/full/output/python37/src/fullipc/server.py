...
class FullServer:
    ...
    def _receive_favorite_number_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7a990f885b20>>` topic
    ...
    def _receive_favorite_foods_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7a990f8851f0>>` topic
    ...
    def _receive_family_name_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7a990f886bd0>>` topic
    ...
    def _receive_last_breakfast_time_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7a990f885af0>>` topic
    ...
    def _receive_last_birthdays_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7a990f886ab0>>` topic
