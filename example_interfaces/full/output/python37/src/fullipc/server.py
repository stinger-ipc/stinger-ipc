...
class FullServer:
    ...
    def _receive_favorite_number_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x70d3f2c52e40>>` topic
    ...
    def _receive_favorite_foods_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x70d3f2c98320>>` topic
    ...
    def _receive_family_name_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x70d3f2c989e0>>` topic
    ...
    def _receive_last_breakfast_time_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x70d3f2c98800>>` topic
    ...
    def _receive_last_birthdays_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x70d3f2c98950>>` topic
