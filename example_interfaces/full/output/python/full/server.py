...
class FullServer:
    ...
    def __init__(self, connection: BrokerConnection):
        ...
        self._conn.subscribe("full/property/favoriteNumber/setValue")
        self.changed_value_callback_for_ = None
        self._publish_interface_info()
        self._property_favorite_foods = None
        self._conn.subscribe("full/property/favoriteFoods/setValue")
        self.changed_value_callback_for_ = None
        self._publish_interface_info()
        self._property_lunch_menu = None
        self._conn.subscribe("full/property/lunchMenu/setValue")
        self.changed_value_callback_for_ = None
        self._publish_interface_info()
