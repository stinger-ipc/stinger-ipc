...
class FullClient:
    ...
    def __init__(self, connection: BrokerConnection):
        ...
        self._favorite_number_prop_subscription_id: int = self._conn.subscribe("Full/property/favorite_number")
        ...
        self._favorite_foods_prop_subscription_id: int = self._conn.subscribe("Full/property/favorite_foods")
        ...
        self._lunch_menu_prop_subscription_id: int = self._conn.subscribe("Full/property/lunch_menu")
