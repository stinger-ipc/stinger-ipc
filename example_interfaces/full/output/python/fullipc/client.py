...
class FullClient:
    ...
    def what_time_is_it(self, the_first_time: datetime.datetime) -> futures.Future:
        ...
        self._conn.publish("full/{}/method/whatTimeIsIt", json.dumps(payload), qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._client_id}/full/{}/method/whatTimeIsIt/response")
        return fut
    ...
    def set_the_time(self, the_first_time: datetime.datetime, the_second_time: datetime.datetime) -> futures.Future:
        ...
        self._conn.publish("full/{}/method/setTheTime", json.dumps(payload), qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._client_id}/full/{}/method/setTheTime/response")
        return fut
    ...
    def _handle_set_the_time_response(self, fut: futures.Future, response_json: Dict[str, Any], return_value: MethodReturnCode):
        ...
        try:
            ...
            return_args = self._filter_for_args(response_json, ["timestamp", "confirmation_message", ])
