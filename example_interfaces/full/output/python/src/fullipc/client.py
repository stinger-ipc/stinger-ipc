...
class FullClient:
    ...
    def favorite_number(self, value: int):
        ...
        with self._property_favorite_number_mutex:
            self._conn.publish_property_update_request(
                    "full/{}/property/favoriteNumber/setValue".format(self._service_id), 
                    property_obj, 
    ...
    def favorite_foods(self, value: FavoriteFoodsProperty):
        ...
        with self._property_favorite_foods_mutex:
            self._conn.publish_property_update_request(
                    "full/{}/property/favoriteFoods/setValue".format(self._service_id), 
                    property_obj, 
    ...
    def lunch_menu(self, value: LunchMenuProperty):
        ...
        with self._property_lunch_menu_mutex:
            self._conn.publish_property_update_request(
                    "full/{}/property/lunchMenu/setValue".format(self._service_id), 
                    property_obj, 
                    str(self._property_lunch_menu_version), 
                    self._property_response_topic
            )
    ...
    def family_name(self, value: str):
        ...
        with self._property_family_name_mutex:
            self._conn.publish_property_update_request(
                    "full/{}/property/familyName/setValue".format(self._service_id), 
                    property_obj, 
    ...
    def last_breakfast_time(self, value: datetime):
        ...
        with self._property_last_breakfast_time_mutex:
            self._conn.publish_property_update_request(
                    "full/{}/property/lastBreakfastTime/setValue".format(self._service_id), 
                    property_obj, 
    ...
    def breakfast_length(self, value: timedelta):
        ...
        with self._property_breakfast_length_mutex:
            self._conn.publish_property_update_request(
                    "full/{}/property/breakfastLength/setValue".format(self._service_id), 
                    property_obj, 
                    str(self._property_breakfast_length_version), 
                    self._property_response_topic
            )
    ...
    def last_birthdays(self, value: LastBirthdaysProperty):
        ...
        with self._property_last_birthdays_mutex:
            self._conn.publish_property_update_request(
                    "full/{}/property/lastBirthdays/setValue".format(self._service_id), 
                    property_obj, 
