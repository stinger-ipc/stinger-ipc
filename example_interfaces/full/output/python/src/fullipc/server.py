...
class FullServer:
    ...
    def _receive_favorite_number_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7da269e3f9b0>>` topic
    ...
    def _receive_favorite_foods_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7da26a899e20>>` topic
    ...
    def _receive_family_name_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7da269e84560>>` topic
    ...
    def _receive_last_breakfast_time_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7da269e840b0>>` topic
    ...
    def _receive_last_birthdays_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7da269e84800>>` topic
