...
impl<C: Mqtt5PubSub + Clone + Send + 'static> FullClient<C> {
    ...
    async fn start_add_numbers(
        ...
        let topic_param_map = HashMap::from([
            ...
            ("method_name".to_string(), "addNumbers".to_string()),
        ...
        let response_topic: String = strfmt(
            "client/{client_id}/Full/method/+/response",
            &topic_param_map,
        )
        .unwrap();
    ...
    async fn start_do_something(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "Full".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "doSomething".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_what_time_is_it(&mut self) -> oneshot::Receiver<MethodReturnCode> {
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "Full".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "what_time_is_it".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_hold_temperature(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "Full".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "hold_temperature".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_favorite_number_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_favorite_number_prop.clone(),
                            ),
                            ("property_name".to_string(), "favorite_number".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_favorite_number_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_favorite_foods_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_favorite_foods_prop.clone(),
                            ),
                            ("property_name".to_string(), "favorite_foods".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_favorite_foods_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_lunch_menu_prop.recv().await {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_lunch_menu_prop.clone(),
                            ),
                            ("property_name".to_string(), "lunch_menu".to_string()),
                            ("prefix".to_string(), client_id_for_lunch_menu_prop.clone()),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_family_name_prop.recv().await {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_family_name_prop.clone(),
                            ),
                            ("property_name".to_string(), "family_name".to_string()),
                            ("prefix".to_string(), client_id_for_family_name_prop.clone()),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_last_breakfast_time_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_last_breakfast_time_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "last_breakfast_time".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_last_breakfast_time_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_last_birthdays_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_last_birthdays_prop.clone(),
                            ),
                            ("property_name".to_string(), "last_birthdays".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_last_birthdays_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
