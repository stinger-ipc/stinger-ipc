...
impl From<MultiplesOfTen> for u32 {
    fn from(s: MultiplesOfTen) -> u32 {
        s as u32
    }
}

impl TryFrom<u32> for MultiplesOfTen {
    type Error = String;
    fn try_from(v: u32) -> Result<Self, Self::Error> {
        MultiplesOfTen::from_u32(v).ok_or_else(|| format!("Invalid MultiplesOfTen value: {}", v))
    }
}
