...
class FullServer:
    ...
    def __init__(self, connection: IBrokerConnection, instance_id: str, property_access: FullPropertyAccess, prefix: str):
        ...
        self._property_last_breakfast_time: PropertyControls[datetime] = PropertyControls(
            getter=property_access.last_breakfast_time_getter, setter=property_access.last_breakfast_time_setter, version=1
        )
    ...
    def publish_favorite_number_value(self, *_, **__):
        ...
        with self._property_favorite_number.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/Full/{service_id}/property/favorite_number/value".format(**self._topic_template_kwargs), favorite_number_prop_obj, self._property_favorite_number.version
            )
    ...
    def publish_favorite_foods_value(self, *_, **__):
        ...
        with self._property_favorite_foods.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/Full/{service_id}/property/favorite_foods/value".format(**self._topic_template_kwargs), favorite_foods_prop_obj, self._property_favorite_foods.version
            )
            self._conn.publish(state_msg)
    ...
    def publish_lunch_menu_value(self, *_, **__):
        ...
        with self._property_lunch_menu.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/Full/{service_id}/property/lunch_menu/value".format(**self._topic_template_kwargs), lunch_menu_prop_obj, self._property_lunch_menu.version
            )
            self._conn.publish(state_msg)
    ...
    def publish_family_name_value(self, *_, **__):
        ...
        with self._property_family_name.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/Full/{service_id}/property/family_name/value".format(**self._topic_template_kwargs), family_name_prop_obj, self._property_family_name.version
            )
            self._conn.publish(state_msg)
    ...
    def publish_last_breakfast_time_value(self, *_, **__):
        ...
        with self._property_last_breakfast_time.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/Full/{service_id}/property/last_breakfast_time/value".format(**self._topic_template_kwargs), last_breakfast_time_prop_obj, self._property_last_breakfast_time.version
            )
            self._conn.publish(state_msg)
    ...
    def publish_last_birthdays_value(self, *_, **__):
        ...
        with self._property_last_birthdays.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/Full/{service_id}/property/last_birthdays/value".format(**self._topic_template_kwargs), last_birthdays_prop_obj, self._property_last_birthdays.version
            )
            self._conn.publish(state_msg)
    ...
    def _receive_favorite_number_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x74b6a19868a0>>` topic
    ...
    def _receive_favorite_foods_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x74b6a175fa70>>` topic
    ...
    def _receive_family_name_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x74b6a175ef30>>` topic
    ...
    def _receive_last_breakfast_time_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x74b6a17a41d0>>` topic
    ...
    def _receive_last_birthdays_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x74b6a17a4800>>` topic
