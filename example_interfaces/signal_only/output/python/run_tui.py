#!/usr/bin/env python3
"""Launch the SignalOnlyIPC TUI."""

import argparse
import logging
from signal_onlyipc.tui.app import SignalOnlyIPCApp
...
def main():
    ...
    parser = argparse.ArgumentParser(description="SignalOnlyIPC TUI Application")
    parser.add_argument(
        "--cafile",
