...
impl<C: Mqtt5PubSub + Clone + Send + 'static> SignalOnlyClient<C> {
    ...
    pub async fn new(mut connection: C, discovery_info: DiscoveredService) -> Self {
        ...
        topic_map.insert("signal_name".to_string(), "anotherSignal".to_string());
        let topic_another_signal_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "bark".to_string());
        let topic_bark_signal =
            strfmt("{prefix}/SignalOnly/{service_id}/signal/bark", &topic_map).unwrap();
        ...
        topic_map.insert("signal_name".to_string(), "maybe_number".to_string());
        let topic_maybe_number_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "maybe_name".to_string());
        let topic_maybe_name_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "now".to_string());
        let topic_now_signal =
            strfmt("{prefix}/SignalOnly/{service_id}/signal/now", &topic_map).unwrap();
