...
class WeatherPropertyOwnership:
    ...
    def set_property_location(self, value: LocationProperty):
        ...
        print(f"~~> Received update for 'location' property: {value}")
    ...
    def set_property_current_condition_refresh_interval(self, value: int):
        ...
        print(f"~~> Received update for 'current_condition_refresh_interval' property: {value}")
    ...
    def set_property_hourly_forecast_refresh_interval(self, value: int):
        ...
        print(f"~~> Received update for 'hourly_forecast_refresh_interval' property: {value}")
    ...
    def set_property_daily_forecast_refresh_interval(self, value: int):
        ...
        print(f"~~> Received update for 'daily_forecast_refresh_interval' property: {value}")
...
if __name__ == "__main__":
    ...
    server = WeatherServer(conn, os.environ.get("SERVICE_ID", "py-server-demo:1"), property_access, prefix="example")
