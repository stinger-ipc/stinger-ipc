...
class WeatherServer:
    ...
    def __init__(self, connection: stinger::utils::IConnection, instance_id: str, property_access: WeatherPropertyAccess, prefix: str):
    ...
    def current_temperature(self, temperature_f: float):
        ...
        with self._property_current_temperature.mutex:
            if temperature_f != self._property_current_temperature.get_value():
                ...
                prop_value_topic = "{prefix}/weather/{service_id}/property/current_temperature/value".format(**self._topic_template_kwargs)
...
class WeatherServerBuilder:
    ...
    def build(self, connection: stinger::utils::IConnection, instance_id: str, property_access: WeatherPropertyAccess, prefix: str, binding: Optional[Any]=None) -> WeatherServer:
