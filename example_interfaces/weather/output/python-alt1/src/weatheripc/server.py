...
class WeatherServer:
    ...
    def __init__(self, connection: IBrokerConnection, instance_id: str, property_access: WeatherPropertyAccess, prefix: str):
        ...
        self._property_current_condition_refresh_interval: PropertyControls[int] = PropertyControls(
            getter=property_access.current_condition_refresh_interval_getter, setter=property_access.current_condition_refresh_interval_setter, version=1
        )
        ...
        self._property_hourly_forecast_refresh_interval: PropertyControls[int] = PropertyControls(
            getter=property_access.hourly_forecast_refresh_interval_getter, setter=property_access.hourly_forecast_refresh_interval_setter, version=1
        )
        ...
        self._property_daily_forecast_refresh_interval: PropertyControls[int] = PropertyControls(
            getter=property_access.daily_forecast_refresh_interval_getter, setter=property_access.daily_forecast_refresh_interval_setter, version=1
        )
    ...
    def publish_location_value(self, *_, **__):
        ...
        with self._property_location.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/weather/{service_id}/property/location/value".format(**self._topic_template_kwargs), location_prop_obj, self._property_location.version
            )
    ...
    def publish_current_temperature_value(self, *_, **__):
        ...
        with self._property_current_temperature.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/weather/{service_id}/property/current_temperature/value".format(**self._topic_template_kwargs), current_temperature_prop_obj, self._property_current_temperature.version
            )
            self._conn.publish(state_msg)
    ...
    def publish_current_condition_value(self, *_, **__):
        ...
        with self._property_current_condition.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/weather/{service_id}/property/current_condition/value".format(**self._topic_template_kwargs), current_condition_prop_obj, self._property_current_condition.version
            )
            self._conn.publish(state_msg)
    ...
    def publish_daily_forecast_value(self, *_, **__):
        ...
        with self._property_daily_forecast.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/weather/{service_id}/property/daily_forecast/value".format(**self._topic_template_kwargs), daily_forecast_prop_obj, self._property_daily_forecast.version
            )
            self._conn.publish(state_msg)
    ...
    def publish_hourly_forecast_value(self, *_, **__):
        ...
        with self._property_hourly_forecast.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/weather/{service_id}/property/hourly_forecast/value".format(**self._topic_template_kwargs), hourly_forecast_prop_obj, self._property_hourly_forecast.version
            )
            self._conn.publish(state_msg)
    ...
    def publish_current_condition_refresh_interval_value(self, *_, **__):
        ...
        with self._property_current_condition_refresh_interval.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/weather/{service_id}/property/current_condition_refresh_interval/value".format(**self._topic_template_kwargs),
    ...
    def publish_hourly_forecast_refresh_interval_value(self, *_, **__):
        ...
        with self._property_hourly_forecast_refresh_interval.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/weather/{service_id}/property/hourly_forecast_refresh_interval/value".format(**self._topic_template_kwargs),
    ...
    def publish_daily_forecast_refresh_interval_value(self, *_, **__):
        ...
        with self._property_daily_forecast_refresh_interval.mutex:
            ...
            state_msg = MessageCreator.property_state_message(
                "{prefix}/weather/{service_id}/property/daily_forecast_refresh_interval/value".format(**self._topic_template_kwargs),
