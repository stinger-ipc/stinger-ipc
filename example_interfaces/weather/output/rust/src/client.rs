...
impl<C: Mqtt5PubSub + Clone + Send + 'static> WeatherClient<C> {
    ...
    async fn start_refresh_daily_forecast(&mut self) -> oneshot::Receiver<MethodReturnCode> {
        ...
        let response_topic: String = strfmt(
            "client/{client_id}/weather/method/+/response",
            &topic_param_map,
        )
        .unwrap();
                ...
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_location_prop.recv().await {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_location_prop.clone(),
                            ),
                            ("property_name".to_string(), "location".to_string()),
                            ("prefix".to_string(), client_id_for_location_prop.clone()),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_current_temperature_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_current_temperature_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "current_temperature".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_current_temperature_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_current_condition_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_current_condition_prop.clone(),
                            ),
                            ("property_name".to_string(), "current_condition".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_current_condition_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_daily_forecast_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_daily_forecast_prop.clone(),
                            ),
                            ("property_name".to_string(), "daily_forecast".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_daily_forecast_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_hourly_forecast_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_hourly_forecast_prop.clone(),
                            ),
                            ("property_name".to_string(), "hourly_forecast".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_hourly_forecast_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_current_condition_refresh_interval_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_current_condition_refresh_interval_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "current_condition_refresh_interval".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_current_condition_refresh_interval_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_hourly_forecast_refresh_interval_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_hourly_forecast_refresh_interval_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "hourly_forecast_refresh_interval".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_hourly_forecast_refresh_interval_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_daily_forecast_refresh_interval_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_daily_forecast_refresh_interval_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "daily_forecast_refresh_interval".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_daily_forecast_refresh_interval_prop.clone(),
                            ),
                        ]);
