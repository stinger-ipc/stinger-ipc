...
class WeatherClientDiscoverer:
    ...
    def __init__(self, connection: IBrokerConnection):
        ...
        self._logger.setLevel(logging.DEBUG)
        service_discovery_topic = "weather/{}/interface".format(self._instance_id)
