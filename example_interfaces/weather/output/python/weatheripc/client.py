...
class WeatherClient:
    ...
    def refresh_daily_forecast(
        ...
        self._conn.publish(
            ...
            response_topic=f"client/{self._client_id}/weather/method/refreshDailyForecast/response",
        )
        return fut
    ...
    def refresh_hourly_forecast(
        ...
        self._conn.publish(
            ...
            retain=False,
            correlation_id=correlation_id,
            response_topic=f"client/{self._client_id}/weather/method/refreshHourlyForecast/response",
        )
        return fut
    ...
    def refresh_current_conditions(
        ...
        self._conn.publish(
            ...
            retain=False,
            correlation_id=correlation_id,
            response_topic=f"client/{self._client_id}/weather/method/refreshCurrentConditions/response",
        )
        return fut
