...
class ForecastForHour(BaseModel):
    ...
    temperature: Annotated[float, Field(description="Forecasted temperature in degrees fahrenheit.", )]
    starttime: Annotated[datetime, Field(description="Forecast is valid for the hour starting at this time.", )]
...
class ForecastForDay(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    high_temperature: Annotated[float, Field(description="High temperature for the day in degrees fahrenheit.", )]
    low_temperature: Annotated[float, Field(description="Low temperature for the day in degrees fahrenheit.", )]
    condition: Annotated[WeatherCondition, Field()]
...
will have a value for each day of the week.
    ...
    model_config = ConfigDict(populate_by_name=True)
    monday: Annotated[ForecastForDay, Field(description="This is the forecast for Monday.", )]
...
hour.
    ...
    model_config = ConfigDict(populate_by_name=True)
    hour_0: Annotated[ForecastForHour, Field(description="This is the forecast for the current hour.", )]
    hour_1: Annotated[ForecastForHour, Field(description="This is the forecast for the next hour.", )]
...
class HourlyForecastRefreshIntervalProperty(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    seconds: Annotated[int, Field(description="Interval duration in seconds.", )]
