...
class WeatherCondition(IntEnum):
    ...
    This enum contains the possible weather conditions that can be reported.
...
# There are 2 struct definitions
...
# There are 8 property definitions
...
# There are 3 method definitions
