...
class WeatherClient:
    ...
    def refresh_daily_forecast(self, ) -> futures.Future:
        ...
        self._conn.publish("weather/{}/method/refreshDailyForecast".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/refresh_daily_forecast/response")
        return fut
    ...
    def refresh_hourly_forecast(self, ) -> futures.Future:
        ...
        self._conn.publish("weather/{}/method/refreshHourlyForecast".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/refresh_hourly_forecast/response")
        return fut
    ...
    def refresh_current_conditions(self, ) -> futures.Future:
        ...
        self._conn.publish("weather/{}/method/refreshCurrentConditions".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/refresh_current_conditions/response")
        return fut
