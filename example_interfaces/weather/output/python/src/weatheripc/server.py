...
class WeatherServer:
    ...
    def _receive_location_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7aa30753abd0>>` topic
    ...
    def _receive_current_condition_refresh_interval_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7aa30753b260>>` topic
    ...
    def _receive_hourly_forecast_refresh_interval_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7aa30753b350>>` topic
    ...
    def _receive_daily_forecast_refresh_interval_update_request_message(self, message: Message):
        """When the MQTT client receives a message to the `<bound method Property.update_topic of <stingeripc.components.Property object at 0x7aa30753bfb0>>` topic
