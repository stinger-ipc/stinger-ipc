        ...
        with self._mutex:
            ...
            if property_name == "location":
                ...
                try:
                    ...
                    self._logger.warning("Failed to process property 'location' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    return
                try:
                    self._discovered_properties[instance_id]["current_temperature"] = prop_obj.temperature_f
                    self._discovered_properties[instance_id]["current_temperature_version"] = prop_version
                except Exception as e:
                    self._logger.warning("Failed to process property 'current_temperature' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    self._logger.warning("Failed to process property 'current_condition' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    self._logger.warning("Failed to process property 'daily_forecast' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    self._logger.warning("Failed to process property 'hourly_forecast' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    return
                try:
                    self._discovered_properties[instance_id]["current_condition_refresh_interval"] = prop_obj.seconds
                    self._discovered_properties[instance_id]["current_condition_refresh_interval_version"] = prop_version
                except Exception as e:
                    self._logger.warning("Failed to process property 'current_condition_refresh_interval' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    return
                try:
                    self._discovered_properties[instance_id]["hourly_forecast_refresh_interval"] = prop_obj.seconds
                    self._discovered_properties[instance_id]["hourly_forecast_refresh_interval_version"] = prop_version
                except Exception as e:
                    self._logger.warning("Failed to process property 'hourly_forecast_refresh_interval' value message:\n%s\n%s", message.payload, e)
                ...
                try:
                    ...
                    return
                try:
                    self._discovered_properties[instance_id]["daily_forecast_refresh_interval"] = prop_obj.seconds
                    self._discovered_properties[instance_id]["daily_forecast_refresh_interval_version"] = prop_version
                except Exception as e:
                    self._logger.warning("Failed to process property 'daily_forecast_refresh_interval' value message:\n%s\n%s", message.payload, e)
