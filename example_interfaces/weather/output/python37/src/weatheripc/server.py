...
class WeatherServer:
    ...
    def __init__(self, connection: stinger::utils::IConnection, instance_id: str, initial_property_values: WeatherInitialPropertyValues, prefix: str):
...
class WeatherServerBuilder:
    ...
    def build(self, connection: stinger::utils::IConnection, instance_id: str, initial_property_values: WeatherInitialPropertyValues, prefix: str, binding: Optional[Any]=None) -> WeatherServer:
        new_server = WeatherServer(connection, instance_id, initial_property_values, prefix, )
