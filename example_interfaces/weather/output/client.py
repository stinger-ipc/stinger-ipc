...
class WeatherClient:
    ...
    def __init__(self, connection: BrokerConnection):
        ...
        self._location_prop_subscription_id: int = self._conn.subscribe("weather/property/location/value")
        ...
        self._current_temperature_prop_subscription_id: int = self._conn.subscribe("weather/property/currentTemperature/value")
        ...
        self._current_condition_prop_subscription_id: int = self._conn.subscribe("weather/property/currentCondition/value")
        ...
        self._daily_forecast_prop_subscription_id: int = self._conn.subscribe("weather/property/dailyForecast/value")
        ...
        self._hourly_forecast_prop_subscription_id: int = self._conn.subscribe("weather/property/hourlyForecast/value")
        ...
        self._current_condition_refresh_interval_prop_subscription_id: int = self._conn.subscribe("weather/property/currentConditionRefreshInterval/value")
        ...
        self._hourly_forecast_refresh_interval_prop_subscription_id: int = self._conn.subscribe("weather/property/hourlyForecastRefreshInterval/value")
        ...
        self._daily_forecast_refresh_interval_prop_subscription_id: int = self._conn.subscribe("weather/property/dailyForecastRefreshInterval/value")
        ...
        self._refresh_daily_forecast_method_call_subscription_id: int = self._conn.subscribe(f"client/{self._client_id}/weather/method/refreshDailyForecast/response")
        self._refresh_hourly_forecast_method_call_subscription_id: int = self._conn.subscribe(f"client/{self._client_id}/weather/method/refreshHourlyForecast/response")
        self._refresh_current_conditions_method_call_subscription_id: int = self._conn.subscribe(f"client/{self._client_id}/weather/method/refreshCurrentConditions/response")
    ...
    def location(self, value: stinger_types.LocationProperty):
        ...
        self._conn.publish("weather/property/location/setValue", serialized, qos=1)
    ...
    def current_condition_refresh_interval(self, value: int):
        ...
        self._conn.publish("weather/property/currentConditionRefreshInterval/setValue", serialized, qos=1)
    ...
    def hourly_forecast_refresh_interval(self, value: int):
        ...
        self._conn.publish("weather/property/hourlyForecastRefreshInterval/setValue", serialized, qos=1)
    ...
    def daily_forecast_refresh_interval(self, value: int):
        ...
        self._conn.publish("weather/property/dailyForecastRefreshInterval/setValue", serialized, qos=1)
    ...
    def _receive_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        if self._conn.is_topic_sub(topic, "weather/signal/currentTime"):
        ...
        if self._conn.is_topic_sub(topic, "weather/property/location/value"):
            if 'ContentType' not in properties or properties['ContentType'] != 'application/json':
        ...
        elif self._conn.is_topic_sub(topic, "weather/property/currentTemperature/value"):
            if 'ContentType' not in properties or properties['ContentType'] != 'application/json':
        ...
        elif self._conn.is_topic_sub(topic, "weather/property/currentCondition/value"):
            if 'ContentType' not in properties or properties['ContentType'] != 'application/json':
        ...
        elif self._conn.is_topic_sub(topic, "weather/property/dailyForecast/value"):
            if 'ContentType' not in properties or properties['ContentType'] != 'application/json':
        ...
        elif self._conn.is_topic_sub(topic, "weather/property/hourlyForecast/value"):
            if 'ContentType' not in properties or properties['ContentType'] != 'application/json':
        ...
        elif self._conn.is_topic_sub(topic, "weather/property/currentConditionRefreshInterval/value"):
            if 'ContentType' not in properties or properties['ContentType'] != 'application/json':
        ...
        elif self._conn.is_topic_sub(topic, "weather/property/hourlyForecastRefreshInterval/value"):
            if 'ContentType' not in properties or properties['ContentType'] != 'application/json':
        ...
        elif self._conn.is_topic_sub(topic, "weather/property/dailyForecastRefreshInterval/value"):
            if 'ContentType' not in properties or properties['ContentType'] != 'application/json':
    ...
    def receive_current_time(self, handler: CurrentTimeSignalCallbackType):
        ...
        if len(self._signal_recv_callbacks_for_current_time) == 1:
            self._conn.subscribe("weather/signal/currentTime")
        return handler
    ...
    def refresh_daily_forecast(self, ) -> futures.Future:
        ...
        self._conn.publish("weather/method/refreshDailyForecast", json.dumps(payload), qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._client_id}/weather/method/refreshDailyForecast/response")
        return fut
    ...
    def refresh_hourly_forecast(self, ) -> futures.Future:
        ...
        self._conn.publish("weather/method/refreshHourlyForecast", json.dumps(payload), qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._client_id}/weather/method/refreshHourlyForecast/response")
        return fut
    ...
    def refresh_current_conditions(self, ) -> futures.Future:
        ...
        self._conn.publish("weather/method/refreshCurrentConditions", json.dumps(payload), qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._client_id}/weather/method/refreshCurrentConditions/response")
        return fut
...
class WeatherClientBuilder:
    ...
    def build(self) -> WeatherClient:
        """ Builds a new WeatherClient.
        """
        self._logger.debug("Building WeatherClient")
        client = WeatherClient(self._conn)
...
if __name__ == '__main__':
    ...
    client_builder = WeatherClientBuilder(conn)
