...
class TestTestableServerProperties:
    ...
    def test_read_write_integer_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc86e10>>".format("+"))
        ...
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc86e10>>".format(server.instance_id)
    ...
    def test_read_write_integer_property_receive(self, server, mock_connection):
        ...
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc86e10>>".format(server.instance_id),
    ...
    def test_read_write_integer_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_integer' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_integer'."
    ...
    def test_read_write_integer_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_integer' was called despite bad payload"
    ...
    def test_read_write_integer_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_integer' was called despite wrong payload"
    ...
    def test_read_only_integer_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ec54eea0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ec54eea0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_only_integer_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ec54eea0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_optional_integer_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2ec00>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2ec00>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_optional_integer_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2ec00>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_optional_integer_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_integer' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_optional_integer'."
    ...
    def test_read_write_optional_integer_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_integer' was called despite bad payload"
    ...
    def test_read_write_optional_integer_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_integer' was called despite wrong payload"
    ...
    def test_read_write_two_integers_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2ec90>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2ec90>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_two_integers_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2ec90>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_two_integers_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_integers' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_two_integers'."
    ...
    def test_read_write_two_integers_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_integers' was called despite bad payload"
    ...
    def test_read_write_two_integers_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_integers' was called despite wrong payload"
    ...
    def test_read_only_string_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2e5d0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2e5d0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_only_string_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2e5d0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_string_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f020>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f020>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_string_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2f020>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_string_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_string' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_string'."
    ...
    def test_read_write_string_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_string' was called despite bad payload"
    ...
    def test_read_write_string_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_string' was called despite wrong payload"
    ...
    def test_read_write_optional_string_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc875f0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc875f0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_optional_string_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc875f0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_optional_string_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_string' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_optional_string'."
    ...
    def test_read_write_optional_string_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_string' was called despite bad payload"
    ...
    def test_read_write_optional_string_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_string' was called despite wrong payload"
    ...
    def test_read_write_two_strings_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f4d0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f4d0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_two_strings_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2f4d0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_two_strings_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_strings' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_two_strings'."
    ...
    def test_read_write_two_strings_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_strings' was called despite bad payload"
    ...
    def test_read_write_two_strings_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_strings' was called despite wrong payload"
    ...
    def test_read_write_struct_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f470>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f470>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_struct_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2f470>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_struct_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_struct' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_struct'."
    ...
    def test_read_write_struct_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_struct' was called despite bad payload"
    ...
    def test_read_write_struct_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_struct' was called despite wrong payload"
    ...
    def test_read_write_optional_struct_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc87590>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc87590>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_optional_struct_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc87590>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_optional_struct_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_struct' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_optional_struct'."
    ...
    def test_read_write_optional_struct_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_struct' was called despite bad payload"
    ...
    def test_read_write_optional_struct_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_struct' was called despite wrong payload"
    ...
    def test_read_write_two_structs_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2eed0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2eed0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_two_structs_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2eed0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_two_structs_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_structs' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_two_structs'."
    ...
    def test_read_write_two_structs_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_structs' was called despite bad payload"
    ...
    def test_read_write_two_structs_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_structs' was called despite wrong payload"
    ...
    def test_read_only_enum_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fa10>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fa10>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_only_enum_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2fa10>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_enum_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fb60>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fb60>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_enum_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2fb60>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_enum_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_enum' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_enum'."
    ...
    def test_read_write_enum_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_enum' was called despite bad payload"
    ...
    def test_read_write_enum_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_enum' was called despite wrong payload"
    ...
    def test_read_write_optional_enum_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fa70>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fa70>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_optional_enum_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2fa70>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_optional_enum_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_enum' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_optional_enum'."
    ...
    def test_read_write_optional_enum_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_enum' was called despite bad payload"
    ...
    def test_read_write_optional_enum_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_enum' was called despite wrong payload"
    ...
    def test_read_write_two_enums_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fbf0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fbf0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_two_enums_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2fbf0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_two_enums_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_enums' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_two_enums'."
    ...
    def test_read_write_two_enums_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_enums' was called despite bad payload"
    ...
    def test_read_write_two_enums_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_enums' was called despite wrong payload"
    ...
    def test_read_write_datetime_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ec577830>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ec577830>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_datetime_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ec577830>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_datetime_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_datetime' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_datetime'."
    ...
    def test_read_write_datetime_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_datetime' was called despite bad payload"
    ...
    def test_read_write_datetime_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_datetime' was called despite wrong payload"
    ...
    def test_read_write_optional_datetime_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ec576f00>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ec576f00>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_optional_datetime_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ec576f00>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_optional_datetime_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_datetime' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_optional_datetime'."
    ...
    def test_read_write_optional_datetime_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_datetime' was called despite bad payload"
    ...
    def test_read_write_optional_datetime_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_datetime' was called despite wrong payload"
    ...
    def test_read_write_two_datetimes_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc8f980>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc8f980>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_two_datetimes_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc8f980>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_two_datetimes_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_datetimes' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_two_datetimes'."
    ...
    def test_read_write_two_datetimes_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_datetimes' was called despite bad payload"
    ...
    def test_read_write_two_datetimes_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_datetimes' was called despite wrong payload"
    ...
    def test_read_write_duration_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f9e0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f9e0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_duration_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2f9e0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_duration_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_duration' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_duration'."
    ...
    def test_read_write_duration_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_duration' was called despite bad payload"
    ...
    def test_read_write_duration_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_duration' was called despite wrong payload"
    ...
    def test_read_write_optional_duration_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fec0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fec0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_optional_duration_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2fec0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_optional_duration_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_duration' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_optional_duration'."
    ...
    def test_read_write_optional_duration_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_duration' was called despite bad payload"
    ...
    def test_read_write_optional_duration_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_duration' was called despite wrong payload"
    ...
    def test_read_write_two_durations_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2ff20>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2ff20>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_two_durations_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2ff20>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_two_durations_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_durations' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_two_durations'."
    ...
    def test_read_write_two_durations_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_durations' was called despite bad payload"
    ...
    def test_read_write_two_durations_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_durations' was called despite wrong payload"
    ...
    def test_read_write_binary_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f7a0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f7a0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_binary_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2f7a0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_binary_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_binary' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_binary'."
    ...
    def test_read_write_binary_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_binary' was called despite bad payload"
    ...
    def test_read_write_binary_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_binary' was called despite wrong payload"
    ...
    def test_read_write_optional_binary_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fe60>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2fe60>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_optional_binary_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2fe60>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_optional_binary_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_binary' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_optional_binary'."
    ...
    def test_read_write_optional_binary_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_binary' was called despite bad payload"
    ...
    def test_read_write_optional_binary_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_optional_binary' was called despite wrong payload"
    ...
    def test_read_write_two_binaries_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f3b0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc2f3b0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_two_binaries_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc2f3b0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_two_binaries_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_binaries' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_two_binaries'."
    ...
    def test_read_write_two_binaries_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_binaries' was called despite bad payload"
    ...
    def test_read_write_two_binaries_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_two_binaries' was called despite wrong payload"
    ...
    def test_read_write_list_of_strings_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc781a0>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc781a0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_list_of_strings_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc781a0>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_list_of_strings_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_list_of_strings' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_list_of_strings'."
    ...
    def test_read_write_list_of_strings_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_list_of_strings' was called despite bad payload"
    ...
    def test_read_write_list_of_strings_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_list_of_strings' was called despite wrong payload"
    ...
    def test_read_write_lists_property_publish(self, server, mock_connection, initial_property_values):
        ...
        published_list = mock_connection.find_published("<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc78740>>".format("+"))
        ...
        msg = published_list[0]
        expected_topic = "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7495ebc78740>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_read_write_lists_property_receive(self, server, mock_connection):
        ...
        correlation_data = b"123-41"
        incoming_msg = Message(
            topic="<bound method Property.update_topic of <stingeripc.components.Property object at 0x7495ebc78740>>".format(server.instance_id),
            payload=prop_obj.model_dump_json(by_alias=True).encode("utf-8"),
            qos=1,
            retain=False,
            response_topic=response_topic,
    ...
    def test_read_write_lists_property_receive_out_of_sync(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_lists' was called despite out-of-sync version"

        # Check for error message published
        published_list = mock_connection.find_published(response_topic)
        assert len(published_list) == 1, f"No response/error message was published for out-of-sync property 'read_write_lists'."
    ...
    def test_read_write_lists_property_receive_nonsense_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_lists' was called despite bad payload"
    ...
    def test_read_write_lists_property_receive_wrong_payload(self, server, mock_connection):
        ...
        assert received_data is None, "Callback for property 'read_write_lists' was called despite wrong payload"
...
class TestTestableServerSignals:
    ...
    def test_server_emit_empty(self, server, mock_connection):
        ...
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ec9ed040>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'empty'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ec9ed040>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_int(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ed6ccaa0>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_int'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ed6ccaa0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_optional_int(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc864e0>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_optional_int'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc864e0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_three_integers(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc86cf0>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'three_integers'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc86cf0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_string(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc86b10>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_string'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc86b10>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_optional_string(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87170>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_optional_string'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87170>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_three_strings(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87290>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'three_strings'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87290>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_enum(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc873e0>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_enum'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc873e0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_optional_enum(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87050>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_optional_enum'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87050>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_three_enums(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87740>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'three_enums'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87740>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_struct(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87830>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_struct'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87830>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_optional_struct(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc876b0>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_optional_struct'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc876b0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_three_structs(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87b90>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'three_structs'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87b90>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_date_time(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87bf0>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_date_time'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87bf0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_optional_datetime(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87b60>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_optional_datetime'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87b60>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_three_date_times(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87950>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'three_date_times'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87950>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_duration(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87560>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_duration'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87560>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_optional_duration(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87f50>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_optional_duration'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87f50>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_three_durations(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87b30>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'three_durations'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87b30>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_binary(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc872f0>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_binary'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc872f0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_optional_binary(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc86e70>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_optional_binary'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc86e70>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_three_binaries(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87200>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'three_binaries'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87200>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_array_of_integers(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87320>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_array_of_integers'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc87320>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_single_optional_array_of_strings(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc8c4d0>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'single_optional_array_of_strings'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc8c4d0>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
    ...
    def test_server_emit_array_of_every_type(self, server, mock_connection):
        ...
        # Verify that a message was published
        published_list = mock_connection.find_published("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc8c380>>".format("+"))
        assert len(published_list) == 1, "No message was published for signal 'array_of_every_type'"

        msg = published_list[0]
        expected_topic = "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7495ebc8c380>>".format(server.instance_id)
        assert msg.topic == expected_topic, f"Published topic '{msg.topic}' does not match expected '{expected_topic}'"
