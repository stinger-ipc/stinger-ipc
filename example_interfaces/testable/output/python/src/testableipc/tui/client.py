...
class ClientScreen(Screen):
    ...
    def _add_method_buttons(self) -> None:
        ...
        methods = {
            ...
            "call_optional_struct": { "input1": AllTypes,  },
        
            "call_three_structs": { "input1": AllTypes, "input2": AllTypes, "input3": AllTypes,  },
            ...
            "call_optional_binary": { "input1": bytes,  },
        
            "call_three_binaries": { "input1": bytes, "input2": bytes, "input3": bytes,  },
        
            "call_one_list_of_integers": { "input1": List[int],  },
        
            "call_optional_list_of_floats": { "input1": List[float],  },
        
            "call_two_lists": { "input1": List[Numbers], "input2": List[str],  },
