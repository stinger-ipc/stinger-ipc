...
class TestAbleClient:
    ...
    def call_with_nothing(self, ) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callWithNothing".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callWithNothing/response")
        return fut
    ...
    def call_one_integer(self, input1: int) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOneInteger".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOneInteger/response")
        return fut
    ...
    def call_optional_integer(self, input1: Optional[int]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOptionalInteger".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOptionalInteger/response")
        return fut
    ...
    def call_three_integers(self, input1: int, input2: int, input3: Optional[int]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callThreeIntegers".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callThreeIntegers/response")
        return fut
    ...
    def call_one_string(self, input1: str) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOneString".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOneString/response")
        return fut
    ...
    def call_optional_string(self, input1: Optional[str]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOptionalString".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOptionalString/response")
        return fut
    ...
    def call_three_strings(self, input1: str, input2: Optional[str], input3: str) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callThreeStrings".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callThreeStrings/response")
        return fut
    ...
    def call_one_enum(self, input1: Numbers) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOneEnum".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOneEnum/response")
        return fut
    ...
    def call_optional_enum(self, input1: Optional[Numbers]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOptionalEnum".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOptionalEnum/response")
        return fut
    ...
    def call_three_enums(self, input1: Numbers, input2: Numbers, input3: Optional[Numbers]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callThreeEnums".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callThreeEnums/response")
        return fut
    ...
    def call_one_struct(self, input1: AllTypes) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOneStruct".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOneStruct/response")
        return fut
    ...
    def call_optional_struct(self, input1: AllTypes) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOptionalStruct".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOptionalStruct/response")
        return fut
    ...
    def call_three_structs(self, input1: AllTypes, input2: AllTypes, input3: AllTypes) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callThreeStructs".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callThreeStructs/response")
        return fut
    ...
    def call_one_date_time(self, input1: datetime) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOneDateTime".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOneDateTime/response")
        return fut
    ...
    def call_optional_date_time(self, input1: Optional[datetime]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOptionalDateTime".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOptionalDateTime/response")
        return fut
    ...
    def call_three_date_times(self, input1: datetime, input2: datetime, input3: Optional[datetime]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callThreeDateTimes".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callThreeDateTimes/response")
        return fut
    ...
    def call_one_duration(self, input1: timedelta) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOneDuration".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOneDuration/response")
        return fut
    ...
    def call_optional_duration(self, input1: Optional[timedelta]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOptionalDuration".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOptionalDuration/response")
        return fut
    ...
    def call_three_durations(self, input1: timedelta, input2: timedelta, input3: Optional[timedelta]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callThreeDurations".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callThreeDurations/response")
        return fut
    ...
    def call_one_binary(self, input1: bytes) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOneBinary".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOneBinary/response")
        return fut
    ...
    def call_optional_binary(self, input1: bytes) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOptionalBinary".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOptionalBinary/response")
        return fut
    ...
    def call_three_binaries(self, input1: bytes, input2: bytes, input3: bytes) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callThreeBinaries".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callThreeBinaries/response")
        return fut
    ...
    def call_one_list_of_integers(self, input1: List[int]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOneListOfIntegers".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOneListOfIntegers/response")
        return fut
    ...
    def call_optional_list_of_floats(self, input1: List[float]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callOptionalListOfFloats".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callOptionalListOfFloats/response")
        return fut
    ...
    def call_two_lists(self, input1: List[Numbers], input2: List[str]) -> futures.Future:
        ...
        self._conn.publish("testAble/{}/method/callTwoLists".format(self._service_id), json_payload, qos=2, retain=False,
                           correlation_id=correlation_id, response_topic=f"client/{self._conn.client_id}/callTwoLists/response")
        return fut
