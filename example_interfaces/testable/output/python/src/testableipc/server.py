...
class TestableServer:
    ...
    def __init__(self, connection: IBrokerConnection, instance_id: str, initial_property_values: TestableInitialPropertyValues):
        ...
        self._property_read_write_optional_integer: PropertyControls[int] = PropertyControls(value=initial_property_values.read_write_optional_integer, version=initial_property_values.read_write_optional_integer_version)
        ...
        self._property_read_write_two_integers: PropertyControls[ReadWriteTwoIntegersProperty] = PropertyControls(value=initial_property_values.read_write_two_integers, version=initial_property_values.read_write_two_integers_version)
        ...
        self._property_read_write_optional_string: PropertyControls[str] = PropertyControls(value=initial_property_values.read_write_optional_string, version=initial_property_values.read_write_optional_string_version)
        ...
        self._property_read_write_two_strings: PropertyControls[ReadWriteTwoStringsProperty] = PropertyControls(value=initial_property_values.read_write_two_strings, version=initial_property_values.read_write_two_strings_version)
        ...
        self._property_read_write_optional_struct: PropertyControls[AllTypes] = PropertyControls(value=initial_property_values.read_write_optional_struct, version=initial_property_values.read_write_optional_struct_version)
        ...
        self._property_read_write_two_structs: PropertyControls[ReadWriteTwoStructsProperty] = PropertyControls(value=initial_property_values.read_write_two_structs, version=initial_property_values.read_write_two_structs_version)
        ...
        self._property_read_write_optional_enum: PropertyControls[Numbers] = PropertyControls(value=initial_property_values.read_write_optional_enum, version=initial_property_values.read_write_optional_enum_version)
        ...
        self._property_read_write_two_enums: PropertyControls[ReadWriteTwoEnumsProperty] = PropertyControls(value=initial_property_values.read_write_two_enums, version=initial_property_values.read_write_two_enums_version)
        ...
        self._property_read_write_datetime: PropertyControls[datetime] = PropertyControls(value=initial_property_values.read_write_datetime, version=initial_property_values.read_write_datetime_version)
        ...
        self._property_read_write_optional_datetime: PropertyControls[datetime] = PropertyControls(value=initial_property_values.read_write_optional_datetime, version=initial_property_values.read_write_optional_datetime_version)
        ...
        self._property_read_write_two_datetimes: PropertyControls[ReadWriteTwoDatetimesProperty] = PropertyControls(value=initial_property_values.read_write_two_datetimes, version=initial_property_values.read_write_two_datetimes_version)
        ...
        self._property_read_write_duration: PropertyControls[timedelta] = PropertyControls(value=initial_property_values.read_write_duration, version=initial_property_values.read_write_duration_version)
        ...
        self._property_read_write_optional_duration: PropertyControls[timedelta] = PropertyControls(value=initial_property_values.read_write_optional_duration, version=initial_property_values.read_write_optional_duration_version)
        ...
        self._property_read_write_two_durations: PropertyControls[ReadWriteTwoDurationsProperty] = PropertyControls(value=initial_property_values.read_write_two_durations, version=initial_property_values.read_write_two_durations_version)
        ...
        self._property_read_write_optional_binary: PropertyControls[bytes] = PropertyControls(value=initial_property_values.read_write_optional_binary, version=initial_property_values.read_write_optional_binary_version)
        ...
        self._property_read_write_two_binaries: PropertyControls[ReadWriteTwoBinariesProperty] = PropertyControls(value=initial_property_values.read_write_two_binaries, version=initial_property_values.read_write_two_binaries_version)
        ...
        self._property_read_write_list_of_strings: PropertyControls[list] = PropertyControls(value=initial_property_values.read_write_list_of_strings, version=initial_property_values.read_write_list_of_strings_version)
        ...
        self._property_read_write_lists: PropertyControls[ReadWriteListsProperty] = PropertyControls(value=initial_property_values.read_write_lists, version=initial_property_values.read_write_lists_version)
    ...
    def publish_read_write_integer_value(self, *_, **__):
        ...
        with self._property_read_write_integer.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteInteger/value".format(self._instance_id), read_write_integer_prop_obj, self._property_read_write_integer.version)
    ...
    def publish_read_only_integer_value(self, *_, **__):
        ...
        with self._property_read_only_integer.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readOnlyInteger/value".format(self._instance_id), read_only_integer_prop_obj, self._property_read_only_integer.version)
            self._conn.publish(state_msg)
    def publish_read_write_optional_integer_value(self, *_, **__):
        ...
        with self._property_read_write_optional_integer.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalInteger/value".format(self._instance_id), read_write_optional_integer_prop_obj, self._property_read_write_optional_integer.version)
            self._conn.publish(state_msg)
    def publish_read_write_two_integers_value(self, *_, **__):
        ...
        with self._property_read_write_two_integers.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoIntegers/value".format(self._instance_id), read_write_two_integers_prop_obj, self._property_read_write_two_integers.version)
            self._conn.publish(state_msg)
    ...
    def publish_read_write_string_value(self, *_, **__):
        ...
        with self._property_read_write_string.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteString/value".format(self._instance_id), read_write_string_prop_obj, self._property_read_write_string.version)
            self._conn.publish(state_msg)
    def publish_read_write_optional_string_value(self, *_, **__):
        ...
        with self._property_read_write_optional_string.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalString/value".format(self._instance_id), read_write_optional_string_prop_obj, self._property_read_write_optional_string.version)
            self._conn.publish(state_msg)
    def publish_read_write_two_strings_value(self, *_, **__):
        ...
        with self._property_read_write_two_strings.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoStrings/value".format(self._instance_id), read_write_two_strings_prop_obj, self._property_read_write_two_strings.version)
            self._conn.publish(state_msg)
    def publish_read_write_struct_value(self, *_, **__):
        ...
        with self._property_read_write_struct.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteStruct/value".format(self._instance_id), read_write_struct_prop_obj, self._property_read_write_struct.version)
            self._conn.publish(state_msg)
    def publish_read_write_optional_struct_value(self, *_, **__):
        ...
        with self._property_read_write_optional_struct.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalStruct/value".format(self._instance_id), read_write_optional_struct_prop_obj, self._property_read_write_optional_struct.version)
            self._conn.publish(state_msg)
    def publish_read_write_two_structs_value(self, *_, **__):
        ...
        with self._property_read_write_two_structs.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoStructs/value".format(self._instance_id), read_write_two_structs_prop_obj, self._property_read_write_two_structs.version)
            self._conn.publish(state_msg)
    ...
    def publish_read_write_optional_enum_value(self, *_, **__):
        ...
        with self._property_read_write_optional_enum.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalEnum/value".format(self._instance_id), read_write_optional_enum_prop_obj, self._property_read_write_optional_enum.version)
            self._conn.publish(state_msg)
    def publish_read_write_two_enums_value(self, *_, **__):
        ...
        with self._property_read_write_two_enums.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoEnums/value".format(self._instance_id), read_write_two_enums_prop_obj, self._property_read_write_two_enums.version)
            self._conn.publish(state_msg)
    def publish_read_write_datetime_value(self, *_, **__):
        ...
        with self._property_read_write_datetime.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteDatetime/value".format(self._instance_id), read_write_datetime_prop_obj, self._property_read_write_datetime.version)
            self._conn.publish(state_msg)
    def publish_read_write_optional_datetime_value(self, *_, **__):
        ...
        with self._property_read_write_optional_datetime.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalDatetime/value".format(self._instance_id), read_write_optional_datetime_prop_obj, self._property_read_write_optional_datetime.version)
            self._conn.publish(state_msg)
    def publish_read_write_two_datetimes_value(self, *_, **__):
        ...
        with self._property_read_write_two_datetimes.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoDatetimes/value".format(self._instance_id), read_write_two_datetimes_prop_obj, self._property_read_write_two_datetimes.version)
            self._conn.publish(state_msg)
    def publish_read_write_duration_value(self, *_, **__):
        ...
        with self._property_read_write_duration.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteDuration/value".format(self._instance_id), read_write_duration_prop_obj, self._property_read_write_duration.version)
            self._conn.publish(state_msg)
    def publish_read_write_optional_duration_value(self, *_, **__):
        ...
        with self._property_read_write_optional_duration.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalDuration/value".format(self._instance_id), read_write_optional_duration_prop_obj, self._property_read_write_optional_duration.version)
            self._conn.publish(state_msg)
    def publish_read_write_two_durations_value(self, *_, **__):
        ...
        with self._property_read_write_two_durations.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoDurations/value".format(self._instance_id), read_write_two_durations_prop_obj, self._property_read_write_two_durations.version)
            self._conn.publish(state_msg)
    def publish_read_write_binary_value(self, *_, **__):
        ...
        with self._property_read_write_binary.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteBinary/value".format(self._instance_id), read_write_binary_prop_obj, self._property_read_write_binary.version)
            self._conn.publish(state_msg)
    def publish_read_write_optional_binary_value(self, *_, **__):
        ...
        with self._property_read_write_optional_binary.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalBinary/value".format(self._instance_id), read_write_optional_binary_prop_obj, self._property_read_write_optional_binary.version)
            self._conn.publish(state_msg)
    def publish_read_write_two_binaries_value(self, *_, **__):
        ...
        with self._property_read_write_two_binaries.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoBinaries/value".format(self._instance_id), read_write_two_binaries_prop_obj, self._property_read_write_two_binaries.version)
            self._conn.publish(state_msg)
    def publish_read_write_list_of_strings_value(self, *_, **__):
        ...
        with self._property_read_write_list_of_strings.mutex:
            ...
            state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteListOfStrings/value".format(self._instance_id), read_write_list_of_strings_prop_obj, self._property_read_write_list_of_strings.version)
            self._conn.publish(state_msg)
    ...
    def _receive_read_write_optional_integer_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_optional_integer.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalInteger/value".format(self._instance_id), current_prop_obj, self._property_read_write_optional_integer.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_two_integers_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_two_integers.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoIntegers/value".format(self._instance_id), current_prop_obj, self._property_read_write_two_integers.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_optional_string_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_optional_string.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalString/value".format(self._instance_id), current_prop_obj, self._property_read_write_optional_string.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_two_strings_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_two_strings.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoStrings/value".format(self._instance_id), current_prop_obj, self._property_read_write_two_strings.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_optional_struct_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_optional_struct.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalStruct/value".format(self._instance_id), current_prop_obj, self._property_read_write_optional_struct.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_two_structs_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_two_structs.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoStructs/value".format(self._instance_id), current_prop_obj, self._property_read_write_two_structs.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_optional_enum_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_optional_enum.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalEnum/value".format(self._instance_id), current_prop_obj, self._property_read_write_optional_enum.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_two_enums_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_two_enums.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoEnums/value".format(self._instance_id), current_prop_obj, self._property_read_write_two_enums.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_datetime_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_datetime.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteDatetime/value".format(self._instance_id), current_prop_obj, self._property_read_write_datetime.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_optional_datetime_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_optional_datetime.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalDatetime/value".format(self._instance_id), current_prop_obj, self._property_read_write_optional_datetime.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_two_datetimes_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_two_datetimes.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoDatetimes/value".format(self._instance_id), current_prop_obj, self._property_read_write_two_datetimes.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_duration_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_duration.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteDuration/value".format(self._instance_id), current_prop_obj, self._property_read_write_duration.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_optional_duration_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_optional_duration.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalDuration/value".format(self._instance_id), current_prop_obj, self._property_read_write_optional_duration.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_two_durations_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_two_durations.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoDurations/value".format(self._instance_id), current_prop_obj, self._property_read_write_two_durations.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_optional_binary_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_optional_binary.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalBinary/value".format(self._instance_id), current_prop_obj, self._property_read_write_optional_binary.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_two_binaries_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_two_binaries.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoBinaries/value".format(self._instance_id), current_prop_obj, self._property_read_write_two_binaries.version)
                self._conn.publish(state_msg)
    ...
    def _receive_read_write_list_of_strings_update_request_message(self, message: Message):
        ...
        try:
            ...
            with self._property_read_write_list_of_strings.mutex:
                ...
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteListOfStrings/value".format(self._instance_id), current_prop_obj, self._property_read_write_list_of_strings.version)
                self._conn.publish(state_msg)
    ...
    def read_write_optional_integer(self, value: Optional[int]):
        ...
        with self._property_read_write_optional_integer.mutex:
            if value != self._property_read_write_optional_integer.get_value():
                ...
                self._property_read_write_optional_integer.version += 1
                prop_obj = ReadWriteOptionalIntegerProperty(value=self._property_read_write_optional_integer.get_value())
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalInteger/value".format(self._instance_id), prop_obj, self._property_read_write_optional_integer.version)
                self._conn.publish(state_msg)
        ...
        if not isinstance(value, ReadWriteTwoIntegersProperty):
            ...
            with self._property_read_write_two_integers.mutex:
                if value != self._property_read_write_two_integers.get_value():
                    ...
                    self._property_read_write_two_integers.version += 1
                    state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoIntegers/value".format(self._instance_id), self._property_read_write_two_integers.get_value(), self._property_read_write_two_integers.version)
                    self._conn.publish(state_msg)
    ...
    def read_write_optional_string(self, value: Optional[str]):
        ...
        with self._property_read_write_optional_string.mutex:
            if value != self._property_read_write_optional_string.get_value():
                ...
                self._property_read_write_optional_string.version += 1
                prop_obj = ReadWriteOptionalStringProperty(value=self._property_read_write_optional_string.get_value())
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalString/value".format(self._instance_id), prop_obj, self._property_read_write_optional_string.version)
                self._conn.publish(state_msg)
        ...
        if not isinstance(value, ReadWriteTwoStringsProperty):
            ...
            with self._property_read_write_two_strings.mutex:
                if value != self._property_read_write_two_strings.get_value():
                    ...
                    self._property_read_write_two_strings.version += 1
                    state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoStrings/value".format(self._instance_id), self._property_read_write_two_strings.get_value(), self._property_read_write_two_strings.version)
                    self._conn.publish(state_msg)
    ...
    def read_write_optional_struct(self, value: AllTypes):
        ...
        with self._property_read_write_optional_struct.mutex:
            if value != self._property_read_write_optional_struct.get_value():
                ...
                self._property_read_write_optional_struct.version += 1
                prop_obj = ReadWriteOptionalStructProperty(value=self._property_read_write_optional_struct.get_value())
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalStruct/value".format(self._instance_id), prop_obj, self._property_read_write_optional_struct.version)
                self._conn.publish(state_msg)
        ...
        if not isinstance(value, ReadWriteTwoStructsProperty):
            ...
            with self._property_read_write_two_structs.mutex:
                if value != self._property_read_write_two_structs.get_value():
                    ...
                    self._property_read_write_two_structs.version += 1
                    state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoStructs/value".format(self._instance_id), self._property_read_write_two_structs.get_value(), self._property_read_write_two_structs.version)
                    self._conn.publish(state_msg)
    ...
    def read_write_optional_enum(self, value: Optional[Numbers]):
        ...
        with self._property_read_write_optional_enum.mutex:
            if value != self._property_read_write_optional_enum.get_value():
                ...
                self._property_read_write_optional_enum.version += 1
                prop_obj = ReadWriteOptionalEnumProperty(value=self._property_read_write_optional_enum.get_value())
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalEnum/value".format(self._instance_id), prop_obj, self._property_read_write_optional_enum.version)
                self._conn.publish(state_msg)
        ...
        if not isinstance(value, ReadWriteTwoEnumsProperty):
            ...
            with self._property_read_write_two_enums.mutex:
                if value != self._property_read_write_two_enums.get_value():
                    ...
                    self._property_read_write_two_enums.version += 1
                    state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoEnums/value".format(self._instance_id), self._property_read_write_two_enums.get_value(), self._property_read_write_two_enums.version)
                    self._conn.publish(state_msg)
    ...
    def read_write_optional_datetime(self, value: Optional[datetime]):
        ...
        with self._property_read_write_optional_datetime.mutex:
            if value != self._property_read_write_optional_datetime.get_value():
                ...
                self._property_read_write_optional_datetime.version += 1
                prop_obj = ReadWriteOptionalDatetimeProperty(value=self._property_read_write_optional_datetime.get_value())
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalDatetime/value".format(self._instance_id), prop_obj, self._property_read_write_optional_datetime.version)
                self._conn.publish(state_msg)
        ...
        if not isinstance(value, ReadWriteTwoDatetimesProperty):
            ...
            with self._property_read_write_two_datetimes.mutex:
                if value != self._property_read_write_two_datetimes.get_value():
                    ...
                    self._property_read_write_two_datetimes.version += 1
                    state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoDatetimes/value".format(self._instance_id), self._property_read_write_two_datetimes.get_value(), self._property_read_write_two_datetimes.version)
                    self._conn.publish(state_msg)
    ...
    def read_write_optional_duration(self, value: Optional[timedelta]):
        ...
        with self._property_read_write_optional_duration.mutex:
            if value != self._property_read_write_optional_duration.get_value():
                ...
                self._property_read_write_optional_duration.version += 1
                prop_obj = ReadWriteOptionalDurationProperty(value=self._property_read_write_optional_duration.get_value())
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalDuration/value".format(self._instance_id), prop_obj, self._property_read_write_optional_duration.version)
                self._conn.publish(state_msg)
        ...
        if not isinstance(value, ReadWriteTwoDurationsProperty):
            ...
            with self._property_read_write_two_durations.mutex:
                if value != self._property_read_write_two_durations.get_value():
                    ...
                    self._property_read_write_two_durations.version += 1
                    state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoDurations/value".format(self._instance_id), self._property_read_write_two_durations.get_value(), self._property_read_write_two_durations.version)
                    self._conn.publish(state_msg)
    ...
    def read_write_optional_binary(self, value: bytes):
        ...
        with self._property_read_write_optional_binary.mutex:
            if value != self._property_read_write_optional_binary.get_value():
                ...
                self._property_read_write_optional_binary.version += 1
                prop_obj = ReadWriteOptionalBinaryProperty(value=self._property_read_write_optional_binary.get_value())
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteOptionalBinary/value".format(self._instance_id), prop_obj, self._property_read_write_optional_binary.version)
                self._conn.publish(state_msg)
        ...
        if not isinstance(value, ReadWriteTwoBinariesProperty):
            ...
            with self._property_read_write_two_binaries.mutex:
                if value != self._property_read_write_two_binaries.get_value():
                    ...
                    self._property_read_write_two_binaries.version += 1
                    state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteTwoBinaries/value".format(self._instance_id), self._property_read_write_two_binaries.get_value(), self._property_read_write_two_binaries.version)
                    self._conn.publish(state_msg)
    ...
    def read_write_list_of_strings(self, value: List[str]):
        ...
        with self._property_read_write_list_of_strings.mutex:
            if value != self._property_read_write_list_of_strings.get_value():
                ...
                self._property_read_write_list_of_strings.version += 1
                prop_obj = ReadWriteListOfStringsProperty(value=self._property_read_write_list_of_strings.get_value())
                state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteListOfStrings/value".format(self._instance_id), prop_obj, self._property_read_write_list_of_strings.version)
                self._conn.publish(state_msg)
        ...
        if not isinstance(value, ReadWriteListsProperty):
            ...
            with self._property_read_write_lists.mutex:
                if value != self._property_read_write_lists.get_value():
                    ...
                    self._property_read_write_lists.version += 1
                    state_msg = MessageCreator.property_state_message("testable/{}/property/readWriteLists/value".format(self._instance_id), self._property_read_write_lists.get_value(), self._property_read_write_lists.version)
                    self._conn.publish(state_msg)
