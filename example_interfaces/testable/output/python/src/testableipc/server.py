...
class TestAbleServer:
    ...
    def __init__(self, connection: IBrokerConnection, instance_id: str, initial_property_values: TestAbleInitialPropertyValues):
        ...
        self._property_read_write_integer: PropertyControls[int] = PropertyControls()
        self._property_read_write_integer.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteInteger/setValue".format(self._instance_id), self._receive_read_write_integer_update_request_message)
        
        self._property_read_only_integer: PropertyControls[int] = PropertyControls()
        self._property_read_only_integer.subscription_id = self._conn.subscribe("testAble/{}/property/readOnlyInteger/setValue".format(self._instance_id), self._receive_read_only_integer_update_request_message)
        
        self._property_read_write_optional_integer: PropertyControls[int] = PropertyControls()
        self._property_read_write_optional_integer.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteOptionalInteger/setValue".format(self._instance_id), self._receive_read_write_optional_integer_update_request_message)
        
        self._property_read_write_two_integers: PropertyControls[ReadWriteTwoIntegersProperty] = PropertyControls()
        self._property_read_write_two_integers.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteTwoIntegers/setValue".format(self._instance_id), self._receive_read_write_two_integers_update_request_message)
        
        self._property_read_only_string: PropertyControls[str] = PropertyControls()
        self._property_read_only_string.subscription_id = self._conn.subscribe("testAble/{}/property/readOnlyString/setValue".format(self._instance_id), self._receive_read_only_string_update_request_message)
        
        self._property_read_write_string: PropertyControls[str] = PropertyControls()
        self._property_read_write_string.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteString/setValue".format(self._instance_id), self._receive_read_write_string_update_request_message)
        
        self._property_read_write_optional_string: PropertyControls[str] = PropertyControls()
        self._property_read_write_optional_string.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteOptionalString/setValue".format(self._instance_id), self._receive_read_write_optional_string_update_request_message)
        
        self._property_read_write_two_strings: PropertyControls[ReadWriteTwoStringsProperty] = PropertyControls()
        self._property_read_write_two_strings.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteTwoStrings/setValue".format(self._instance_id), self._receive_read_write_two_strings_update_request_message)
        
        self._property_read_write_struct: PropertyControls[AllTypes] = PropertyControls()
        self._property_read_write_struct.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteStruct/setValue".format(self._instance_id), self._receive_read_write_struct_update_request_message)
        
        self._property_read_write_optional_struct: PropertyControls[AllTypes] = PropertyControls()
        self._property_read_write_optional_struct.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteOptionalStruct/setValue".format(self._instance_id), self._receive_read_write_optional_struct_update_request_message)
        
        self._property_read_write_two_structs: PropertyControls[ReadWriteTwoStructsProperty] = PropertyControls()
        self._property_read_write_two_structs.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteTwoStructs/setValue".format(self._instance_id), self._receive_read_write_two_structs_update_request_message)
        
        self._property_read_only_enum: PropertyControls[Numbers] = PropertyControls()
        self._property_read_only_enum.subscription_id = self._conn.subscribe("testAble/{}/property/readOnlyEnum/setValue".format(self._instance_id), self._receive_read_only_enum_update_request_message)
        
        self._property_read_write_enum: PropertyControls[Numbers] = PropertyControls()
        self._property_read_write_enum.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteEnum/setValue".format(self._instance_id), self._receive_read_write_enum_update_request_message)
        
        self._property_read_write_optional_enum: PropertyControls[Numbers] = PropertyControls()
        self._property_read_write_optional_enum.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteOptionalEnum/setValue".format(self._instance_id), self._receive_read_write_optional_enum_update_request_message)
        
        self._property_read_write_two_enums: PropertyControls[ReadWriteTwoEnumsProperty] = PropertyControls()
        self._property_read_write_two_enums.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteTwoEnums/setValue".format(self._instance_id), self._receive_read_write_two_enums_update_request_message)
        
        self._property_read_write_datetime: PropertyControls[datetime] = PropertyControls()
        self._property_read_write_datetime.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteDatetime/setValue".format(self._instance_id), self._receive_read_write_datetime_update_request_message)
        
        self._property_read_write_optional_datetime: PropertyControls[datetime] = PropertyControls()
        self._property_read_write_optional_datetime.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteOptionalDatetime/setValue".format(self._instance_id), self._receive_read_write_optional_datetime_update_request_message)
        
        self._property_read_write_two_datetimes: PropertyControls[ReadWriteTwoDatetimesProperty] = PropertyControls()
        self._property_read_write_two_datetimes.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteTwoDatetimes/setValue".format(self._instance_id), self._receive_read_write_two_datetimes_update_request_message)
        
        self._property_read_write_duration: PropertyControls[timedelta] = PropertyControls()
        self._property_read_write_duration.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteDuration/setValue".format(self._instance_id), self._receive_read_write_duration_update_request_message)
        
        self._property_read_write_optional_duration: PropertyControls[timedelta] = PropertyControls()
        self._property_read_write_optional_duration.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteOptionalDuration/setValue".format(self._instance_id), self._receive_read_write_optional_duration_update_request_message)
        
        self._property_read_write_two_durations: PropertyControls[ReadWriteTwoDurationsProperty] = PropertyControls()
        self._property_read_write_two_durations.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteTwoDurations/setValue".format(self._instance_id), self._receive_read_write_two_durations_update_request_message)
        
        self._property_read_write_binary: PropertyControls[bytes] = PropertyControls()
        self._property_read_write_binary.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteBinary/setValue".format(self._instance_id), self._receive_read_write_binary_update_request_message)
        
        self._property_read_write_optional_binary: PropertyControls[bytes] = PropertyControls()
        self._property_read_write_optional_binary.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteOptionalBinary/setValue".format(self._instance_id), self._receive_read_write_optional_binary_update_request_message)
        
        self._property_read_write_two_binaries: PropertyControls[ReadWriteTwoBinariesProperty] = PropertyControls()
        self._property_read_write_two_binaries.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteTwoBinaries/setValue".format(self._instance_id), self._receive_read_write_two_binaries_update_request_message)
        
        self._property_read_write_list_of_strings: PropertyControls[list] = PropertyControls()
        self._property_read_write_list_of_strings.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteListOfStrings/setValue".format(self._instance_id), self._receive_read_write_list_of_strings_update_request_message)
        
        self._property_read_write_lists: PropertyControls[ReadWriteListsProperty] = PropertyControls()
        self._property_read_write_lists.subscription_id = self._conn.subscribe("testAble/{}/property/readWriteLists/setValue".format(self._instance_id), self._receive_read_write_lists_update_request_message)
        ...
        self._method_call_one_list_of_integers.subscription_id = self._conn.subscribe("testAble/{}/method/callOneListOfIntegers".format(self._instance_id), self._process_call_one_list_of_integers_call)
        
        self._method_call_optional_list_of_floats = MethodControls()
        self._method_call_optional_list_of_floats.subscription_id = self._conn.subscribe("testAble/{}/method/callOptionalListOfFloats".format(self._instance_id), self._process_call_optional_list_of_floats_call)
    ...
    def _receive_read_write_integer_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_integer.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_integer.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_integer.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_integer.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_integer.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_only_integer_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_only_integer.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_only_integer.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_only_integer.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_only_integer.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_only_integer.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_optional_integer_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_optional_integer.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_optional_integer.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_optional_integer.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_integer.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_integer.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_two_integers_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_two_integers.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_integers.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_two_integers.version}")
                return
            ...
            try:
                ...
                if response_topic is not None:
                self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_integers.version, MethodReturnCode.SERVER_DESERIALIZATION_ERROR, correlation_id, str(e))
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_integers.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_integers.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_only_string_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_only_string.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_only_string.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_only_string.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_only_string.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_only_string.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_string_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_string.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_string.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_string.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_string.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_string.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_optional_string_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_optional_string.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_optional_string.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_optional_string.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_string.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_string.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_two_strings_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_two_strings.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_strings.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_two_strings.version}")
                return
            ...
            try:
                ...
                self._logger.error("Failed to validate payload for %s: %s", topic, e)
                if response_topic is not None:
                self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_strings.version, MethodReturnCode.SERVER_DESERIALIZATION_ERROR, correlation_id, str(e))
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_strings.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_strings.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_struct_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_struct.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_struct.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_struct.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_struct.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_struct.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_optional_struct_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_optional_struct.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_optional_struct.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_optional_struct.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_struct.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_struct.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_two_structs_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_two_structs.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_structs.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_two_structs.version}")
                return
            ...
            try:
                ...
                self._logger.error("Failed to validate payload for %s: %s", topic, e)
                if response_topic is not None:
                self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_structs.version, MethodReturnCode.SERVER_DESERIALIZATION_ERROR, correlation_id, str(e))
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_structs.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_structs.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_only_enum_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_only_enum.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_only_enum.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_only_enum.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_only_enum.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_only_enum.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_enum_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_enum.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_enum.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_enum.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_enum.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_enum.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_optional_enum_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_optional_enum.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_optional_enum.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_optional_enum.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_enum.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_enum.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_two_enums_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_two_enums.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_enums.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_two_enums.version}")
                return
            ...
            try:
                ...
                self._logger.error("Failed to validate payload for %s: %s", topic, e)
                if response_topic is not None:
                self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_enums.version, MethodReturnCode.SERVER_DESERIALIZATION_ERROR, correlation_id, str(e))
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_enums.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_enums.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_datetime_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_datetime.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_datetime.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_datetime.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_datetime.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_datetime.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_optional_datetime_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_optional_datetime.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_optional_datetime.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_optional_datetime.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_datetime.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_datetime.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_two_datetimes_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_two_datetimes.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_datetimes.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_two_datetimes.version}")
                return
            ...
            try:
                ...
                self._logger.error("Failed to validate payload for %s: %s", topic, e)
                if response_topic is not None:
                self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_datetimes.version, MethodReturnCode.SERVER_DESERIALIZATION_ERROR, correlation_id, str(e))
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_datetimes.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_datetimes.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_duration_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_duration.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_duration.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_duration.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_duration.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_duration.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_optional_duration_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_optional_duration.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_optional_duration.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_optional_duration.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_duration.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_duration.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_two_durations_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_two_durations.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_durations.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_two_durations.version}")
                return
            ...
            try:
                ...
                self._logger.error("Failed to validate payload for %s: %s", topic, e)
                if response_topic is not None:
                self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_durations.version, MethodReturnCode.SERVER_DESERIALIZATION_ERROR, correlation_id, str(e))
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_durations.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_durations.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_binary_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_binary.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_binary.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_binary.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_binary.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_binary.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_optional_binary_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_optional_binary.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_optional_binary.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_optional_binary.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_binary.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_optional_binary.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_two_binaries_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_two_binaries.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_binaries.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_two_binaries.version}")
                return
            ...
            try:
                ...
                self._logger.error("Failed to validate payload for %s: %s", topic, e)
                if response_topic is not None:
                self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_two_binaries.version, MethodReturnCode.SERVER_DESERIALIZATION_ERROR, correlation_id, str(e))
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_binaries.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_two_binaries.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_list_of_strings_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_list_of_strings.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_list_of_strings.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_list_of_strings.version}")
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_list_of_strings.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_list_of_strings.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _receive_read_write_lists_update_request_message(self, topic: str, payload: str, properties: Dict[str, Any]):
        ...
        try:
            if prop_version != self._property_read_write_lists.version:
                ...
                if response_topic is not None:
                    self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_lists.version, MethodReturnCode.OUT_OF_SYNC, correlation_id, f"Request version {prop_version} does not match current version {self._property_read_write_lists.version}")
                return
            ...
            try:
                ...
                self._logger.error("Failed to validate payload for %s: %s", topic, e)
                if response_topic is not None:
                self._conn.publish_property_response(response_topic, existing_prop_obj, self._property_read_write_lists.version, MethodReturnCode.SERVER_DESERIALIZATION_ERROR, correlation_id, str(e))
                return
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_lists.version, MethodReturnCode.SUCCESS, correlation_id)
            else:
                self._logger.warning("No response topic provided for property update of %s", topic)
            ...
            if response_topic is not None:
                ...
                self._conn.publish_property_response(response_topic, prop_obj, self._property_read_write_lists.version, MethodReturnCode.SERVER_ERROR, correlation_id, str(e))
    ...
    def _process_call_three_integers_call(self, topic: str, payload_str: str, properties: Dict[str, Any]):
        ...
        if self._method_call_three_integers.callback is not None:
            method_args = [payload.input1, payload.input2, payload.input3, ]
    ...
    def _process_call_two_lists_call(self, topic: str, payload_str: str, properties: Dict[str, Any]):
        ...
        if self._method_call_two_lists.callback is not None:
            method_args = [payload.input1, payload.input2, ]
