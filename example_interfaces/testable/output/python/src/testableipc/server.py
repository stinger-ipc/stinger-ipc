...
class TestableServer:
    ...
    def __init__(self, connection: stinger::utils::IConnection, instance_id: str, initial_property_values: TestableInitialPropertyValues, prefix: str):
        ...
        self._property_read_write_optional_integer: PropertyControls[Optional[int]] = PropertyControls(value=initial_property_values.read_write_optional_integer, version=initial_property_values.read_write_optional_integer_version)
        ...
        self._property_read_write_optional_string: PropertyControls[Optional[str]] = PropertyControls(value=initial_property_values.read_write_optional_string, version=initial_property_values.read_write_optional_string_version)
        ...
        self._property_read_write_optional_struct: PropertyControls[Optional[AllTypes]] = PropertyControls(value=initial_property_values.read_write_optional_struct, version=initial_property_values.read_write_optional_struct_version)
        ...
        self._property_read_write_optional_enum: PropertyControls[Optional[Numbers]] = PropertyControls(value=initial_property_values.read_write_optional_enum, version=initial_property_values.read_write_optional_enum_version)
        ...
        self._property_read_write_optional_datetime: PropertyControls[Optional[datetime]] = PropertyControls(value=initial_property_values.read_write_optional_datetime, version=initial_property_values.read_write_optional_datetime_version)
        ...
        self._property_read_write_optional_duration: PropertyControls[Optional[timedelta]] = PropertyControls(value=initial_property_values.read_write_optional_duration, version=initial_property_values.read_write_optional_duration_version)
        ...
        self._property_read_write_optional_binary: PropertyControls[Optional[bytes]] = PropertyControls(value=initial_property_values.read_write_optional_binary, version=initial_property_values.read_write_optional_binary_version)
        ...
        self._property_read_write_list_of_strings: PropertyControls[List[str]] = PropertyControls(value=initial_property_values.read_write_list_of_strings, version=initial_property_values.read_write_list_of_strings_version)
    ...
    def emit_single_int(self, value: int):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleInt".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_optional_int(self, value: Optional[int]):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleOptionalInt".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_string(self, value: str):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleString".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_optional_string(self, value: Optional[str]):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleOptionalString".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_enum(self, value: Numbers):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleEnum".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_optional_enum(self, value: Optional[Numbers]):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleOptionalEnum".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_struct(self, value: AllTypes):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleStruct".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_optional_struct(self, value: Optional[AllTypes]):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleOptionalStruct".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_date_time(self, value: datetime):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleDateTime".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_optional_datetime(self, value: Optional[datetime]):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleOptionalDatetime".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_duration(self, value: timedelta):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleDuration".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_optional_duration(self, value: Optional[timedelta]):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleOptionalDuration".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_binary(self, value: bytes):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleBinary".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_optional_binary(self, value: Optional[bytes]):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleOptionalBinary".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_array_of_integers(self, values: List[int]):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleArrayOfIntegers".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def emit_single_optional_array_of_strings(self, values: Optional[List[str]]):
        ...
        signal_topic = "{prefix}/testable/{service_id}/signal/singleOptionalArrayOfStrings".format(**self._topic_template_kwargs)
        sig_msg = MessageCreator.signal_message(signal_topic, payload)
        self._conn.publish(sig_msg)
    ...
    def on_read_write_optional_struct_updated(self, handler: Callable[[Optional[AllTypes]], None]):
    ...
    def on_read_write_two_structs_updated(self, handler: Callable[[AllTypes, Optional[AllTypes]], None]):
    ...
    def on_read_write_optional_binary_updated(self, handler: Callable[[Optional[bytes]], None]):
    ...
    def on_read_write_two_binaries_updated(self, handler: Callable[[bytes, Optional[bytes]], None]):
    ...
    def on_read_write_lists_updated(self, handler: Callable[[List[Numbers], Optional[List[datetime]]], None]):
...
class TestableServerBuilder:
    ...
    def __init__(self):
        ...
        self._call_optional_struct_method_handler: Optional[Callable[[Optional[AllTypes]], Optional[AllTypes]]] = None
        self._call_three_structs_method_handler: Optional[Callable[[Optional[AllTypes], AllTypes, AllTypes], CallThreeStructsMethodResponse]] = None
        ...
        self._call_optional_binary_method_handler: Optional[Callable[[Optional[bytes]], Optional[bytes]]] = None
        self._call_three_binaries_method_handler: Optional[Callable[[bytes, bytes, Optional[bytes]], CallThreeBinariesMethodResponse]] = None
        ...
        self._read_write_optional_struct_property_callbacks: List[Callable[[Optional[AllTypes]], None]] = []
        self._read_write_two_structs_property_callbacks: List[Callable[[AllTypes, Optional[AllTypes]], None]] = []
        ...
        self._read_write_optional_binary_property_callbacks: List[Callable[[Optional[bytes]], None]] = []
        self._read_write_two_binaries_property_callbacks: List[Callable[[bytes, Optional[bytes]], None]] = []
        self._read_write_list_of_strings_property_callbacks: List[Callable[[List[str]], None]] = []
        self._read_write_lists_property_callbacks: List[Callable[[List[Numbers], Optional[List[datetime]]], None]] = []
    ...
    def build(self, connection: stinger::utils::IConnection, instance_id: str, initial_property_values: TestableInitialPropertyValues, prefix: str, binding: Optional[Any]=None) -> TestableServer:
        new_server = TestableServer(connection, instance_id, initial_property_values, prefix, )
