...
class Entry(BaseModel):
    ...
    key: Annotated[int, Field(description="An identifier.", )]
    value: Annotated[str, Field(description="A name.", )]
...
class AllTypes(BaseModel):
    ...
    the_number: Annotated[float, Field(description="A floating point number.  Bool and int do not have descriptions.", )]
    the_str: Annotated[str, Field(description="A string type.", )]
    the_enum: Annotated[Numbers, Field(description="An enum type", )]
    an_entry_object: Annotated[Entry, Field(description="A struct type.", )]
    date_and_time: Annotated[datetime, Field(description="A date and time type.", )]
    time_duration: Annotated[timedelta, Field(description="A duration type.", )]
    data: Annotated[bytes, Field(description="A binary type.", ), PlainValidator(base64_decode_if_str), PlainSerializer(lambda v: base64.b64encode(v).decode('utf-8'))]
    ...
    optional_binary: Annotated[Optional[bytes], Field(description="An optional binary type.", alias="OptionalBinary"), PlainValidator(base64_decode_if_str), PlainSerializer(lambda v: base64.b64encode(v).decode('utf-8') if v is not None else None)]

    array_of_integers: Annotated[List[int], Field(description="An array of integers.", )]



    optional_array_of_integers: Annotated[Optional[List[int]], Field(description="An optional array of integers.", )]



    array_of_strings: Annotated[List[str], Field(description="An array of strings.", )]



    optional_array_of_strings: Annotated[Optional[List[str]], Field(description="An optional array of strings.", )]



    array_of_enums: Annotated[List[Numbers], Field(description="An array of enums.", )]



    optional_array_of_enums: Annotated[Optional[List[Numbers]], Field(description="An optional array of enums.", )]



    array_of_datetimes: Annotated[List[datetime], Field(description="An array of date and time values.", )]



    optional_array_of_datetimes: Annotated[Optional[List[datetime]], Field(description="An optional array of date and time values.", )]



    array_of_durations: Annotated[List[timedelta], Field(description="An array of duration values.", )]



    optional_array_of_durations: Annotated[Optional[List[timedelta]], Field(description="An optional array of duration values.", )]


    array_of_binaries: Annotated[List[bytes], Field(description="An array of binary values.", ), PlainValidator(lambda arr: [base64_decode_if_str(v) for v in arr]), PlainSerializer(lambda arr: [base64.b64encode(v).decode("utf-8") for v in arr])]



    optional_array_of_binaries: Annotated[Optional[List[bytes]], Field(description="An optional array of binary values.", ), PlainValidator(lambda arr: [base64_decode_if_str(v) for v in arr]), PlainSerializer(lambda arr: [base64.b64encode(v).decode("utf-8") for v in arr])]




    array_of_entry_objects: Annotated[List[Entry], Field(description="An array of struct values.", )]



    optional_array_of_entry_objects: Annotated[Optional[List[Entry]], Field(description="An optional array of struct values.", )]
...
class SingleIntSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[int, Field(description="The integer value.", )]
...
class SingleOptionalIntSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[Optional[int], Field(description="The integer value.", )]
...
class ThreeIntegersSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[int, Field(description="The first integer value.", )]
    second: Annotated[int, Field(description="The second integer value.", )]
    third: Annotated[Optional[int], Field(description="The third integer value.", )]
...
class SingleStringSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[str, Field(description="The string value.", )]
...
class SingleOptionalStringSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[Optional[str], Field(description="The string value.", )]
...
class ThreeStringsSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[str, Field(description="The first string value.", )]
    second: Annotated[str, Field(description="The second string value.", )]
    third: Annotated[Optional[str], Field(description="The third string value.", )]
...
class SingleEnumSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[Numbers, Field(description="The enum value.", )]
...
class SingleOptionalEnumSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[Optional[Numbers], Field(description="The enum value.", )]
...
class ThreeEnumsSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[Numbers, Field(description="The first enum value.", )]
    second: Annotated[Numbers, Field(description="The second enum value.", )]
    third: Annotated[Optional[Numbers], Field(description="The third enum value.", )]
...
class SingleStructSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[AllTypes, Field(description="The struct value.", )]
...
class SingleOptionalStructSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[Optional[AllTypes], Field(description="The struct value.", )]
...
class ThreeStructsSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[AllTypes, Field(description="The first struct value.", )]
    second: Annotated[AllTypes, Field(description="The second struct value.", )]
    third: Annotated[Optional[AllTypes], Field(description="The third struct value.", )]
...
class SingleDateTimeSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[datetime, Field(description="The date and time value.", )]
...
class SingleOptionalDatetimeSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[Optional[datetime], Field(description="The date and time value.", )]
...
class ThreeDateTimesSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[datetime, Field(description="The first date and time value.", )]
    second: Annotated[datetime, Field(description="The second date and time value.", )]
    third: Annotated[Optional[datetime], Field(description="The third date and time value.", )]
...
class SingleDurationSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[timedelta, Field(description="The duration value.", )]
...
class SingleOptionalDurationSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[Optional[timedelta], Field(description="The duration value.", )]
...
class ThreeDurationsSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[timedelta, Field(description="The first duration value.", )]
    second: Annotated[timedelta, Field(description="The second duration value.", )]
    third: Annotated[Optional[timedelta], Field(description="The third duration value.", )]
...
class SingleBinarySignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[bytes, Field(description="The binary value.", ), PlainValidator(base64_decode_if_str), PlainSerializer(lambda v: base64.b64encode(v).decode('utf-8'))]
...
class SingleOptionalBinarySignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    value: Annotated[Optional[bytes], Field(description="The binary value.", ), PlainValidator(base64_decode_if_str), PlainSerializer(lambda v: base64.b64encode(v).decode('utf-8') if v is not None else None)]
...
class ThreeBinariesSignalPayload(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[bytes, Field(description="The first binary value.", ), PlainValidator(base64_decode_if_str), PlainSerializer(lambda v: base64.b64encode(v).decode('utf-8'))]
    second: Annotated[bytes, Field(description="The second binary value.", ), PlainValidator(base64_decode_if_str), PlainSerializer(lambda v: base64.b64encode(v).decode('utf-8'))]
    third: Annotated[Optional[bytes], Field(description="The third binary value.", ), PlainValidator(base64_decode_if_str), PlainSerializer(lambda v: base64.b64encode(v).decode('utf-8') if v is not None else None)]
...
class SingleArrayOfIntegersSignalPayload(BaseModel):
    ...
    values: Annotated[List[int], Field(description="The array of integers.", )]
...
class SingleOptionalArrayOfStringsSignalPayload(BaseModel):
    ...
    values: Annotated[Optional[List[str]], Field(description="The array of strings.", )]
...
class ArrayOfEveryTypeSignalPayload(BaseModel):
    ...
    first_of_integers: Annotated[List[int], Field(description="The first array of integers.", )]



    second_of_floats: Annotated[List[float], Field(description="The second array of floats.", )]



    third_of_strings: Annotated[List[str], Field(description="The third array of strings.", )]



    fourth_of_enums: Annotated[List[Numbers], Field(description="The fourth array of enums.", )]



    fifth_of_structs: Annotated[List[Entry], Field(description="The fifth array of structs.", )]



    sixth_of_datetimes: Annotated[List[datetime], Field(description="The sixth array of date and time values.", )]



    seventh_of_durations: Annotated[List[timedelta], Field(description="The seventh array of duration values.", )]


    eighth_of_binaries: Annotated[List[bytes], Field(description="The eighth array of binary values.", ), PlainValidator(lambda arr: [base64_decode_if_str(v) for v in arr]), PlainSerializer(lambda arr: [base64.b64encode(v).decode("utf-8") for v in arr])]
...
class ReadWriteTwoIntegersProperty(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[int, Field(description="An integer value.", )]
...
class ReadWriteTwoStringsProperty(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[str, Field(description="A string value.", )]
...
class ReadWriteTwoStructsProperty(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[AllTypes, Field(description="A struct value.", )]
...
class ReadWriteTwoEnumsProperty(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[Numbers, Field(description="An enum value.", )]
...
class ReadWriteTwoDatetimesProperty(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[datetime, Field(description="A date and time value.", )]
...
class ReadWriteTwoDurationsProperty(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[timedelta, Field(description="A duration of time.", )]
...
class ReadWriteTwoBinariesProperty(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    first: Annotated[bytes, Field(description="A binary blob of data.", ), PlainValidator(base64_decode_if_str), PlainSerializer(lambda v: base64.b64encode(v).decode('utf-8'))]
...
class CallThreeIntegersMethodRequest(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    input1: Annotated[int, Field(description="The first integer input.  The other two don't have descriptions.", )]
...
class CallThreeIntegersMethodResponse(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    output1: Annotated[int, Field(description="The first integer output.  The other two don't have descriptions.", )]
...
class CallThreeStringsMethodRequest(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    input1: Annotated[str, Field(description="The first string input.  The other two don't have descriptions.", )]
...
class CallThreeStringsMethodResponse(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    output1: Annotated[str, Field(description="The first string output.  The other two don't have descriptions.", )]
...
class CallThreeEnumsMethodRequest(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    input1: Annotated[Numbers, Field(description="The first enum input.  The other two don't have descriptions.", )]
...
class CallThreeEnumsMethodResponse(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    output1: Annotated[Numbers, Field(description="The first enum output.  The other two don't have descriptions.", )]
...
class CallThreeStructsMethodRequest(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    input1: Annotated[Optional[AllTypes], Field(description="The first struct input.  The other two don't have descriptions.", )]
...
class CallThreeStructsMethodResponse(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    output1: Annotated[Optional[AllTypes], Field(description="The first struct output.  The other two don't have descriptions.", )]
...
class CallThreeDateTimesMethodRequest(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    input1: Annotated[datetime, Field(description="The first date and time input.  The other two don't have descriptions.", )]
...
class CallThreeDateTimesMethodResponse(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    output1: Annotated[datetime, Field(description="The first date and time output.  The other two don't have descriptions.", )]
...
class CallThreeDurationsMethodRequest(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    input1: Annotated[timedelta, Field(description="The first duration input.  The other two don't have descriptions.", )]
...
class CallThreeDurationsMethodResponse(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    output1: Annotated[timedelta, Field(description="The first duration output.  The other two don't have descriptions.", )]
...
class CallThreeBinariesMethodRequest(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    input1: Annotated[bytes, Field(description="The first binary input.  The other two don't have descriptions.", ), PlainValidator(base64_decode_if_str), PlainSerializer(lambda v: base64.b64encode(v).decode('utf-8'))]
...
class CallThreeBinariesMethodResponse(BaseModel):
    ...
    model_config = ConfigDict(populate_by_name=True)
    output1: Annotated[bytes, Field(description="The first binary output.  The other two don't have descriptions.", ), PlainValidator(base64_decode_if_str), PlainSerializer(lambda v: base64.b64encode(v).decode('utf-8'))]
...
class CallTwoListsMethodRequest(BaseModel):
    ...
    input1: Annotated[List[Numbers], Field(description="The first list of enums.", )]
...
class CallTwoListsMethodResponse(BaseModel):
    ...
    output1: Annotated[List[Numbers], Field(description="The first list of enums.", )]
