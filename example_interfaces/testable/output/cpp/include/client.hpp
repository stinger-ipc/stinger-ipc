...
public:
    ...
    void registerThreeIntegersCallback(const std::function<void(int, int, std::optional<int>)>& cb);
    ...
    void registerSingleOptionalStringCallback(const std::function<void(std::optional<std::string>)>& cb);

    // Register a callback for the `threeStrings` signal.
    // The provided method will be called whenever a `threeStrings` is received.
    void registerThreeStringsCallback(const std::function<void(std::string, std::string, std::optional<std::string>)>& cb);
    ...
    void registerSingleOptionalEnumCallback(const std::function<void(std::optional<Numbers>)>& cb);

    // Register a callback for the `threeEnums` signal.
    // The provided method will be called whenever a `threeEnums` is received.
    void registerThreeEnumsCallback(const std::function<void(Numbers, Numbers, std::optional<Numbers>)>& cb);
    ...
    void registerSingleOptionalStructCallback(const std::function<void(std::optional<AllTypes>)>& cb);

    // Register a callback for the `threeStructs` signal.
    // The provided method will be called whenever a `threeStructs` is received.
    void registerThreeStructsCallback(const std::function<void(AllTypes, AllTypes, std::optional<AllTypes>)>& cb);
    ...
    void registerSingleOptionalDatetimeCallback(const std::function<void(std::optional<std::chrono::time_point<std::chrono::system_clock>>)>& cb);
    ...
    void registerThreeDateTimesCallback(const std::function<void(std::chrono::time_point<std::chrono::system_clock>, std::chrono::time_point<std::chrono::system_clock>, std::optional<std::chrono::time_point<std::chrono::system_clock>>)>& cb);
    ...
    void registerSingleOptionalDurationCallback(const std::function<void(std::optional<std::chrono::duration<double>>)>& cb);
    ...
    void registerThreeDurationsCallback(const std::function<void(std::chrono::duration<double>, std::chrono::duration<double>, std::optional<std::chrono::duration<double>>)>& cb);
    ...
    void registerSingleOptionalBinaryCallback(const std::function<void(std::optional<std::vector<uint8_t>>)>& cb);

    // Register a callback for the `threeBinaries` signal.
    // The provided method will be called whenever a `threeBinaries` is received.
    void registerThreeBinariesCallback(const std::function<void(std::vector<uint8_t>, std::vector<uint8_t>, std::optional<std::vector<uint8_t>>)>& cb);
    ...
    void registerSingleOptionalArrayOfStringsCallback(const std::function<void(std::optional<std::vector<std::string>>)>& cb);
    ...
    std::future<void> callWithNothing();
    ...
    std::future<int> callOneInteger(int input1);

    // Calls the `callOptionalInteger` method.
    // Returns a future.  When that future resolves, it will have the returned value. <ArgPrimitive name=output1 type=int>
    std::future<std::optional<int>> callOptionalInteger(std::optional<int> input1);
    ...
    std::future<CallThreeIntegersReturnValues> callThreeIntegers(int input1, int input2, std::optional<int> input3);
    ...
    std::future<std::string> callOneString(std::string input1);

    // Calls the `callOptionalString` method.
    // Returns a future.  When that future resolves, it will have the returned value. <ArgPrimitive name=output1 type=str>
    std::future<std::optional<std::string>> callOptionalString(std::optional<std::string> input1);
    ...
    std::future<CallThreeStringsReturnValues> callThreeStrings(std::string input1, std::optional<std::string> input2, std::string input3);
    ...
    std::future<Numbers> callOneEnum(Numbers input1);

    // Calls the `callOptionalEnum` method.
    // Returns a future.  When that future resolves, it will have the returned value. <ArgEnum name=output1>
    std::future<std::optional<Numbers>> callOptionalEnum(std::optional<Numbers> input1);
    ...
    std::future<CallThreeEnumsReturnValues> callThreeEnums(Numbers input1, Numbers input2, std::optional<Numbers> input3);
    ...
    std::future<AllTypes> callOneStruct(AllTypes input1);

    // Calls the `callOptionalStruct` method.
    // Returns a future.  When that future resolves, it will have the returned value. <ArgStruct name=output1>
    std::future<std::optional<AllTypes>> callOptionalStruct(std::optional<AllTypes> input1);
    ...
    std::future<CallThreeStructsReturnValues> callThreeStructs(std::optional<AllTypes> input1, AllTypes input2, AllTypes input3);
    ...
    std::future<std::chrono::time_point<std::chrono::system_clock>> callOneDateTime(std::chrono::time_point<std::chrono::system_clock> input1);

    // Calls the `callOptionalDateTime` method.
    // Returns a future.  When that future resolves, it will have the returned value. <ArgDateTime name=output1>
    std::future<std::optional<std::chrono::time_point<std::chrono::system_clock>>> callOptionalDateTime(std::optional<std::chrono::time_point<std::chrono::system_clock>> input1);
    ...
    std::future<CallThreeDateTimesReturnValues> callThreeDateTimes(std::chrono::time_point<std::chrono::system_clock> input1, std::chrono::time_point<std::chrono::system_clock> input2, std::optional<std::chrono::time_point<std::chrono::system_clock>> input3);
    ...
    std::future<std::chrono::duration<double>> callOneDuration(std::chrono::duration<double> input1);

    // Calls the `callOptionalDuration` method.
    // Returns a future.  When that future resolves, it will have the returned value. <ArgDuration name=output1>
    std::future<std::optional<std::chrono::duration<double>>> callOptionalDuration(std::optional<std::chrono::duration<double>> input1);
    ...
    std::future<CallThreeDurationsReturnValues> callThreeDurations(std::chrono::duration<double> input1, std::chrono::duration<double> input2, std::optional<std::chrono::duration<double>> input3);
    ...
    std::future<std::vector<uint8_t>> callOneBinary(std::vector<uint8_t> input1);

    // Calls the `callOptionalBinary` method.
    // Returns a future.  When that future resolves, it will have the returned value. <ArgBinary name=output1>
    std::future<std::optional<std::vector<uint8_t>>> callOptionalBinary(std::optional<std::vector<uint8_t>> input1);
    ...
    std::future<CallThreeBinariesReturnValues> callThreeBinaries(std::vector<uint8_t> input1, std::vector<uint8_t> input2, std::optional<std::vector<uint8_t>> input3);
    ...
    std::future<std::vector<int>> callOneListOfIntegers(std::vector<int> input1);
    ...
    std::future<std::optional<std::vector<double>>> callOptionalListOfFloats(std::optional<std::vector<double>> input1);
    ...
    std::future<CallTwoListsReturnValues> callTwoLists(std::vector<Numbers> input1, std::optional<std::vector<std::string>> input2);
    ...
    std::future<bool> updateReadWriteIntegerProperty(int) const;
    ...
    std::future<bool> updateReadWriteOptionalIntegerProperty(std::optional<int>) const;
    ...
    std::future<bool> updateReadWriteTwoIntegersProperty(int, std::optional<int>) const;
    ...
    std::future<bool> updateReadWriteStringProperty(std::string) const;
    ...
    std::future<bool> updateReadWriteOptionalStringProperty(std::optional<std::string>) const;
    ...
    std::future<bool> updateReadWriteTwoStringsProperty(std::string, std::optional<std::string>) const;
    ...
    std::future<bool> updateReadWriteStructProperty(AllTypes) const;
    ...
    std::future<bool> updateReadWriteOptionalStructProperty(std::optional<AllTypes>) const;
    ...
    std::future<bool> updateReadWriteTwoStructsProperty(AllTypes, std::optional<AllTypes>) const;
    ...
    std::future<bool> updateReadWriteEnumProperty(Numbers) const;
    ...
    std::future<bool> updateReadWriteOptionalEnumProperty(std::optional<Numbers>) const;
    ...
    std::future<bool> updateReadWriteTwoEnumsProperty(Numbers, std::optional<Numbers>) const;
    ...
    std::future<bool> updateReadWriteDatetimeProperty(std::chrono::time_point<std::chrono::system_clock>) const;
    ...
    std::future<bool> updateReadWriteOptionalDatetimeProperty(std::optional<std::chrono::time_point<std::chrono::system_clock>>) const;
    ...
    std::future<bool> updateReadWriteTwoDatetimesProperty(std::chrono::time_point<std::chrono::system_clock>, std::optional<std::chrono::time_point<std::chrono::system_clock>>) const;
    ...
    std::future<bool> updateReadWriteDurationProperty(std::chrono::duration<double>) const;
    ...
    std::future<bool> updateReadWriteOptionalDurationProperty(std::optional<std::chrono::duration<double>>) const;
    ...
    std::future<bool> updateReadWriteTwoDurationsProperty(std::chrono::duration<double>, std::optional<std::chrono::duration<double>>) const;
    ...
    std::future<bool> updateReadWriteBinaryProperty(std::vector<uint8_t>) const;
    ...
    std::future<bool> updateReadWriteOptionalBinaryProperty(std::optional<std::vector<uint8_t>>) const;
    ...
    std::future<bool> updateReadWriteTwoBinariesProperty(std::vector<uint8_t>, std::optional<std::vector<uint8_t>>) const;
    ...
    std::future<bool> updateReadWriteListOfStringsProperty(std::vector<std::string>) const;
    ...
    std::future<bool> updateReadWriteListsProperty(std::vector<Numbers>, std::optional<std::vector<std::chrono::time_point<std::chrono::system_clock>>>) const;
...
private:
    ...
    std::vector<std::function<void(int, int, std::optional<int>)>> _threeIntegersSignalCallbacks;
    ...
    std::vector<std::function<void(std::string, std::string, std::optional<std::string>)>> _threeStringsSignalCallbacks;
    ...
    std::vector<std::function<void(std::optional<Numbers>)>> _singleOptionalEnumSignalCallbacks;
    ...
    std::vector<std::function<void(Numbers, Numbers, std::optional<Numbers>)>> _threeEnumsSignalCallbacks;
    ...
    std::vector<std::function<void(std::optional<AllTypes>)>> _singleOptionalStructSignalCallbacks;
    ...
    std::vector<std::function<void(AllTypes, AllTypes, std::optional<AllTypes>)>> _threeStructsSignalCallbacks;
    ...
    std::vector<std::function<void(std::optional<std::chrono::time_point<std::chrono::system_clock>>)>> _singleOptionalDatetimeSignalCallbacks;
    ...
    std::vector<std::function<void(std::chrono::time_point<std::chrono::system_clock>, std::chrono::time_point<std::chrono::system_clock>, std::optional<std::chrono::time_point<std::chrono::system_clock>>)>> _threeDateTimesSignalCallbacks;
    ...
    std::vector<std::function<void(std::optional<std::chrono::duration<double>>)>> _singleOptionalDurationSignalCallbacks;
    ...
    std::vector<std::function<void(std::chrono::duration<double>, std::chrono::duration<double>, std::optional<std::chrono::duration<double>>)>> _threeDurationsSignalCallbacks;
    ...
    std::vector<std::function<void(std::optional<std::vector<uint8_t>>)>> _singleOptionalBinarySignalCallbacks;
    ...
    std::vector<std::function<void(std::vector<uint8_t>, std::vector<uint8_t>, std::optional<std::vector<uint8_t>>)>> _threeBinariesSignalCallbacks;
    ...
    std::vector<std::function<void(std::optional<std::vector<std::string>>)>> _singleOptionalArrayOfStringsSignalCallbacks;
    ...
    std::map<std::string, std::promise<void>> _pendingCallWithNothingMethodCalls;
    ...
    std::map<std::string, std::promise<int>> _pendingCallOneIntegerMethodCalls;
    ...
    std::map<std::string, std::promise<std::optional<int>>> _pendingCallOptionalIntegerMethodCalls;
    ...
    std::map<std::string, std::promise<CallThreeIntegersReturnValues>> _pendingCallThreeIntegersMethodCalls;
    ...
    std::map<std::string, std::promise<std::string>> _pendingCallOneStringMethodCalls;
    ...
    std::map<std::string, std::promise<std::optional<std::string>>> _pendingCallOptionalStringMethodCalls;
    ...
    std::map<std::string, std::promise<CallThreeStringsReturnValues>> _pendingCallThreeStringsMethodCalls;
    ...
    std::map<std::string, std::promise<Numbers>> _pendingCallOneEnumMethodCalls;
    ...
    std::map<std::string, std::promise<std::optional<Numbers>>> _pendingCallOptionalEnumMethodCalls;
    ...
    std::map<std::string, std::promise<CallThreeEnumsReturnValues>> _pendingCallThreeEnumsMethodCalls;
    ...
    std::map<std::string, std::promise<AllTypes>> _pendingCallOneStructMethodCalls;
    ...
    std::map<std::string, std::promise<std::optional<AllTypes>>> _pendingCallOptionalStructMethodCalls;
    ...
    std::map<std::string, std::promise<CallThreeStructsReturnValues>> _pendingCallThreeStructsMethodCalls;
    ...
    std::map<std::string, std::promise<std::chrono::time_point<std::chrono::system_clock>>> _pendingCallOneDateTimeMethodCalls;
    ...
    std::map<std::string, std::promise<std::optional<std::chrono::time_point<std::chrono::system_clock>>>> _pendingCallOptionalDateTimeMethodCalls;
    ...
    std::map<std::string, std::promise<CallThreeDateTimesReturnValues>> _pendingCallThreeDateTimesMethodCalls;
    ...
    std::map<std::string, std::promise<std::chrono::duration<double>>> _pendingCallOneDurationMethodCalls;
    ...
    std::map<std::string, std::promise<std::optional<std::chrono::duration<double>>>> _pendingCallOptionalDurationMethodCalls;
    ...
    std::map<std::string, std::promise<CallThreeDurationsReturnValues>> _pendingCallThreeDurationsMethodCalls;
    ...
    std::map<std::string, std::promise<std::vector<uint8_t>>> _pendingCallOneBinaryMethodCalls;
    ...
    std::map<std::string, std::promise<std::optional<std::vector<uint8_t>>>> _pendingCallOptionalBinaryMethodCalls;
    ...
    std::map<std::string, std::promise<CallThreeBinariesReturnValues>> _pendingCallThreeBinariesMethodCalls;
    ...
    std::map<std::string, std::promise<std::vector<int>>> _pendingCallOneListOfIntegersMethodCalls;
    ...
    std::map<std::string, std::promise<std::optional<std::vector<double>>>> _pendingCallOptionalListOfFloatsMethodCalls;
    ...
    std::map<std::string, std::promise<CallTwoListsReturnValues>> _pendingCallTwoListsMethodCalls;
