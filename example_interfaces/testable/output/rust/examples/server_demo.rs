...
use test__able_ipc::server::{ TestAbleServer, TestAbleMethodHandlers };
...
impl TestAbleMethodHandlers for TestAbleMethodImpl {
    ...
    async fn handle_call_optional_integer(&self, _input1: Option<i32>) -> Result<Option<i32>, MethodReturnCode> {
        println!("Handling callOptionalInteger");
        Ok(Some(42))
        
    }
    
    async fn handle_call_three_integers(&self, _input1: i32, _input2: i32, _input3: Option<i32>) -> Result<CallThreeIntegersReturnValues, MethodReturnCode> {
    ...
    async fn handle_call_optional_string(&self, _input1: Option<String>) -> Result<Option<String>, MethodReturnCode> {
        println!("Handling callOptionalString");
        Ok(Some("apples".to_string()))
        
    }
    
    async fn handle_call_three_strings(&self, _input1: String, _input2: Option<String>, _input3: String) -> Result<CallThreeStringsReturnValues, MethodReturnCode> {
    ...
    async fn handle_call_optional_enum(&self, _input1: Option<Numbers>) -> Result<Option<Numbers>, MethodReturnCode> {
        println!("Handling callOptionalEnum");
        Ok(Some(Numbers::One))
        
    }
    
    async fn handle_call_three_enums(&self, _input1: Numbers, _input2: Numbers, _input3: Option<Numbers>) -> Result<CallThreeEnumsReturnValues, MethodReturnCode> {
    ...
    async fn handle_call_one_struct(&self, _input1: AllTypes) -> Result<AllTypes, MethodReturnCode> {
    ...
    async fn handle_call_optional_struct(&self, _input1: AllTypes) -> Result<AllTypes, MethodReturnCode> {
    ...
    async fn handle_call_three_structs(&self, _input1: AllTypes, _input2: AllTypes, _input3: AllTypes) -> Result<CallThreeStructsReturnValues, MethodReturnCode> {
        println!("Handling callThreeStructs");
        let rv = CallThreeStructsReturnValues {
            output1: AllTypes {the_bool: true, the_int: 42, the_number: 3.14, the_str: "apples".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(3536), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(42), OptionalString: Some("apples".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(3536), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]},
            output2: AllTypes {the_bool: true, the_int: 42, the_number: 3.14, the_str: "apples".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(3536), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(42), OptionalString: Some("apples".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(3536), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]},
            output3: AllTypes {the_bool: true, the_int: 42, the_number: 3.14, the_str: "apples".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(3536), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(42), OptionalString: Some("apples".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(3536), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]},
    ...
    async fn handle_call_one_date_time(&self, _input1: chrono::DateTime<chrono::Utc>) -> Result<chrono::DateTime<chrono::Utc>, MethodReturnCode> {
        println!("Handling callOneDateTime");
        Ok(chrono::Utc::now())
        
    }
    
    async fn handle_call_optional_date_time(&self, _input1: chrono::DateTime<chrono::Utc>) -> Result<chrono::DateTime<chrono::Utc>, MethodReturnCode> {
        println!("Handling callOptionalDateTime");
        Ok(chrono::Utc::now())
        
    }
    
    async fn handle_call_three_date_times(&self, _input1: chrono::DateTime<chrono::Utc>, _input2: chrono::DateTime<chrono::Utc>, _input3: chrono::DateTime<chrono::Utc>) -> Result<CallThreeDateTimesReturnValues, MethodReturnCode> {
    ...
    async fn handle_call_one_duration(&self, _input1: chrono::Duration) -> Result<chrono::Duration, MethodReturnCode> {
        println!("Handling callOneDuration");
        Ok(chrono::Duration::seconds(3536))
        
    }
    
    async fn handle_call_optional_duration(&self, _input1: chrono::Duration) -> Result<chrono::Duration, MethodReturnCode> {
        println!("Handling callOptionalDuration");
        Ok(chrono::Duration::seconds(3536))
        
    }
    
    async fn handle_call_three_durations(&self, _input1: chrono::Duration, _input2: chrono::Duration, _input3: chrono::Duration) -> Result<CallThreeDurationsReturnValues, MethodReturnCode> {
    ...
    async fn handle_call_optional_binary(&self, _input1: Vec<u8>) -> Result<Vec<u8>, MethodReturnCode> {
        println!("Handling callOptionalBinary");
        Ok(vec![101, 120, 97, 109, 112, 108, 101])
        
    }
    
    async fn handle_call_three_binaries(&self, _input1: Vec<u8>, _input2: Vec<u8>, _input3: Vec<u8>) -> Result<CallThreeBinariesReturnValues, MethodReturnCode> {
...
async fn main() {
    ...
    block_on(async {
        ...
        let handlers: Arc<Mutex<Box<dyn TestAbleMethodHandlers>>> = Arc::new(Mutex::new(Box::new(TestAbleMethodImpl::new())));

        let mut server = TestAbleServer::new(&mut connection, handlers.clone(), "rust-server-demo:1".to_string()).await;
        ...
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_optional_integer': {:?}", e);
        }
        ...
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_two_integers': {:?}", e);
        }
        ...
        let prop_init_future = server.set_read_write_optional_string(Some("apples".to_string())).await;
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_optional_string': {:?}", e);
        }
        ...
        let prop_init_future = server.set_read_write_optional_struct(AllTypes {the_bool: true, the_int: 42, the_number: 3.14, the_str: "apples".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(3536), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(42), OptionalString: Some("apples".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(3536), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]}).await;
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_optional_struct': {:?}", e);
        }
        ...
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_two_structs': {:?}", e);
        }
        ...
        let prop_init_future = server.set_read_write_optional_enum(Some(Numbers::One)).await;
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_optional_enum': {:?}", e);
        }
        ...
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_two_enums': {:?}", e);
        }
        ...
        let prop_init_future = server.set_read_write_optional_datetime(chrono::Utc::now()).await;
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_optional_datetime': {:?}", e);
        }
        ...
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_two_datetimes': {:?}", e);
        }
        
        println!("Setting initial value for property 'read_write_duration'");
        let prop_init_future = server.set_read_write_duration(chrono::Duration::seconds(3536)).await;
        if let Err(e) = prop_init_future.await {
        ...
        let prop_init_future = server.set_read_write_optional_duration(chrono::Duration::seconds(3536)).await;
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_optional_duration': {:?}", e);
        }
        ...
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_two_durations': {:?}", e);
        }
        
        println!("Setting initial value for property 'read_write_binary'");
        let prop_init_future = server.set_read_write_binary(vec![101, 120, 97, 109, 112, 108, 101]).await;
        if let Err(e) = prop_init_future.await {
        ...
        let prop_init_future = server.set_read_write_optional_binary(vec![101, 120, 97, 109, 112, 108, 101]).await;
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_optional_binary': {:?}", e);
        }
        ...
        if let Err(e) = prop_init_future.await {
            eprintln!("Error initializing property 'read_write_two_binaries': {:?}", e);
        }
        ...
        let signal_result_future = server.emit_single_optional_string(Some("apples".to_string())).await;
        let signal_result = signal_result_future.await;
        println!("Signal 'singleOptionalString' was sent: {:?}", signal_result);
        
        sleep(Duration::from_secs(1)).await;
        println!("Emitting signal 'threeStrings'");
        let signal_result_future = server.emit_three_strings("apples".to_string(), "apples".to_string(), Some("apples".to_string())).await;
        let signal_result = signal_result_future.await;
        ...
        let signal_result_future = server.emit_three_enums(Numbers::One, Numbers::One, Some(Numbers::One)).await;
        let signal_result = signal_result_future.await;
        ...
        let signal_result_future = server.emit_single_optional_struct(AllTypes {the_bool: true, the_int: 42, the_number: 3.14, the_str: "apples".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(3536), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(42), OptionalString: Some("apples".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(3536), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]}).await;
        let signal_result = signal_result_future.await;
        println!("Signal 'singleOptionalStruct' was sent: {:?}", signal_result);
        
        sleep(Duration::from_secs(1)).await;
        println!("Emitting signal 'threeStructs'");
        let signal_result_future = server.emit_three_structs(AllTypes {the_bool: true, the_int: 42, the_number: 3.14, the_str: "apples".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(3536), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(42), OptionalString: Some("apples".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(3536), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]}, AllTypes {the_bool: true, the_int: 42, the_number: 3.14, the_str: "apples".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(3536), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(42), OptionalString: Some("apples".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(3536), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]}, AllTypes {the_bool: true, the_int: 42, the_number: 3.14, the_str: "apples".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(3536), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(42), OptionalString: Some("apples".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(3536), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]}).await;
        let signal_result = signal_result_future.await;
        ...
        let signal_result_future = server.emit_single_optional_datetime(chrono::Utc::now()).await;
        let signal_result = signal_result_future.await;
        println!("Signal 'singleOptionalDatetime' was sent: {:?}", signal_result);
        
        sleep(Duration::from_secs(1)).await;
        println!("Emitting signal 'threeDateTimes'");
        let signal_result_future = server.emit_three_date_times(chrono::Utc::now(), chrono::Utc::now(), chrono::Utc::now()).await;
        let signal_result = signal_result_future.await;
        println!("Signal 'threeDateTimes' was sent: {:?}", signal_result);
        
        sleep(Duration::from_secs(1)).await;
        println!("Emitting signal 'singleDuration'");
        let signal_result_future = server.emit_single_duration(chrono::Duration::seconds(3536)).await;
        let signal_result = signal_result_future.await;
        println!("Signal 'singleDuration' was sent: {:?}", signal_result);
        
        sleep(Duration::from_secs(1)).await;
        println!("Emitting signal 'singleOptionalDuration'");
        let signal_result_future = server.emit_single_optional_duration(chrono::Duration::seconds(3536)).await;
        let signal_result = signal_result_future.await;
        println!("Signal 'singleOptionalDuration' was sent: {:?}", signal_result);
        
        sleep(Duration::from_secs(1)).await;
        println!("Emitting signal 'threeDurations'");
        let signal_result_future = server.emit_three_durations(chrono::Duration::seconds(3536), chrono::Duration::seconds(3536), chrono::Duration::seconds(3536)).await;
        let signal_result = signal_result_future.await;
        println!("Signal 'threeDurations' was sent: {:?}", signal_result);
        
        sleep(Duration::from_secs(1)).await;
        println!("Emitting signal 'singleBinary'");
        let signal_result_future = server.emit_single_binary(vec![101, 120, 97, 109, 112, 108, 101]).await;
        let signal_result = signal_result_future.await;
        println!("Signal 'singleBinary' was sent: {:?}", signal_result);
        
        sleep(Duration::from_secs(1)).await;
        println!("Emitting signal 'singleOptionalBinary'");
        let signal_result_future = server.emit_single_optional_binary(vec![101, 120, 97, 109, 112, 108, 101]).await;
        let signal_result = signal_result_future.await;
        println!("Signal 'singleOptionalBinary' was sent: {:?}", signal_result);
        
        sleep(Duration::from_secs(1)).await;
        println!("Emitting signal 'threeBinaries'");
        let signal_result_future = server.emit_three_binaries(vec![101, 120, 97, 109, 112, 108, 101], vec![101, 120, 97, 109, 112, 108, 101], vec![101, 120, 97, 109, 112, 108, 101]).await;
        let signal_result = signal_result_future.await;
        ...
        if let Err(e) = prop_change_future.await {
            eprintln!("Error changing property 'read_write_optional_integer': {:?}", e);
        }
        ...
        let prop_change_future = server.set_read_write_optional_string(Some("foo".to_string())).await;
        if let Err(e) = prop_change_future.await {
            eprintln!("Error changing property 'read_write_optional_string': {:?}", e);
        }
        ...
        let prop_change_future = server.set_read_write_struct(AllTypes {the_bool: true, the_int: 2022, the_number: 1.0, the_str: "foo".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(975), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(2022), OptionalString: Some("foo".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(975), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]}).await;
        if let Err(e) = prop_change_future.await {
        ...
        let prop_change_future = server.set_read_write_optional_struct(AllTypes {the_bool: true, the_int: 2022, the_number: 1.0, the_str: "foo".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(975), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(2022), OptionalString: Some("foo".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(975), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]}).await;
        if let Err(e) = prop_change_future.await {
            eprintln!("Error changing property 'read_write_optional_struct': {:?}", e);
        }
        
        sleep(Duration::from_secs(1)).await;
        println!("Changing property 'read_write_two_structs'");
        let new_value = ReadWriteTwoStructsProperty {
                first: AllTypes {the_bool: true, the_int: 2022, the_number: 1.0, the_str: "foo".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(967), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(2022), OptionalString: Some("foo".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(967), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]},
                second: AllTypes {the_bool: true, the_int: 2022, the_number: 1.0, the_str: "foo".to_string(), the_enum: Numbers::One, date_and_time: chrono::Utc::now(), time_duration: chrono::Duration::seconds(967), data: vec![101, 120, 97, 109, 112, 108, 101], OptionalInteger: Some(2022), OptionalString: Some("foo".to_string()), OptionalEnum: Some(Numbers::One), OptionalDateTime: chrono::Utc::now(), OptionalDuration: chrono::Duration::seconds(967), OptionalBinary: vec![101, 120, 97, 109, 112, 108, 101]},
        };
        ...
        let prop_change_future = server.set_read_write_optional_enum(Some(Numbers::One)).await;
        if let Err(e) = prop_change_future.await {
            eprintln!("Error changing property 'read_write_optional_enum': {:?}", e);
        }
        ...
        let prop_change_future = server.set_read_write_optional_datetime(chrono::Utc::now()).await;
        if let Err(e) = prop_change_future.await {
            eprintln!("Error changing property 'read_write_optional_datetime': {:?}", e);
        }
        ...
        let prop_change_future = server.set_read_write_duration(chrono::Duration::seconds(975)).await;
        if let Err(e) = prop_change_future.await {
        ...
        let prop_change_future = server.set_read_write_optional_duration(chrono::Duration::seconds(975)).await;
        if let Err(e) = prop_change_future.await {
            eprintln!("Error changing property 'read_write_optional_duration': {:?}", e);
        }
        ...
        let prop_change_future = server.set_read_write_binary(vec![101, 120, 97, 109, 112, 108, 101]).await;
        if let Err(e) = prop_change_future.await {
        ...
        let prop_change_future = server.set_read_write_optional_binary(vec![101, 120, 97, 109, 112, 108, 101]).await;
        if let Err(e) = prop_change_future.await {
            eprintln!("Error changing property 'read_write_optional_binary': {:?}", e);
        }
