...
impl<C: Mqtt5PubSub + Clone + Send + 'static> TestableClient<C> {
    ...
    pub async fn new(mut connection: C, discovery_info: DiscoveredService) -> Self {
        ...
        let topic_any_method_response =
            strfmt("client/{client_id}/testable/method/+/response", &topic_map).unwrap();
        ...
        topic_map.insert("signal_name".to_string(), "empty".to_string());
        let topic_empty_signal =
            strfmt("{prefix}/testable/{service_id}/signal/empty", &topic_map).unwrap();
        ...
        topic_map.insert("signal_name".to_string(), "singleInt".to_string());
        let topic_single_int_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "singleOptionalInt".to_string());
        let topic_single_optional_int_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "threeIntegers".to_string());
        let topic_three_integers_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "singleString".to_string());
        let topic_single_string_signal = strfmt(
        ...
        let topic_single_optional_string_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "threeStrings".to_string());
        let topic_three_strings_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "singleEnum".to_string());
        let topic_single_enum_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "singleOptionalEnum".to_string());
        let topic_single_optional_enum_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "threeEnums".to_string());
        let topic_three_enums_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "singleStruct".to_string());
        let topic_single_struct_signal = strfmt(
        ...
        let topic_single_optional_struct_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "threeStructs".to_string());
        let topic_three_structs_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "singleDateTime".to_string());
        let topic_single_date_time_signal = strfmt(
        ...
        let topic_single_optional_datetime_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "threeDateTimes".to_string());
        let topic_three_date_times_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "singleDuration".to_string());
        let topic_single_duration_signal = strfmt(
        ...
        let topic_single_optional_duration_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "threeDurations".to_string());
        let topic_three_durations_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "singleBinary".to_string());
        let topic_single_binary_signal = strfmt(
        ...
        let topic_single_optional_binary_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "threeBinaries".to_string());
        let topic_three_binaries_signal = strfmt(
        ...
        let topic_single_array_of_integers_signal = strfmt(
        ...
        let topic_single_optional_array_of_strings_signal = strfmt(
        ...
        topic_map.insert("signal_name".to_string(), "arrayOfEveryType".to_string());
        let topic_array_of_every_type_signal = strfmt(
        ...
        let topic_read_write_integer_property_value = strfmt(
        ...
        topic_map.insert("property_name".to_string(), "read_only_integer".to_string());
        let topic_read_only_integer_property_value = strfmt(
        ...
        let topic_read_write_optional_integer_property_value = strfmt(
        ...
        let topic_read_write_two_integers_property_value = strfmt(
        ...
        topic_map.insert("property_name".to_string(), "read_only_string".to_string());
        let topic_read_only_string_property_value = strfmt(
        ...
        topic_map.insert("property_name".to_string(), "read_write_string".to_string());
        let topic_read_write_string_property_value = strfmt(
        ...
        let topic_read_write_optional_string_property_value = strfmt(
        ...
        let topic_read_write_two_strings_property_value = strfmt(
        ...
        topic_map.insert("property_name".to_string(), "read_write_struct".to_string());
        let topic_read_write_struct_property_value = strfmt(
        ...
        let topic_read_write_optional_struct_property_value = strfmt(
        ...
        let topic_read_write_two_structs_property_value = strfmt(
        ...
        topic_map.insert("property_name".to_string(), "read_only_enum".to_string());
        let topic_read_only_enum_property_value = strfmt(
        ...
        topic_map.insert("property_name".to_string(), "read_write_enum".to_string());
        let topic_read_write_enum_property_value = strfmt(
        ...
        let topic_read_write_optional_enum_property_value = strfmt(
        ...
        let topic_read_write_two_enums_property_value = strfmt(
        ...
        let topic_read_write_datetime_property_value = strfmt(
        ...
        let topic_read_write_optional_datetime_property_value = strfmt(
        ...
        let topic_read_write_two_datetimes_property_value = strfmt(
        ...
        let topic_read_write_duration_property_value = strfmt(
        ...
        let topic_read_write_optional_duration_property_value = strfmt(
        ...
        let topic_read_write_two_durations_property_value = strfmt(
        ...
        topic_map.insert("property_name".to_string(), "read_write_binary".to_string());
        let topic_read_write_binary_property_value = strfmt(
        ...
        let topic_read_write_optional_binary_property_value = strfmt(
        ...
        let topic_read_write_two_binaries_property_value = strfmt(
        ...
        let topic_read_write_list_of_strings_property_value = strfmt(
        ...
        topic_map.insert("property_name".to_string(), "read_write_lists".to_string());
        let topic_read_write_lists_property_value = strfmt(
        ...
        let topic_any_property_update_response = strfmt(
            "client/{client_id}/testable/property/+/update/response",
            &topic_map,
        )
        .unwrap();
    ...
    async fn start_call_with_nothing(&mut self) -> oneshot::Receiver<MethodReturnCode> {
        ...
        let topic_param_map = HashMap::from([
            ...
            ("method_name".to_string(), "callWithNothing".to_string()),
        ...
        let response_topic: String = strfmt(
            "client/{client_id}/testable/method/+/response",
            &topic_param_map,
        )
        .unwrap();
    ...
    async fn start_call_one_integer(&mut self, input1: i32) -> oneshot::Receiver<MethodReturnCode> {
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOneInteger".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_optional_integer(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOptionalInteger".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_three_integers(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callThreeIntegers".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_one_string(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOneString".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_optional_string(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOptionalString".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_three_strings(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callThreeStrings".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_one_enum(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOneEnum".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_optional_enum(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOptionalEnum".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_three_enums(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callThreeEnums".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_one_struct(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOneStruct".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_optional_struct(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOptionalStruct".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_three_structs(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callThreeStructs".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_one_date_time(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOneDateTime".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_optional_date_time(
        ...
        let topic_param_map = HashMap::from([
            ...
            (
                ...
                "callOptionalDateTime".to_string(),
            ),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
    ...
    async fn start_call_three_date_times(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callThreeDateTimes".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_one_duration(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOneDuration".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_optional_duration(
        ...
        let topic_param_map = HashMap::from([
            ...
            (
                "method_name".to_string(),
                "callOptionalDuration".to_string(),
            ),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
    ...
    async fn start_call_three_durations(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callThreeDurations".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_one_binary(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOneBinary".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_optional_binary(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callOptionalBinary".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_three_binaries(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callThreeBinaries".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
    ...
    async fn start_call_one_list_of_integers(
        ...
        let topic_param_map = HashMap::from([
            ...
            (
                "method_name".to_string(),
                "callOneListOfIntegers".to_string(),
            ),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
    ...
    async fn start_call_optional_list_of_floats(
        ...
        let topic_param_map = HashMap::from([
            ...
            (
                "method_name".to_string(),
                "callOptionalListOfFloats".to_string(),
            ),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
    ...
    async fn start_call_two_lists(
        ...
        let topic_param_map = HashMap::from([
            ("interface_name".to_string(), "testable".to_string()),
            ("service_id".to_string(), self.service_instance_id.clone()),
            ("method_name".to_string(), "callTwoLists".to_string()),
            ("client_id".to_string(), self.client_id.clone()),
            ("prefix".to_string(), self.topic_param_prefix.clone()),
        ]);
        let request_topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_integer_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_integer_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_integer".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_integer_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_only_integer_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_only_integer_prop.clone(),
                            ),
                            ("property_name".to_string(), "read_only_integer".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_read_only_integer_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                            "{prefix}/testable/{service_id}/property/read_only_integer/update",
                            &topic_param_map,
                        )
                        .unwrap();
                        if let Some(responder) = opt_responder {
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_integer_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_optional_integer_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_optional_integer".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_optional_integer_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_integers_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_two_integers_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_two_integers".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_two_integers_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_only_string_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_only_string_prop.clone(),
                            ),
                            ("property_name".to_string(), "read_only_string".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_read_only_string_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                            "{prefix}/testable/{service_id}/property/read_only_string/update",
                            &topic_param_map,
                        )
                        .unwrap();
                        if let Some(responder) = opt_responder {
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_string_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_string_prop.clone(),
                            ),
                            ("property_name".to_string(), "read_write_string".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_string_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_string_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_optional_string_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_optional_string".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_optional_string_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_strings_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_two_strings_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_two_strings".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_two_strings_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_struct_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_struct_prop.clone(),
                            ),
                            ("property_name".to_string(), "read_write_struct".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_struct_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_struct_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_optional_struct_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_optional_struct".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_optional_struct_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_structs_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_two_structs_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_two_structs".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_two_structs_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                    while let Some((value, opt_responder)) = rx_for_read_only_enum_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_only_enum_prop.clone(),
                            ),
                            ("property_name".to_string(), "read_only_enum".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_read_only_enum_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                            "{prefix}/testable/{service_id}/property/read_only_enum/update",
                            &topic_param_map,
                        )
                        .unwrap();
                        if let Some(responder) = opt_responder {
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_enum_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_enum_prop.clone(),
                            ),
                            ("property_name".to_string(), "read_write_enum".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_enum_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_enum_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_optional_enum_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_optional_enum".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_optional_enum_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_enums_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_two_enums_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_two_enums".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_two_enums_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_datetime_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_datetime_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_datetime".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_datetime_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_datetime_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_optional_datetime_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_optional_datetime".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_optional_datetime_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_datetimes_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_two_datetimes_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_two_datetimes".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_two_datetimes_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_duration_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_duration_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_duration".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_duration_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_duration_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_optional_duration_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_optional_duration".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_optional_duration_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_durations_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_two_durations_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_two_durations".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_two_durations_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_binary_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_binary_prop.clone(),
                            ),
                            ("property_name".to_string(), "read_write_binary".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_binary_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_optional_binary_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_optional_binary_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_optional_binary".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_optional_binary_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_two_binaries_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_two_binaries_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_two_binaries".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_two_binaries_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_list_of_strings_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_list_of_strings_prop.clone(),
                            ),
                            (
                                "property_name".to_string(),
                                "read_write_list_of_strings".to_string(),
                            ...
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_list_of_strings_prop.clone(),
                            ),
                        ]);
                ...
                tokio::spawn(async move {
                        ...
                        rx_for_read_write_lists_prop.recv().await
                    {
                        ...
                        let topic_param_map = HashMap::from([
                            ...
                            (
                                "service_id".to_string(),
                                instance_id_for_read_write_lists_prop.clone(),
                            ),
                            ("property_name".to_string(), "read_write_lists".to_string()),
                            (
                                "prefix".to_string(),
                                client_id_for_read_write_lists_prop.clone(),
                            ),
                        ]);
                        let topic: String = strfmt(
