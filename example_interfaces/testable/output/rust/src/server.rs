...
struct TestAbleProperties {
    ...
    read_write_integer_version: Arc<AtomicU32>,read_only_integer: Arc<AsyncMutex<Option<ReadOnlyIntegerProperty>>>,
    read_only_integer_tx_channel: watch::Sender<Option<i32>>,
    read_only_integer_version: Arc<AtomicU32>,read_write_optional_integer: Arc<AsyncMutex<Option<ReadWriteOptionalIntegerProperty>>>,
    read_write_optional_integer_tx_channel: watch::Sender<Option<Option<i32>>>,
    read_write_optional_integer_version: Arc<AtomicU32>,read_write_two_integers: Arc<AsyncMutex<Option<ReadWriteTwoIntegersProperty>>>,
    read_write_two_integers_tx_channel: watch::Sender<Option<ReadWriteTwoIntegersProperty>>,
    read_write_two_integers_version: Arc<AtomicU32>,read_only_string: Arc<AsyncMutex<Option<ReadOnlyStringProperty>>>,
    read_only_string_tx_channel: watch::Sender<Option<String>>,
    read_only_string_version: Arc<AtomicU32>,read_write_string: Arc<AsyncMutex<Option<ReadWriteStringProperty>>>,
    read_write_string_tx_channel: watch::Sender<Option<String>>,
    read_write_string_version: Arc<AtomicU32>,read_write_optional_string: Arc<AsyncMutex<Option<ReadWriteOptionalStringProperty>>>,
    read_write_optional_string_tx_channel: watch::Sender<Option<Option<String>>>,
    read_write_optional_string_version: Arc<AtomicU32>,read_write_two_strings: Arc<AsyncMutex<Option<ReadWriteTwoStringsProperty>>>,
    read_write_two_strings_tx_channel: watch::Sender<Option<ReadWriteTwoStringsProperty>>,
    read_write_two_strings_version: Arc<AtomicU32>,read_write_struct: Arc<AsyncMutex<Option<ReadWriteStructProperty>>>,
    read_write_struct_tx_channel: watch::Sender<Option<AllTypes>>,
    read_write_struct_version: Arc<AtomicU32>,read_write_optional_struct: Arc<AsyncMutex<Option<ReadWriteOptionalStructProperty>>>,
    read_write_optional_struct_tx_channel: watch::Sender<Option<Option<AllTypes>>>,
    read_write_optional_struct_version: Arc<AtomicU32>,read_write_two_structs: Arc<AsyncMutex<Option<ReadWriteTwoStructsProperty>>>,
    read_write_two_structs_tx_channel: watch::Sender<Option<ReadWriteTwoStructsProperty>>,
    read_write_two_structs_version: Arc<AtomicU32>,read_only_enum: Arc<AsyncMutex<Option<ReadOnlyEnumProperty>>>,
    read_only_enum_tx_channel: watch::Sender<Option<Numbers>>,
    read_only_enum_version: Arc<AtomicU32>,read_write_enum: Arc<AsyncMutex<Option<ReadWriteEnumProperty>>>,
    read_write_enum_tx_channel: watch::Sender<Option<Numbers>>,
    read_write_enum_version: Arc<AtomicU32>,read_write_optional_enum: Arc<AsyncMutex<Option<ReadWriteOptionalEnumProperty>>>,
    read_write_optional_enum_tx_channel: watch::Sender<Option<Option<Numbers>>>,
    read_write_optional_enum_version: Arc<AtomicU32>,read_write_two_enums: Arc<AsyncMutex<Option<ReadWriteTwoEnumsProperty>>>,
    read_write_two_enums_tx_channel: watch::Sender<Option<ReadWriteTwoEnumsProperty>>,
    read_write_two_enums_version: Arc<AtomicU32>,read_write_datetime: Arc<AsyncMutex<Option<ReadWriteDatetimeProperty>>>,
    read_write_datetime_tx_channel: watch::Sender<Option<chrono::DateTime<chrono::Utc>>>,
    read_write_datetime_version: Arc<AtomicU32>,read_write_optional_datetime: Arc<AsyncMutex<Option<ReadWriteOptionalDatetimeProperty>>>,
    read_write_optional_datetime_tx_channel: watch::Sender<Option<Option<chrono::DateTime<chrono::Utc>>>>,
    read_write_optional_datetime_version: Arc<AtomicU32>,read_write_two_datetimes: Arc<AsyncMutex<Option<ReadWriteTwoDatetimesProperty>>>,
    read_write_two_datetimes_tx_channel: watch::Sender<Option<ReadWriteTwoDatetimesProperty>>,
    read_write_two_datetimes_version: Arc<AtomicU32>,read_write_duration: Arc<AsyncMutex<Option<ReadWriteDurationProperty>>>,
    read_write_duration_tx_channel: watch::Sender<Option<chrono::Duration>>,
    read_write_duration_version: Arc<AtomicU32>,read_write_optional_duration: Arc<AsyncMutex<Option<ReadWriteOptionalDurationProperty>>>,
    read_write_optional_duration_tx_channel: watch::Sender<Option<Option<chrono::Duration>>>,
    read_write_optional_duration_version: Arc<AtomicU32>,read_write_two_durations: Arc<AsyncMutex<Option<ReadWriteTwoDurationsProperty>>>,
    read_write_two_durations_tx_channel: watch::Sender<Option<ReadWriteTwoDurationsProperty>>,
    read_write_two_durations_version: Arc<AtomicU32>,read_write_binary: Arc<AsyncMutex<Option<ReadWriteBinaryProperty>>>,
    read_write_binary_tx_channel: watch::Sender<Option<Vec<u8>>>,
    read_write_binary_version: Arc<AtomicU32>,read_write_optional_binary: Arc<AsyncMutex<Option<ReadWriteOptionalBinaryProperty>>>,
    read_write_optional_binary_tx_channel: watch::Sender<Option<Option<Vec<u8>>>>,
    read_write_optional_binary_version: Arc<AtomicU32>,read_write_two_binaries: Arc<AsyncMutex<Option<ReadWriteTwoBinariesProperty>>>,
    read_write_two_binaries_tx_channel: watch::Sender<Option<ReadWriteTwoBinariesProperty>>,
    read_write_two_binaries_version: Arc<AtomicU32>,read_write_list_of_strings: Arc<AsyncMutex<Option<ReadWriteListOfStringsProperty>>>,
    read_write_list_of_strings_tx_channel: watch::Sender<Option<Vec<String>>>,
    read_write_list_of_strings_version: Arc<AtomicU32>,read_write_lists: Arc<AsyncMutex<Option<ReadWriteListsProperty>>>,
...
impl<C: Mqtt5PubSub + Clone + Send> TestAbleServer<C> {
    pub async fn new(mut connection: C, method_handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>> , instance_id: String) -> Self {
        ...
        let subscription_id_call_with_nothing_method_req = connection.subscribe(format!("testAble/{}/method/callWithNothing", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_with_nothing_method_req = subscription_id_call_with_nothing_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_one_integer_method_req = connection.subscribe(format!("testAble/{}/method/callOneInteger", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_one_integer_method_req = subscription_id_call_one_integer_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_optional_integer_method_req = connection.subscribe(format!("testAble/{}/method/callOptionalInteger", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_optional_integer_method_req = subscription_id_call_optional_integer_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_three_integers_method_req = connection.subscribe(format!("testAble/{}/method/callThreeIntegers", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_three_integers_method_req = subscription_id_call_three_integers_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_one_string_method_req = connection.subscribe(format!("testAble/{}/method/callOneString", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_one_string_method_req = subscription_id_call_one_string_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_optional_string_method_req = connection.subscribe(format!("testAble/{}/method/callOptionalString", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_optional_string_method_req = subscription_id_call_optional_string_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_three_strings_method_req = connection.subscribe(format!("testAble/{}/method/callThreeStrings", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_three_strings_method_req = subscription_id_call_three_strings_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_one_enum_method_req = connection.subscribe(format!("testAble/{}/method/callOneEnum", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_one_enum_method_req = subscription_id_call_one_enum_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_optional_enum_method_req = connection.subscribe(format!("testAble/{}/method/callOptionalEnum", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_optional_enum_method_req = subscription_id_call_optional_enum_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_three_enums_method_req = connection.subscribe(format!("testAble/{}/method/callThreeEnums", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_three_enums_method_req = subscription_id_call_three_enums_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_one_struct_method_req = connection.subscribe(format!("testAble/{}/method/callOneStruct", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_one_struct_method_req = subscription_id_call_one_struct_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_optional_struct_method_req = connection.subscribe(format!("testAble/{}/method/callOptionalStruct", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_optional_struct_method_req = subscription_id_call_optional_struct_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_three_structs_method_req = connection.subscribe(format!("testAble/{}/method/callThreeStructs", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_three_structs_method_req = subscription_id_call_three_structs_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_one_date_time_method_req = connection.subscribe(format!("testAble/{}/method/callOneDateTime", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_one_date_time_method_req = subscription_id_call_one_date_time_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_optional_date_time_method_req = connection.subscribe(format!("testAble/{}/method/callOptionalDateTime", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_optional_date_time_method_req = subscription_id_call_optional_date_time_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_three_date_times_method_req = connection.subscribe(format!("testAble/{}/method/callThreeDateTimes", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_three_date_times_method_req = subscription_id_call_three_date_times_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_one_duration_method_req = connection.subscribe(format!("testAble/{}/method/callOneDuration", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_one_duration_method_req = subscription_id_call_one_duration_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_optional_duration_method_req = connection.subscribe(format!("testAble/{}/method/callOptionalDuration", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_optional_duration_method_req = subscription_id_call_optional_duration_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_three_durations_method_req = connection.subscribe(format!("testAble/{}/method/callThreeDurations", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_three_durations_method_req = subscription_id_call_three_durations_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_one_binary_method_req = connection.subscribe(format!("testAble/{}/method/callOneBinary", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_one_binary_method_req = subscription_id_call_one_binary_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_optional_binary_method_req = connection.subscribe(format!("testAble/{}/method/callOptionalBinary", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_optional_binary_method_req = subscription_id_call_optional_binary_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_three_binaries_method_req = connection.subscribe(format!("testAble/{}/method/callThreeBinaries", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_three_binaries_method_req = subscription_id_call_three_binaries_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_one_list_of_integers_method_req = connection.subscribe(format!("testAble/{}/method/callOneListOfIntegers", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_one_list_of_integers_method_req = subscription_id_call_one_list_of_integers_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_optional_list_of_floats_method_req = connection.subscribe(format!("testAble/{}/method/callOptionalListOfFloats", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_optional_list_of_floats_method_req = subscription_id_call_optional_list_of_floats_method_req.unwrap_or_else(|_| u32::MAX);

        let subscription_id_call_two_lists_method_req = connection.subscribe(format!("testAble/{}/method/callTwoLists", instance_id), QoS::ExactlyOnce, message_received_tx.clone()).await;
        let subscription_id_call_two_lists_method_req = subscription_id_call_two_lists_method_req.unwrap_or_else(|_| u32::MAX);

        
        
        let subscription_id_read_write_integer_property_update = connection.subscribe(format!("testAble/{}/property/readWriteInteger/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_integer_property_update = subscription_id_read_write_integer_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_optional_integer_property_update = connection.subscribe(format!("testAble/{}/property/readWriteOptionalInteger/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_optional_integer_property_update = subscription_id_read_write_optional_integer_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_two_integers_property_update = connection.subscribe(format!("testAble/{}/property/readWriteTwoIntegers/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_two_integers_property_update = subscription_id_read_write_two_integers_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_string_property_update = connection.subscribe(format!("testAble/{}/property/readWriteString/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_string_property_update = subscription_id_read_write_string_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_optional_string_property_update = connection.subscribe(format!("testAble/{}/property/readWriteOptionalString/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_optional_string_property_update = subscription_id_read_write_optional_string_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_two_strings_property_update = connection.subscribe(format!("testAble/{}/property/readWriteTwoStrings/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_two_strings_property_update = subscription_id_read_write_two_strings_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_struct_property_update = connection.subscribe(format!("testAble/{}/property/readWriteStruct/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_struct_property_update = subscription_id_read_write_struct_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_optional_struct_property_update = connection.subscribe(format!("testAble/{}/property/readWriteOptionalStruct/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_optional_struct_property_update = subscription_id_read_write_optional_struct_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_two_structs_property_update = connection.subscribe(format!("testAble/{}/property/readWriteTwoStructs/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_two_structs_property_update = subscription_id_read_write_two_structs_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_enum_property_update = connection.subscribe(format!("testAble/{}/property/readWriteEnum/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_enum_property_update = subscription_id_read_write_enum_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_optional_enum_property_update = connection.subscribe(format!("testAble/{}/property/readWriteOptionalEnum/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_optional_enum_property_update = subscription_id_read_write_optional_enum_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_two_enums_property_update = connection.subscribe(format!("testAble/{}/property/readWriteTwoEnums/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_two_enums_property_update = subscription_id_read_write_two_enums_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_datetime_property_update = connection.subscribe(format!("testAble/{}/property/readWriteDatetime/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_datetime_property_update = subscription_id_read_write_datetime_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_optional_datetime_property_update = connection.subscribe(format!("testAble/{}/property/readWriteOptionalDatetime/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_optional_datetime_property_update = subscription_id_read_write_optional_datetime_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_two_datetimes_property_update = connection.subscribe(format!("testAble/{}/property/readWriteTwoDatetimes/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_two_datetimes_property_update = subscription_id_read_write_two_datetimes_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_duration_property_update = connection.subscribe(format!("testAble/{}/property/readWriteDuration/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_duration_property_update = subscription_id_read_write_duration_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_optional_duration_property_update = connection.subscribe(format!("testAble/{}/property/readWriteOptionalDuration/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_optional_duration_property_update = subscription_id_read_write_optional_duration_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_two_durations_property_update = connection.subscribe(format!("testAble/{}/property/readWriteTwoDurations/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_two_durations_property_update = subscription_id_read_write_two_durations_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_binary_property_update = connection.subscribe(format!("testAble/{}/property/readWriteBinary/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_binary_property_update = subscription_id_read_write_binary_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_optional_binary_property_update = connection.subscribe(format!("testAble/{}/property/readWriteOptionalBinary/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_optional_binary_property_update = subscription_id_read_write_optional_binary_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_two_binaries_property_update = connection.subscribe(format!("testAble/{}/property/readWriteTwoBinaries/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_two_binaries_property_update = subscription_id_read_write_two_binaries_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_list_of_strings_property_update = connection.subscribe(format!("testAble/{}/property/readWriteListOfStrings/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_list_of_strings_property_update = subscription_id_read_write_list_of_strings_property_update.unwrap_or_else(|_| u32::MAX);

        
        let subscription_id_read_write_lists_property_update = connection.subscribe(format!("testAble/{}/property/readWriteLists/setValue", instance_id), QoS::AtLeastOnce, message_received_tx.clone()).await;
        let subscription_id_read_write_lists_property_update = subscription_id_read_write_lists_property_update.unwrap_or_else(|_| u32::MAX);
    ...
    pub fn emit_empty_nowait(&mut self, ) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = EmptySignalPayload {
    ...
    pub fn emit_single_int_nowait(&mut self, value: i32) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleIntSignalPayload {
    ...
    pub fn emit_single_optional_int_nowait(&mut self, value: Option<i32>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleOptionalIntSignalPayload {
    ...
    pub fn emit_three_integers_nowait(&mut self, first: i32, second: i32, third: Option<i32>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = ThreeIntegersSignalPayload {
    ...
    pub fn emit_single_string_nowait(&mut self, value: String) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleStringSignalPayload {
    ...
    pub fn emit_single_optional_string_nowait(&mut self, value: Option<String>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleOptionalStringSignalPayload {
    ...
    pub fn emit_three_strings_nowait(&mut self, first: String, second: String, third: Option<String>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = ThreeStringsSignalPayload {
    ...
    pub fn emit_single_enum_nowait(&mut self, value: Numbers) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleEnumSignalPayload {
    ...
    pub fn emit_single_optional_enum_nowait(&mut self, value: Option<Numbers>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleOptionalEnumSignalPayload {
    ...
    pub fn emit_three_enums_nowait(&mut self, first: Numbers, second: Numbers, third: Option<Numbers>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = ThreeEnumsSignalPayload {
    ...
    pub fn emit_single_struct_nowait(&mut self, value: AllTypes) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleStructSignalPayload {
    ...
    pub async fn emit_single_optional_struct(&mut self, value: Option<AllTypes>) -> SentMessageFuture {
    ...
    pub fn emit_single_optional_struct_nowait(&mut self, value: Option<AllTypes>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleOptionalStructSignalPayload {
    ...
    pub async fn emit_three_structs(&mut self, first: AllTypes, second: AllTypes, third: Option<AllTypes>) -> SentMessageFuture {
    ...
    pub fn emit_three_structs_nowait(&mut self, first: AllTypes, second: AllTypes, third: Option<AllTypes>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = ThreeStructsSignalPayload {
    ...
    pub fn emit_single_date_time_nowait(&mut self, value: chrono::DateTime<chrono::Utc>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleDateTimeSignalPayload {
    ...
    pub async fn emit_single_optional_datetime(&mut self, value: Option<chrono::DateTime<chrono::Utc>>) -> SentMessageFuture {
        let data = SingleOptionalDatetimeSignalPayload {
            
            value: value,
            
        };
        let topic = format!("testAble/{}/signal/singleOptionalDatetime", self.instance_id);
        let msg = message::signal(&topic, &data).unwrap();
        let mut publisher = self.mqtt_client.clone();
        let ch = publisher.publish_noblock(msg).await;
        Self::oneshot_to_future(ch).await
    ...
    pub fn emit_single_optional_datetime_nowait(&mut self, value: Option<chrono::DateTime<chrono::Utc>>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleOptionalDatetimeSignalPayload {
    ...
    pub async fn emit_three_date_times(&mut self, first: chrono::DateTime<chrono::Utc>, second: chrono::DateTime<chrono::Utc>, third: Option<chrono::DateTime<chrono::Utc>>) -> SentMessageFuture {
    ...
    pub fn emit_three_date_times_nowait(&mut self, first: chrono::DateTime<chrono::Utc>, second: chrono::DateTime<chrono::Utc>, third: Option<chrono::DateTime<chrono::Utc>>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = ThreeDateTimesSignalPayload {
    ...
    pub fn emit_single_duration_nowait(&mut self, value: chrono::Duration) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleDurationSignalPayload {
    ...
    pub async fn emit_single_optional_duration(&mut self, value: Option<chrono::Duration>) -> SentMessageFuture {
        let data = SingleOptionalDurationSignalPayload {
            
            value: value,
            
        };
        let topic = format!("testAble/{}/signal/singleOptionalDuration", self.instance_id);
        let msg = message::signal(&topic, &data).unwrap();
        let mut publisher = self.mqtt_client.clone();
        let ch = publisher.publish_noblock(msg).await;
        Self::oneshot_to_future(ch).await
    ...
    pub fn emit_single_optional_duration_nowait(&mut self, value: Option<chrono::Duration>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleOptionalDurationSignalPayload {
    ...
    pub async fn emit_three_durations(&mut self, first: chrono::Duration, second: chrono::Duration, third: Option<chrono::Duration>) -> SentMessageFuture {
    ...
    pub fn emit_three_durations_nowait(&mut self, first: chrono::Duration, second: chrono::Duration, third: Option<chrono::Duration>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = ThreeDurationsSignalPayload {
    ...
    pub fn emit_single_binary_nowait(&mut self, value: Vec<u8>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleBinarySignalPayload {
    ...
    pub async fn emit_single_optional_binary(&mut self, value: Option<Vec<u8>>) -> SentMessageFuture {
    ...
    pub fn emit_single_optional_binary_nowait(&mut self, value: Option<Vec<u8>>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleOptionalBinarySignalPayload {
    ...
    pub async fn emit_three_binaries(&mut self, first: Vec<u8>, second: Vec<u8>, third: Option<Vec<u8>>) -> SentMessageFuture {
    ...
    pub fn emit_three_binaries_nowait(&mut self, first: Vec<u8>, second: Vec<u8>, third: Option<Vec<u8>>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = ThreeBinariesSignalPayload {
    ...
    pub fn emit_single_array_of_integers_nowait(&mut self, values: Vec<i32>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleArrayOfIntegersSignalPayload {
    ...
    pub async fn emit_single_optional_array_of_strings(&mut self, values: Option<Vec<String>>) -> SentMessageFuture {
        let data = SingleOptionalArrayOfStringsSignalPayload {
            
            values: values,
            
        };
        let topic = format!("testAble/{}/signal/singleOptionalArrayOfStrings", self.instance_id);
        let msg = message::signal(&topic, &data).unwrap();
        let mut publisher = self.mqtt_client.clone();
        let ch = publisher.publish_noblock(msg).await;
        Self::oneshot_to_future(ch).await
    ...
    pub fn emit_single_optional_array_of_strings_nowait(&mut self, values: Option<Vec<String>>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = SingleOptionalArrayOfStringsSignalPayload {
    ...
    pub async fn emit_array_of_every_type(&mut self, first_of_integers: Vec<i32>, second_of_floats: Vec<f32>, third_of_strings: Vec<String>, fourth_of_enums: Vec<Numbers>, fifth_of_structs: Vec<Entry>, sixth_of_datetimes: Vec<chrono::DateTime<chrono::Utc>>, seventh_of_durations: Vec<chrono::Duration>, eighth_of_binaries: Vec<Vec<u8>>) -> SentMessageFuture {
    ...
    pub fn emit_array_of_every_type_nowait(&mut self, first_of_integers: Vec<i32>, second_of_floats: Vec<f32>, third_of_strings: Vec<String>, fourth_of_enums: Vec<Numbers>, fifth_of_structs: Vec<Entry>, sixth_of_datetimes: Vec<chrono::DateTime<chrono::Utc>>, seventh_of_durations: Vec<chrono::Duration>, eighth_of_binaries: Vec<Vec<u8>>) -> std::result::Result<MqttPublishSuccess, Mqtt5PubSubError>{
        let data = ArrayOfEveryTypeSignalPayload {
    ...
    async fn handle_call_with_nothing_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                ...
                Err(err) => {
                    ...
                    TestAbleServer::<C>::publish_error_response(publisher, Some(resp_topic), Some(corr_data), err).await;
                }
            }
        } else {
    ...
    async fn handle_call_one_integer_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        ...
        if payload_obj.is_err() {
            ...
            TestAbleServer::<C>::publish_error_response(publisher, opt_resp_topic, opt_corr_data, MethodReturnCode::ServerDeserializationError("Failed to deserialize request payload".to_string())).await;
            return;
        }
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOneIntegerReturnValues {
                        output1: retval,
                    };
    ...
    async fn handle_call_optional_integer_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOptionalIntegerReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_three_integers_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
    ...
    async fn handle_call_one_string_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOneStringReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_optional_string_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOptionalStringReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_three_strings_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
    ...
    async fn handle_call_one_enum_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOneEnumReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_optional_enum_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOptionalEnumReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_three_enums_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
    ...
    async fn handle_call_one_struct_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOneStructReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_optional_struct_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOptionalStructReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_three_structs_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
    ...
    async fn handle_call_one_date_time_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOneDateTimeReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_optional_date_time_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOptionalDateTimeReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_three_date_times_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
    ...
    async fn handle_call_one_duration_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOneDurationReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_optional_duration_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOptionalDurationReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_three_durations_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
    ...
    async fn handle_call_one_binary_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOneBinaryReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_optional_binary_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOptionalBinaryReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_three_binaries_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
    ...
    async fn handle_call_one_list_of_integers_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOneListOfIntegersReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_optional_list_of_floats_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    ...
                    let resp_obj = CallOptionalListOfFloatsReturnValues {
                        output1: retval,
                    };
                    let msg = message::response(&resp_topic, &resp_obj, corr_data,None).unwrap();
                    let _fut_publish_result = publisher.publish(msg).await;
    ...
    async fn handle_call_two_lists_request(mut publisher: C, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers<C>>>>, msg: MqttMessage) {
        let opt_corr_data = msg.correlation_data;
        let opt_resp_topic = msg.response_topic;
        let payload_vec = msg.payload;
    ...
    async fn publish_read_write_integer_value(mut publisher: C, topic: String, data: ReadWriteIntegerProperty, property_version: u32) -> SentMessageFuture
    {
    ...
    async fn update_read_write_integer_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteIntegerProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<i32>>, msg: MqttMessage) -> SentMessageFuture
    {
        ...
        let new_property_structure: ReadWriteIntegerProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_integer' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_integer_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_integer(&mut self, data: i32) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::Success).await;
        } else {
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteInteger/value", self.instance_id);
                let new_version = self.properties.read_write_integer_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_integer_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    }
    
    async fn publish_read_only_integer_value(mut publisher: C, topic: String, data: ReadOnlyIntegerProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    pub async fn set_read_only_integer(&mut self, data: i32) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readOnlyInteger/value", self.instance_id);
                let new_version = self.properties.read_only_integer_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_only_integer_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_optional_integer_value(mut publisher: C, topic: String, data: ReadWriteOptionalIntegerProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_integer_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteOptionalIntegerProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<Option<i32>>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteOptionalIntegerProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_optional_integer' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_optional_integer_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_optional_integer(&mut self, data: Option<i32>) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteOptionalInteger/value", self.instance_id);
                let new_version = self.properties.read_write_optional_integer_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_optional_integer_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_two_integers_value(mut publisher: C, topic: String, data: ReadWriteTwoIntegersProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_integers_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteTwoIntegersProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<ReadWriteTwoIntegersProperty>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteTwoIntegersProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_two_integers' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_two_integers_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_two_integers(&mut self, data: ReadWriteTwoIntegersProperty) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteTwoIntegers/value", self.instance_id);
                let new_version = self.properties.read_write_two_integers_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_two_integers_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_only_string_value(mut publisher: C, topic: String, data: ReadOnlyStringProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    pub async fn set_read_only_string(&mut self, data: String) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readOnlyString/value", self.instance_id);
                let new_version = self.properties.read_only_string_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_only_string_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_string_value(mut publisher: C, topic: String, data: ReadWriteStringProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_string_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteStringProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<String>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteStringProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_string' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_string_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_string(&mut self, data: String) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteString/value", self.instance_id);
                let new_version = self.properties.read_write_string_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_string_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_optional_string_value(mut publisher: C, topic: String, data: ReadWriteOptionalStringProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_string_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteOptionalStringProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<Option<String>>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteOptionalStringProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_optional_string' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_optional_string_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_optional_string(&mut self, data: Option<String>) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteOptionalString/value", self.instance_id);
                let new_version = self.properties.read_write_optional_string_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_optional_string_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_two_strings_value(mut publisher: C, topic: String, data: ReadWriteTwoStringsProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_strings_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteTwoStringsProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<ReadWriteTwoStringsProperty>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteTwoStringsProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_two_strings' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_two_strings_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_two_strings(&mut self, data: ReadWriteTwoStringsProperty) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteTwoStrings/value", self.instance_id);
                let new_version = self.properties.read_write_two_strings_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_two_strings_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_struct_value(mut publisher: C, topic: String, data: ReadWriteStructProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_struct_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteStructProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<AllTypes>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteStructProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_struct' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_struct_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_struct(&mut self, data: AllTypes) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteStruct/value", self.instance_id);
                let new_version = self.properties.read_write_struct_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_struct_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_optional_struct_value(mut publisher: C, topic: String, data: ReadWriteOptionalStructProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_struct_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteOptionalStructProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<Option<AllTypes>>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteOptionalStructProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_optional_struct' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_optional_struct_value(publisher, topic2, new_property_structure, new_version).await
    }

    pub async fn watch_read_write_optional_struct(&self) -> watch::Receiver<Option<Option<AllTypes>>> {
    ...
    /// As a consequence, it notifies any watchers and publishes the new value to MQTT.
    pub async fn set_read_write_optional_struct(&mut self, data: Option<AllTypes>) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteOptionalStruct/value", self.instance_id);
                let new_version = self.properties.read_write_optional_struct_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_optional_struct_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_two_structs_value(mut publisher: C, topic: String, data: ReadWriteTwoStructsProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_structs_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteTwoStructsProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<ReadWriteTwoStructsProperty>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteTwoStructsProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_two_structs' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_two_structs_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_two_structs(&mut self, data: ReadWriteTwoStructsProperty) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteTwoStructs/value", self.instance_id);
                let new_version = self.properties.read_write_two_structs_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_two_structs_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_only_enum_value(mut publisher: C, topic: String, data: ReadOnlyEnumProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                ...
                let new_version = self.properties.read_only_enum_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_only_enum_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_enum_value(mut publisher: C, topic: String, data: ReadWriteEnumProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_enum_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteEnumProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<Numbers>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteEnumProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_enum' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_enum_value(publisher, topic2, new_property_structure, new_version).await
    }
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                ...
                let new_version = self.properties.read_write_enum_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_enum_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_optional_enum_value(mut publisher: C, topic: String, data: ReadWriteOptionalEnumProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_enum_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteOptionalEnumProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<Option<Numbers>>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteOptionalEnumProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_optional_enum' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_optional_enum_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_optional_enum(&mut self, data: Option<Numbers>) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteOptionalEnum/value", self.instance_id);
                let new_version = self.properties.read_write_optional_enum_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_optional_enum_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_two_enums_value(mut publisher: C, topic: String, data: ReadWriteTwoEnumsProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_enums_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteTwoEnumsProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<ReadWriteTwoEnumsProperty>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteTwoEnumsProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_two_enums' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_two_enums_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_two_enums(&mut self, data: ReadWriteTwoEnumsProperty) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteTwoEnums/value", self.instance_id);
                let new_version = self.properties.read_write_two_enums_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_two_enums_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_datetime_value(mut publisher: C, topic: String, data: ReadWriteDatetimeProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_datetime_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteDatetimeProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<chrono::DateTime<chrono::Utc>>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteDatetimeProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_datetime' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_datetime_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_datetime(&mut self, data: chrono::DateTime<chrono::Utc>) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteDatetime/value", self.instance_id);
                let new_version = self.properties.read_write_datetime_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_datetime_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_optional_datetime_value(mut publisher: C, topic: String, data: ReadWriteOptionalDatetimeProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_datetime_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteOptionalDatetimeProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<Option<chrono::DateTime<chrono::Utc>>>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteOptionalDatetimeProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_optional_datetime' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_optional_datetime_value(publisher, topic2, new_property_structure, new_version).await
    }

    pub async fn watch_read_write_optional_datetime(&self) -> watch::Receiver<Option<Option<chrono::DateTime<chrono::Utc>>>> {
    ...
    /// As a consequence, it notifies any watchers and publishes the new value to MQTT.
    pub async fn set_read_write_optional_datetime(&mut self, data: Option<chrono::DateTime<chrono::Utc>>) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteOptionalDatetime/value", self.instance_id);
                let new_version = self.properties.read_write_optional_datetime_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_optional_datetime_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_two_datetimes_value(mut publisher: C, topic: String, data: ReadWriteTwoDatetimesProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_datetimes_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteTwoDatetimesProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<ReadWriteTwoDatetimesProperty>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteTwoDatetimesProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_two_datetimes' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_two_datetimes_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_two_datetimes(&mut self, data: ReadWriteTwoDatetimesProperty) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteTwoDatetimes/value", self.instance_id);
                let new_version = self.properties.read_write_two_datetimes_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_two_datetimes_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_duration_value(mut publisher: C, topic: String, data: ReadWriteDurationProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_duration_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteDurationProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<chrono::Duration>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteDurationProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_duration' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_duration_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_duration(&mut self, data: chrono::Duration) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteDuration/value", self.instance_id);
                let new_version = self.properties.read_write_duration_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_duration_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_optional_duration_value(mut publisher: C, topic: String, data: ReadWriteOptionalDurationProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_duration_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteOptionalDurationProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<Option<chrono::Duration>>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteOptionalDurationProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_optional_duration' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_optional_duration_value(publisher, topic2, new_property_structure, new_version).await
    }

    pub async fn watch_read_write_optional_duration(&self) -> watch::Receiver<Option<Option<chrono::Duration>>> {
    ...
    /// As a consequence, it notifies any watchers and publishes the new value to MQTT.
    pub async fn set_read_write_optional_duration(&mut self, data: Option<chrono::Duration>) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteOptionalDuration/value", self.instance_id);
                let new_version = self.properties.read_write_optional_duration_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_optional_duration_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_two_durations_value(mut publisher: C, topic: String, data: ReadWriteTwoDurationsProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_durations_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteTwoDurationsProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<ReadWriteTwoDurationsProperty>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteTwoDurationsProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_two_durations' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_two_durations_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_two_durations(&mut self, data: ReadWriteTwoDurationsProperty) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteTwoDurations/value", self.instance_id);
                let new_version = self.properties.read_write_two_durations_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_two_durations_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_binary_value(mut publisher: C, topic: String, data: ReadWriteBinaryProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_binary_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteBinaryProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<Vec<u8>>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteBinaryProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_binary' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_binary_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_binary(&mut self, data: Vec<u8>) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteBinary/value", self.instance_id);
                let new_version = self.properties.read_write_binary_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_binary_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_optional_binary_value(mut publisher: C, topic: String, data: ReadWriteOptionalBinaryProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_binary_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteOptionalBinaryProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<Option<Vec<u8>>>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteOptionalBinaryProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_optional_binary' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_optional_binary_value(publisher, topic2, new_property_structure, new_version).await
    }

    pub async fn watch_read_write_optional_binary(&self) -> watch::Receiver<Option<Option<Vec<u8>>>> {
    ...
    /// As a consequence, it notifies any watchers and publishes the new value to MQTT.
    pub async fn set_read_write_optional_binary(&mut self, data: Option<Vec<u8>>) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteOptionalBinary/value", self.instance_id);
                let new_version = self.properties.read_write_optional_binary_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_optional_binary_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_two_binaries_value(mut publisher: C, topic: String, data: ReadWriteTwoBinariesProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_binaries_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteTwoBinariesProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<ReadWriteTwoBinariesProperty>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteTwoBinariesProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_two_binaries' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_two_binaries_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_two_binaries(&mut self, data: ReadWriteTwoBinariesProperty) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteTwoBinaries/value", self.instance_id);
                let new_version = self.properties.read_write_two_binaries_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_two_binaries_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_list_of_strings_value(mut publisher: C, topic: String, data: ReadWriteListOfStringsProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_list_of_strings_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteListOfStringsProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<Vec<String>>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteListOfStringsProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_list_of_strings' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_list_of_strings_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_list_of_strings(&mut self, data: Vec<String>) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteListOfStrings/value", self.instance_id);
                let new_version = self.properties.read_write_list_of_strings_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_list_of_strings_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
    ...
    async fn publish_read_write_lists_value(mut publisher: C, topic: String, data: ReadWriteListsProperty, property_version: u32) -> SentMessageFuture
    {
        let msg = message::property_value_message(&topic, &data, property_version).unwrap();
        let ch = publisher.publish_noblock(msg).await;
        TestAbleServer::<C>::oneshot_to_future(ch).await
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_lists_value(publisher: C, topic: String, property_pointer: Arc<AsyncMutex<Option<ReadWriteListsProperty>>>, property_version: Arc<AtomicU32>,watch_sender: watch::Sender<Option<ReadWriteListsProperty>>, msg: MqttMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        let new_version = property_version.fetch_add(1, Ordering::SeqCst);
        let new_property_structure: ReadWriteListsProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::ServerDeserializationError("Failed to deserialize property 'read_write_lists' payload".to_string())).await;
                }
            }
        };
        ...
        *property_guard = Some(new_property_structure.clone());
        ...
        TestAbleServer::publish_read_write_lists_value(publisher, topic2, new_property_structure, new_version).await
    }
    ...
    pub async fn set_read_write_lists(&mut self, data: ReadWriteListsProperty) -> SentMessageFuture {
        ...
        *property_data_guard = Some(new_prop_obj.clone());
        ...
        if !send_result {
            ...
            if let Some(prop_obj) = property_obj {
                let publisher2 = self.mqtt_client.clone();
                let topic2 = format!("testAble/{}/property/readWriteLists/value", self.instance_id);
                let new_version = self.properties.read_write_lists_version.fetch_add(1, std::sync::atomic::Ordering::SeqCst);
                TestAbleServer::<C>::publish_read_write_lists_value(publisher2, topic2, prop_obj, new_version).await
            } else {
                TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::UnknownError("Could not find property object".to_string())).await
            }
        }
                    ...
                    Ok(msg) => {
                        ...
                        if let Some(subscription_id) = msg.subscription_id {
                            if subscription_id == sub_ids.call_with_nothing_method_req {
                                TestAbleServer::<C>::handle_call_with_nothing_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_one_integer_method_req {
                                TestAbleServer::<C>::handle_call_one_integer_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_optional_integer_method_req {
                                TestAbleServer::<C>::handle_call_optional_integer_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_three_integers_method_req {
                                TestAbleServer::<C>::handle_call_three_integers_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_one_string_method_req {
                                TestAbleServer::<C>::handle_call_one_string_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_optional_string_method_req {
                                TestAbleServer::<C>::handle_call_optional_string_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_three_strings_method_req {
                                TestAbleServer::<C>::handle_call_three_strings_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_one_enum_method_req {
                                TestAbleServer::<C>::handle_call_one_enum_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_optional_enum_method_req {
                                TestAbleServer::<C>::handle_call_optional_enum_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_three_enums_method_req {
                                TestAbleServer::<C>::handle_call_three_enums_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_one_struct_method_req {
                                TestAbleServer::<C>::handle_call_one_struct_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_optional_struct_method_req {
                                TestAbleServer::<C>::handle_call_optional_struct_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_three_structs_method_req {
                                TestAbleServer::<C>::handle_call_three_structs_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_one_date_time_method_req {
                                TestAbleServer::<C>::handle_call_one_date_time_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_optional_date_time_method_req {
                                TestAbleServer::<C>::handle_call_optional_date_time_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_three_date_times_method_req {
                                TestAbleServer::<C>::handle_call_three_date_times_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_one_duration_method_req {
                                TestAbleServer::<C>::handle_call_one_duration_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_optional_duration_method_req {
                                TestAbleServer::<C>::handle_call_optional_duration_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_three_durations_method_req {
                                TestAbleServer::<C>::handle_call_three_durations_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_one_binary_method_req {
                                TestAbleServer::<C>::handle_call_one_binary_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_optional_binary_method_req {
                                TestAbleServer::<C>::handle_call_optional_binary_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_three_binaries_method_req {
                                TestAbleServer::<C>::handle_call_three_binaries_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            else if subscription_id == sub_ids.call_one_list_of_integers_method_req {
                                TestAbleServer::<C>::handle_call_one_list_of_integers_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                                ...
                                TestAbleServer::<C>::handle_call_two_lists_request(publisher.clone(), method_handlers.clone(), msg).await;
                            }
                            
                            else {
                                let update_prop_future = {
                                        if subscription_id == sub_ids.read_write_integer_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteInteger/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_optional_integer_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteOptionalInteger/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_two_integers_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteTwoIntegers/value", instance_id);
                                            ...
                                            let prop_topic = format!("testAble/{}/property/readWriteString/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_optional_string_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteOptionalString/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_two_strings_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteTwoStrings/value", instance_id);
                                            ...
                                            let prop_topic = format!("testAble/{}/property/readWriteStruct/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_optional_struct_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteOptionalStruct/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_two_structs_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteTwoStructs/value", instance_id);
                                            ...
                                            let prop_topic = format!("testAble/{}/property/readWriteEnum/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_optional_enum_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteOptionalEnum/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_two_enums_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteTwoEnums/value", instance_id);
                                            ...
                                            let prop_topic = format!("testAble/{}/property/readWriteDatetime/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_optional_datetime_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteOptionalDatetime/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_two_datetimes_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteTwoDatetimes/value", instance_id);
                                            ...
                                            let prop_topic = format!("testAble/{}/property/readWriteDuration/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_optional_duration_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteOptionalDuration/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_two_durations_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteTwoDurations/value", instance_id);
                                            ...
                                            let prop_topic = format!("testAble/{}/property/readWriteBinary/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_optional_binary_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteOptionalBinary/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_two_binaries_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteTwoBinaries/value", instance_id);
                                        ...
                                        else if subscription_id == sub_ids.read_write_list_of_strings_property_update {
                                            let prop_topic = format!("testAble/{}/property/readWriteListOfStrings/value", instance_id);
                                            ...
                                            let prop_topic = format!("testAble/{}/property/readWriteLists/value", instance_id);
                                            ...
                                            TestAbleServer::<C>::wrap_return_code_in_future(MethodReturnCode::NotImplemented("Could not find a property matching the request".to_string())).await
                                        }
                                };
                                match update_prop_future.await {
                                    ...
                                    Err(e) => {
                                        ...
                                        if let Some(resp_topic) = opt_resp_topic {
                                            TestAbleServer::<C>::publish_error_response(publisher.clone(), Some(resp_topic), opt_corr_data, e).await;
                                        } else {
...
pub trait TestAbleMethodHandlers<C: Mqtt5PubSub>: Send + Sync {
    ...
    async fn handle_call_optional_struct(&self, input1: Option<AllTypes>) -> Result<Option<AllTypes>, MethodReturnCode>;
    
    /// Pointer to a function to handle the callThreeStructs method request.
    async fn handle_call_three_structs(&self, input1: Option<AllTypes>, input2: AllTypes, input3: AllTypes) -> Result<CallThreeStructsReturnValues, MethodReturnCode>;
    ...
    async fn handle_call_optional_date_time(&self, input1: Option<chrono::DateTime<chrono::Utc>>) -> Result<Option<chrono::DateTime<chrono::Utc>>, MethodReturnCode>;
    
    /// Pointer to a function to handle the callThreeDateTimes method request.
    async fn handle_call_three_date_times(&self, input1: chrono::DateTime<chrono::Utc>, input2: chrono::DateTime<chrono::Utc>, input3: Option<chrono::DateTime<chrono::Utc>>) -> Result<CallThreeDateTimesReturnValues, MethodReturnCode>;
    ...
    async fn handle_call_optional_duration(&self, input1: Option<chrono::Duration>) -> Result<Option<chrono::Duration>, MethodReturnCode>;
    
    /// Pointer to a function to handle the callThreeDurations method request.
    async fn handle_call_three_durations(&self, input1: chrono::Duration, input2: chrono::Duration, input3: Option<chrono::Duration>) -> Result<CallThreeDurationsReturnValues, MethodReturnCode>;
    ...
    async fn handle_call_optional_binary(&self, input1: Option<Vec<u8>>) -> Result<Option<Vec<u8>>, MethodReturnCode>;
    
    /// Pointer to a function to handle the callThreeBinaries method request.
    async fn handle_call_three_binaries(&self, input1: Vec<u8>, input2: Vec<u8>, input3: Option<Vec<u8>>) -> Result<CallThreeBinariesReturnValues, MethodReturnCode>;
    ...
    async fn handle_call_optional_list_of_floats(&self, input1: Option<Vec<f32>>) -> Result<Option<Vec<f32>>, MethodReturnCode>;
    
    /// Pointer to a function to handle the callTwoLists method request.
    async fn handle_call_two_lists(&self, input1: Vec<Numbers>, input2: Option<Vec<String>>) -> Result<CallTwoListsReturnValues, MethodReturnCode>;
