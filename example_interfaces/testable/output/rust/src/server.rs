...
struct TestAbleProperties {
    ...
    read_write_datetime: Arc<Mutex<Option<chrono::DateTime<chrono::Utc>>>>,
    ...
    read_write_optional_datetime: Arc<Mutex<Option<chrono::DateTime<chrono::Utc>>>>,
    ...
    read_write_duration: Arc<Mutex<Option<chrono::Duration>>>,
    read_write_duration_tx_channel: watch::Sender<Option<chrono::Duration>>,
    read_write_optional_duration_topic: Arc<String>,
    read_write_optional_duration: Arc<Mutex<Option<chrono::Duration>>>,
...
impl TestAbleServer {
    ...
    async fn handle_call_with_nothing_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(_) => {
                    let retval = CallWithNothingReturnValue {};
    ...
    async fn handle_call_one_integer_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if payload_obj.is_err() {
            ...
            TestAbleServer::publish_error_response(publisher, opt_resp_topic, opt_corr_data, &MethodReturnCode::DeserializationError("Failed to deserialize request payload".to_string())).await;
            return;
        }
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    let retval = CallOneIntegerReturnValue {
                        output1: retval,
                    };
    ...
    async fn handle_call_optional_integer_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    let retval = CallOptionalIntegerReturnValue {
                        output1: retval,
                    };
    ...
    async fn handle_call_one_string_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    let retval = CallOneStringReturnValue {
                        output1: retval,
                    };
    ...
    async fn handle_call_optional_string_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    let retval = CallOptionalStringReturnValue {
                        output1: retval,
                    };
    ...
    async fn handle_call_one_date_time_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    let retval = CallOneDateTimeReturnValue {
                        output1: retval,
                    };
    ...
    async fn handle_call_optional_date_time_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    let retval = CallOptionalDateTimeReturnValue {
                        output1: retval,
                    };
    ...
    async fn handle_call_one_duration_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    let retval = CallOneDurationReturnValue {
                        output1: retval,
                    };
    ...
    async fn handle_call_optional_duration_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    let retval = CallOptionalDurationReturnValue {
                        output1: retval,
                    };
    ...
    async fn handle_call_one_binary_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    let retval = CallOneBinaryReturnValue {
                        output1: retval,
                    };
    ...
    async fn handle_call_optional_binary_request(publisher: MqttierClient, handlers: Arc<AsyncMutex<Box<dyn TestAbleMethodHandlers>>>, msg: ReceivedMessage) {
        ...
        if let Some(resp_topic) = opt_resp_topic {
            ...
            match rc {
                Ok(retval) => {
                    let retval = CallOptionalBinaryReturnValue {
                        output1: retval,
                    };
    ...
    async fn publish_read_write_integer_value(publisher: MqttierClient, topic: String, data: i32) -> SentMessageFuture
    {
        let new_data = ReadWriteIntegerProperty {
            value: data,
        };
        debug!("Publishing 'read_write_integer' property value to topic {}", topic);
    ...
    async fn update_read_write_integer_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<i32>>>, watch_sender: watch::Sender<Option<i32>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        ...
        let new_data: ReadWriteIntegerProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_integer' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_integer_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_integer(&mut self, data: i32) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_integer_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_only_integer_value(publisher: MqttierClient, topic: String, data: i32) -> SentMessageFuture
    {
        let new_data = ReadOnlyIntegerProperty {
            value: data,
        };
        debug!("Publishing 'read_only_integer' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    pub async fn set_read_only_integer(&mut self, data: i32) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_only_integer_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_optional_integer_value(publisher: MqttierClient, topic: String, data: Option<i32>) -> SentMessageFuture
    {
        let new_data = ReadWriteOptionalIntegerProperty {
            value: data,
        };
        debug!("Publishing 'read_write_optional_integer' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_integer_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<Option<i32>>>>, watch_sender: watch::Sender<Option<Option<i32>>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteOptionalIntegerProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_optional_integer' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_optional_integer_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_optional_integer(&mut self, data: Option<i32>) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_optional_integer_value(publisher2, topic2, data).await
        }
    }
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_integers_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<ReadWriteTwoIntegersProperty>>>, watch_sender: watch::Sender<Option<ReadWriteTwoIntegersProperty>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();

        let new_data: ReadWriteTwoIntegersProperty = {
            match serde_json::from_str(&payload_str) {
                Ok(data) => data,
                Err(e) => {
                    error!("Failed to parse JSON received over MQTT to update 'read_write_two_integers' property: {:?}", e);
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_two_integers' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_two_integers_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_two_integers(&mut self, data: ReadWriteTwoIntegersProperty) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_two_integers_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_only_string_value(publisher: MqttierClient, topic: String, data: String) -> SentMessageFuture
    {
        let new_data = ReadOnlyStringProperty {
            value: data,
        };
        debug!("Publishing 'read_only_string' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    pub async fn set_read_only_string(&mut self, data: String) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_only_string_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_string_value(publisher: MqttierClient, topic: String, data: String) -> SentMessageFuture
    {
        let new_data = ReadWriteStringProperty {
            value: data,
        };
        debug!("Publishing 'read_write_string' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_string_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<String>>>, watch_sender: watch::Sender<Option<String>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteStringProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_string' payload".to_string())).await;
                }
            }
        };
        ...
        let assignment_result = match data.lock() {
            Ok(mut guard) => {
                *guard = Some(new_data.value.clone());
        ...
        let topic2: String = topic.as_ref().clone();
        let data2 = new_data.value.clone();
        let data_to_send_to_watchers = data2.clone();
        match watch_sender.send(Some(data_to_send_to_watchers)) {
            Ok(_) => {}
            Err(e) => {
        ...
        TestAbleServer::publish_read_write_string_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_string(&mut self, data: String) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_string_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_optional_string_value(publisher: MqttierClient, topic: String, data: Option<String>) -> SentMessageFuture
    {
        let new_data = ReadWriteOptionalStringProperty {
            value: data,
        };
        debug!("Publishing 'read_write_optional_string' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_string_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<Option<String>>>>, watch_sender: watch::Sender<Option<Option<String>>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteOptionalStringProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_optional_string' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_optional_string_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_optional_string(&mut self, data: Option<String>) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_optional_string_value(publisher2, topic2, data).await
        }
    }
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_strings_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<ReadWriteTwoStringsProperty>>>, watch_sender: watch::Sender<Option<ReadWriteTwoStringsProperty>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();

        let new_data: ReadWriteTwoStringsProperty = {
            match serde_json::from_str(&payload_str) {
                Ok(data) => data,
                Err(e) => {
                    error!("Failed to parse JSON received over MQTT to update 'read_write_two_strings' property: {:?}", e);
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_two_strings' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_two_strings_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_two_strings(&mut self, data: ReadWriteTwoStringsProperty) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_two_strings_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_struct_value(publisher: MqttierClient, topic: String, data: AllTypes) -> SentMessageFuture
    {
        let new_data = ReadWriteStructProperty {
            value: data,
        };
        debug!("Publishing 'read_write_struct' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_struct_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<AllTypes>>>, watch_sender: watch::Sender<Option<AllTypes>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteStructProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_struct' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_struct_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_struct(&mut self, data: AllTypes) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_struct_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_optional_struct_value(publisher: MqttierClient, topic: String, data: AllTypes) -> SentMessageFuture
    {
        let new_data = ReadWriteOptionalStructProperty {
            value: data,
        };
        debug!("Publishing 'read_write_optional_struct' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_struct_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<AllTypes>>>, watch_sender: watch::Sender<Option<AllTypes>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteOptionalStructProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_optional_struct' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_optional_struct_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_optional_struct(&mut self, data: AllTypes) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_optional_struct_value(publisher2, topic2, data).await
        }
    }
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_structs_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<ReadWriteTwoStructsProperty>>>, watch_sender: watch::Sender<Option<ReadWriteTwoStructsProperty>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();

        let new_data: ReadWriteTwoStructsProperty = {
            match serde_json::from_str(&payload_str) {
                Ok(data) => data,
                Err(e) => {
                    error!("Failed to parse JSON received over MQTT to update 'read_write_two_structs' property: {:?}", e);
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_two_structs' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_two_structs_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_two_structs(&mut self, data: ReadWriteTwoStructsProperty) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_two_structs_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_only_enum_value(publisher: MqttierClient, topic: String, data: Numbers) -> SentMessageFuture
    {
        let new_data = ReadOnlyEnumProperty {
            value: data,
        };
        debug!("Publishing 'read_only_enum' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    pub async fn set_read_only_enum(&mut self, data: Numbers) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_only_enum_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_enum_value(publisher: MqttierClient, topic: String, data: Numbers) -> SentMessageFuture
    {
        let new_data = ReadWriteEnumProperty {
            value: data,
        };
        debug!("Publishing 'read_write_enum' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_enum_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<Numbers>>>, watch_sender: watch::Sender<Option<Numbers>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteEnumProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_enum' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_enum_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_enum(&mut self, data: Numbers) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_enum_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_optional_enum_value(publisher: MqttierClient, topic: String, data: Option<Numbers>) -> SentMessageFuture
    {
        let new_data = ReadWriteOptionalEnumProperty {
            value: data,
        };
        debug!("Publishing 'read_write_optional_enum' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_enum_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<Option<Numbers>>>>, watch_sender: watch::Sender<Option<Option<Numbers>>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteOptionalEnumProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_optional_enum' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_optional_enum_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_optional_enum(&mut self, data: Option<Numbers>) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_optional_enum_value(publisher2, topic2, data).await
        }
    }
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_enums_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<ReadWriteTwoEnumsProperty>>>, watch_sender: watch::Sender<Option<ReadWriteTwoEnumsProperty>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();

        let new_data: ReadWriteTwoEnumsProperty = {
            match serde_json::from_str(&payload_str) {
                Ok(data) => data,
                Err(e) => {
                    error!("Failed to parse JSON received over MQTT to update 'read_write_two_enums' property: {:?}", e);
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_two_enums' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_two_enums_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_two_enums(&mut self, data: ReadWriteTwoEnumsProperty) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_two_enums_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_datetime_value(publisher: MqttierClient, topic: String, data: chrono::DateTime<chrono::Utc>) -> SentMessageFuture
    {
        let new_data = ReadWriteDatetimeProperty {
            value: data,
        };
        debug!("Publishing 'read_write_datetime' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_datetime_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<chrono::DateTime<chrono::Utc>>>>, watch_sender: watch::Sender<Option<chrono::DateTime<chrono::Utc>>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteDatetimeProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_datetime' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_datetime_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_datetime(&mut self, data: chrono::DateTime<chrono::Utc>) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_datetime_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_optional_datetime_value(publisher: MqttierClient, topic: String, data: chrono::DateTime<chrono::Utc>) -> SentMessageFuture
    {
        let new_data = ReadWriteOptionalDatetimeProperty {
            value: data,
        };
        debug!("Publishing 'read_write_optional_datetime' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_datetime_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<chrono::DateTime<chrono::Utc>>>>, watch_sender: watch::Sender<Option<chrono::DateTime<chrono::Utc>>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteOptionalDatetimeProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_optional_datetime' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_optional_datetime_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_optional_datetime(&mut self, data: chrono::DateTime<chrono::Utc>) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_optional_datetime_value(publisher2, topic2, data).await
        }
    }
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_datetimes_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<ReadWriteTwoDatetimesProperty>>>, watch_sender: watch::Sender<Option<ReadWriteTwoDatetimesProperty>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();

        let new_data: ReadWriteTwoDatetimesProperty = {
            match serde_json::from_str(&payload_str) {
                Ok(data) => data,
                Err(e) => {
                    error!("Failed to parse JSON received over MQTT to update 'read_write_two_datetimes' property: {:?}", e);
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_two_datetimes' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_two_datetimes_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_two_datetimes(&mut self, data: ReadWriteTwoDatetimesProperty) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_two_datetimes_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_duration_value(publisher: MqttierClient, topic: String, data: chrono::Duration) -> SentMessageFuture
    {
        let new_data = ReadWriteDurationProperty {
            value: data,
        };
        debug!("Publishing 'read_write_duration' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_duration_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<chrono::Duration>>>, watch_sender: watch::Sender<Option<chrono::Duration>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteDurationProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_duration' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_duration_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_duration(&mut self, data: chrono::Duration) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_duration_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_optional_duration_value(publisher: MqttierClient, topic: String, data: chrono::Duration) -> SentMessageFuture
    {
        let new_data = ReadWriteOptionalDurationProperty {
            value: data,
        };
        debug!("Publishing 'read_write_optional_duration' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_duration_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<chrono::Duration>>>, watch_sender: watch::Sender<Option<chrono::Duration>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteOptionalDurationProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_optional_duration' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_optional_duration_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_optional_duration(&mut self, data: chrono::Duration) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_optional_duration_value(publisher2, topic2, data).await
        }
    }
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_durations_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<ReadWriteTwoDurationsProperty>>>, watch_sender: watch::Sender<Option<ReadWriteTwoDurationsProperty>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();

        let new_data: ReadWriteTwoDurationsProperty = {
            match serde_json::from_str(&payload_str) {
                Ok(data) => data,
                Err(e) => {
                    error!("Failed to parse JSON received over MQTT to update 'read_write_two_durations' property: {:?}", e);
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_two_durations' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_two_durations_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_two_durations(&mut self, data: ReadWriteTwoDurationsProperty) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_two_durations_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_binary_value(publisher: MqttierClient, topic: String, data: Vec<u8>) -> SentMessageFuture
    {
        let new_data = ReadWriteBinaryProperty {
            value: data,
        };
        debug!("Publishing 'read_write_binary' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_binary_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<Vec<u8>>>>, watch_sender: watch::Sender<Option<Vec<u8>>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteBinaryProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_binary' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_binary_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_binary(&mut self, data: Vec<u8>) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_binary_value(publisher2, topic2, data).await
        }
    }
    
    async fn publish_read_write_optional_binary_value(publisher: MqttierClient, topic: String, data: Vec<u8>) -> SentMessageFuture
    {
        let new_data = ReadWriteOptionalBinaryProperty {
            value: data,
        };
        debug!("Publishing 'read_write_optional_binary' property value to topic {}", topic);
        let published_oneshot = publisher.publish_state(topic, &new_data, 1).await;
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_optional_binary_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<Vec<u8>>>>, watch_sender: watch::Sender<Option<Vec<u8>>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();
        ...
        let new_data: ReadWriteOptionalBinaryProperty = {
            match serde_json::from_str(&payload_str) {
                ...
                Err(e) => {
                    ...
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_optional_binary' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_optional_binary_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_optional_binary(&mut self, data: Vec<u8>) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_optional_binary_value(publisher2, topic2, data).await
        }
    }
    ...
    /// It updates the local value, notifies any watchers, and publishes the new value.
    /// If there is an error, it can publish back if a response topic was provided.
    async fn update_read_write_two_binaries_value(publisher: MqttierClient, topic: Arc<String>, data: Arc<Mutex<Option<ReadWriteTwoBinariesProperty>>>, watch_sender: watch::Sender<Option<ReadWriteTwoBinariesProperty>>, msg: ReceivedMessage) -> SentMessageFuture
    {
        let payload_str = String::from_utf8_lossy(&msg.payload).to_string();

        let new_data: ReadWriteTwoBinariesProperty = {
            match serde_json::from_str(&payload_str) {
                Ok(data) => data,
                Err(e) => {
                    error!("Failed to parse JSON received over MQTT to update 'read_write_two_binaries' property: {:?}", e);
                    return TestAbleServer::wrap_return_code_in_future(MethodReturnCode::DeserializationError("Failed to deserialize property 'read_write_two_binaries' payload".to_string())).await;
                }
            }
        };
        ...
        TestAbleServer::publish_read_write_two_binaries_value(publisher, topic2, data2).await
    }
    ...
    pub async fn set_read_write_two_binaries(&mut self, data: ReadWriteTwoBinariesProperty) -> SentMessageFuture {
        ...
        if !send_result {
            ...
            TestAbleServer::publish_read_write_two_binaries_value(publisher2, topic2, data).await
        }
    }
