...
class TestableServer:
    ...
    def __init__(self, connection: IConnection, instance_id: str, property_access: TestablePropertyAccess, prefix: str):
...
class TestableServerBuilder:
    ...
    def build(self, connection: IConnection, instance_id: str, property_access: TestablePropertyAccess, prefix: str, binding: Optional[Any] = None) -> TestableServer:
