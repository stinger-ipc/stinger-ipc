"""
Generated by Stinger-IPC code generator 0.7.0rc7.
"""
...
if __name__ == "__main__":
    ...
    server = TestableServer(conn, os.environ.get("SERVICE_ID", "py-server-demo:1"), initial_property_values, prefix="example")
