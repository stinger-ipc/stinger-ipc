...
class SimpleClient:
    ...
    def __init__(self, connection: IBrokerConnection, instance_info: DiscoveredInstance):
        ...
        self._conn.subscribe("{prefix}/Simple/{service_id}/property/school/value".format(**self._topic_template_kwargs), self._receive_school_property_update_message)
        ...
        self._all_methods_response_topic = "client/{client_id}/Simple/responses".format(**self._topic_template_kwargs)
        self._conn.subscribe(self._all_methods_response_topic, self._receive_any_method_response_message)

        self._property_response_topic = "client/{client_id}/Simple/responses".format(**self._topic_template_kwargs)
    ...
    def school(self, value: str):
        ...
        with self._property_school_mutex:
            req_msg = MessageCreator.property_update_request_message(
                "{prefix}/Simple/{service_id}/property/school/update".format(**self._topic_template_kwargs),
                property_obj,
    ...
    def receive_person_entered(self, handler: PersonEnteredSignalCallbackType):
        ...
        if len(self._signal_recv_callbacks_for_person_entered) == 1:
            self._conn.subscribe("{prefix}/Simple/{service_id}/signal/person_entered".format(**self._topic_template_kwargs), self._receive_person_entered_signal_message)
        return handler
    ...
    def trade_numbers(self, your_number: int) -> futures.Future:
        ...
        req_msg = MessageCreator.request_message(
            "{prefix}/Simple/{service_id}/method/trade_numbers/request".format(**self._topic_template_kwargs), payload, self._all_methods_response_topic, correlation_id
        )
        self._conn.publish(req_msg)
        return fut
...
class SimpleClientDiscoverer:
    ...
    def __init__(self, connection: IBrokerConnection, builder: Optional[SimpleClientBuilder] = None, build_binding: Optional[Any] = None):
        ...
        self._conn.subscribe(
            "{prefix}/Simple/{service_id}/property/+/value".format(
                client_id="+",
                service_id="+",
                prefix="+",
            ),
            self._process_property_value_message,
        )
        ...
        with self._mutex:
            if instance_id in self._discovered_properties and len(self._discovered_properties[instance_id]) == 2 and instance_id in self._discovered_interface_infos:
                ...
                entry = DiscoveredInstance(
                    instance_id=instance_id, initial_property_values=SimpleInitialPropertyValues(**self._discovered_properties[instance_id]), info=self._discovered_interface_infos[instance_id]
                )
