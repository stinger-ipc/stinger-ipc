"""Discovery screen for finding SimpleIPC servers."""
...
from simpleipc.client import SimpleClientDiscoverer, DiscoveredInstance, SimpleClient
from simpleipc.tui.helpers import get_package_version
import logging
...
class DiscoveryScreen(Screen):
    """Screen for discovering available SimpleIPC servers."""
    ...
    def on_mount(self) -> None:
        ...
        self.discoverer = SimpleClientDiscoverer(conn)
    ...
    def on_button_pressed(self, event: Button.Pressed) -> None:
        ...
        if hasattr(event.button, "instance_id"):
            ...
            conn = self.app.mqtt_connection
            client = SimpleClient(conn, discovered_instance)

            # Store the client in the app for the Client screen to use
            self.app.simple_client = client
