const clientId = "Simple-web-" + new Date().getTime();
...
app.controller("myCtrl", function ($scope, $filter, $location) {
    ...
    $scope.signals = {
        "personEntered": {
            ...
            "received": null,
            "received_time": null,
            "mqtt_topic": "<bound method Signal.topic of <stingeripc.components.Signal object at 0x7b563a93ae40>>"
        }
    };
    ...
    $scope.properties = {
        "school": {
            ...
            "mqtt_topic": "<bound method Property.value_topic of <stingeripc.components.Property object at 0x7b563a93acc0>>",
            "update_topic": "<bound method Property.update_topic of <stingeripc.components.Property object at 0x7b563a93acc0>>",
            "property_version": -1
        }
    };
    ...
    $scope.methods = {
        "tradeNumbers": {
            "name": "trade_numbers",
            "mqtt_topic": "",
            "response_topic": `client/${client_id}/Simple/responses`,
    ...
    client.on('connect', function() {
        ...
        var resolvedTopic = resolveTopic("<bound method Signal.topic of <stingeripc.components.Signal object at 0x7b563a93ae40>>");
