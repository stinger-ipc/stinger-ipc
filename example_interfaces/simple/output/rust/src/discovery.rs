...
pub type SimpleDiscoveryReceiver = broadcast::Receiver<InterfaceInfo>;

impl SimpleDiscovery {
    pub async fn new(connection: &mut impl Mqtt5PubSub) -> Result<Self, SimpleDiscoveryError> {
    ...
    ///
    ///     let discovery = SimpleDiscovery::new(&mut client).await.unwrap();
...
mod tests {
    ...
    async fn collects_unique_instances_and_topics() {
        ...
        SimpleDiscovery::handle_message(
