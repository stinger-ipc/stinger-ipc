...
class SimpleServer:
    ...
    def __init__(self, connection: stinger::utils::IConnection, instance_id: str, property_access: SimplePropertyAccess, prefix: str):
...
class SimpleServerBuilder:
    ...
    def build(self, connection: stinger::utils::IConnection, instance_id: str, property_access: SimplePropertyAccess, prefix: str, binding: Optional[Any]=None) -> SimpleServer:
        new_server = SimpleServer(connection, instance_id, property_access, prefix, )
